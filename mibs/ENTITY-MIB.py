...
mib_2, Counter64, MibIdentifier, TimeTicks, ModuleIdentity, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, ObjectIdentity, Bits, IpAddress, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Counter64", "MibIdentifier", "TimeTicks", "ModuleIdentity", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "ObjectIdentity", "Bits", "IpAddress", "Integer32", "Gauge32")
TextualConvention, TruthValue, DisplayString, TDomain, TimeStamp, TAddress, RowPointer, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "DisplayString", "TDomain", "TimeStamp", "TAddress", "RowPointer", "AutonomousType")
...
mibBuilder.exportSymbols("ENTITY-MIB", entPhysicalFirmwareRev=entPhysicalFirmwareRev, entPhysicalAssetID=entPhysicalAssetID, entPhysicalDescr=entPhysicalDescr, entityMIBTrapPrefix=entityMIBTrapPrefix, entity2Compliance=entity2Compliance, entityMappingGroup=entityMappingGroup, entPhysicalParentRelPos=entPhysicalParentRelPos, entPhysicalModelName=entPhysicalModelName, entPhysicalClass=entPhysicalClass, entPhysicalTable=entPhysicalTable, entLogicalCommunity=entLogicalCommunity, entPhysicalEntry=entPhysicalEntry, entLogicalType=entLogicalType, entityGroups=entityGroups, entityPhysical2Group=entityPhysical2Group, entityLogical2Group=entityLogical2Group, entLogicalTable=entLogicalTable, entPhysicalContainsEntry=entPhysicalContainsEntry, entLastChangeTime=entLastChangeTime, entLPMappingTable=entLPMappingTable, entityCompliance=entityCompliance, entPhysicalAlias=entPhysicalAlias, SnmpEngineIdOrNone=SnmpEngineIdOrNone, entPhysicalMfgName=entPhysicalMfgName, entLPPhysicalIndex=entLPPhysicalIndex, entityMapping=entityMapping, entityGeneral=entityGeneral, entPhysicalContainsTable=entPhysicalContainsTable, entLogicalContextEngineID=entLogicalContextEngineID, entPhysicalHardwareRev=entPhysicalHardwareRev, entPhysicalSerialNum=entPhysicalSerialNum, entLogicalEntry=entLogicalEntry, entityConformance=entityConformance, entPhysicalIndex=entPhysicalIndex, entityCompliances=entityCompliances, entPhysicalChildIndex=entPhysicalChildIndex, entConfigChange=entConfigChange, entityMIB=entityMIB, entLogicalTDomain=entLogicalTDomain, PYSNMP_MODULE_ID=entityMIB, entityPhysicalGroup=entityPhysicalGroup, entityPhysical=entityPhysical, entAliasMappingIdentifier=entAliasMappingIdentifier, entityGeneralGroup=entityGeneralGroup, entLogicalDescr=entLogicalDescr, entLPMappingEntry=entLPMappingEntry, entAliasLogicalIndexOrZero=entAliasLogicalIndexOrZero, PhysicalIndex=PhysicalIndex, entityMIBTraps=entityMIBTraps, entityNotificationsGroup=entityNotificationsGroup, PhysicalClass=PhysicalClass, entPhysicalIsFRU=entPhysicalIsFRU, entAliasMappingTable=entAliasMappingTable, entityMIBObjects=entityMIBObjects, entPhysicalVendorType=entPhysicalVendorType, entPhysicalName=entPhysicalName, entPhysicalContainedIn=entPhysicalContainedIn, entAliasMappingEntry=entAliasMappingEntry, entPhysicalSoftwareRev=entPhysicalSoftwareRev, entityLogicalGroup=entityLogicalGroup, entityLogical=entityLogical, entLogicalTAddress=entLogicalTAddress, entLogicalIndex=entLogicalIndex, entLogicalContextName=entLogicalContextName)
