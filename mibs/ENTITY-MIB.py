...
DisplayString, AutonomousType, TruthValue, TimeStamp, RowPointer, TDomain, TAddress, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "AutonomousType", "TruthValue", "TimeStamp", "RowPointer", "TDomain", "TAddress", "TextualConvention")
...
mibBuilder.exportSymbols("ENTITY-MIB", entLogicalIndex=entLogicalIndex, entPhysicalChildIndex=entPhysicalChildIndex, entLogicalTAddress=entLogicalTAddress, entPhysicalContainedIn=entPhysicalContainedIn, entityGroups=entityGroups, entityMapping=entityMapping, entLogicalContextEngineID=entLogicalContextEngineID, entLPMappingTable=entLPMappingTable, entPhysicalEntry=entPhysicalEntry, entPhysicalParentRelPos=entPhysicalParentRelPos, entPhysicalIndex=entPhysicalIndex, entLPMappingEntry=entLPMappingEntry, entPhysicalAssetID=entPhysicalAssetID, entAliasMappingEntry=entAliasMappingEntry, entLogicalTDomain=entLogicalTDomain, entityCompliance=entityCompliance, entPhysicalIsFRU=entPhysicalIsFRU, entityMIB=entityMIB, entPhysicalDescr=entPhysicalDescr, entityGeneralGroup=entityGeneralGroup, entLogicalType=entLogicalType, entityPhysical2Group=entityPhysical2Group, entPhysicalAlias=entPhysicalAlias, entPhysicalSoftwareRev=entPhysicalSoftwareRev, entPhysicalVendorType=entPhysicalVendorType, entLogicalTable=entLogicalTable, entPhysicalClass=entPhysicalClass, entityConformance=entityConformance, entityMappingGroup=entityMappingGroup, entPhysicalContainsTable=entPhysicalContainsTable, entLogicalDescr=entLogicalDescr, SnmpEngineIdOrNone=SnmpEngineIdOrNone, entityPhysical=entityPhysical, entPhysicalModelName=entPhysicalModelName, entLogicalContextName=entLogicalContextName, PhysicalIndex=PhysicalIndex, entPhysicalMfgName=entPhysicalMfgName, entPhysicalFirmwareRev=entPhysicalFirmwareRev, entPhysicalSerialNum=entPhysicalSerialNum, entityLogical2Group=entityLogical2Group, entPhysicalContainsEntry=entPhysicalContainsEntry, entLPPhysicalIndex=entLPPhysicalIndex, entityLogicalGroup=entityLogicalGroup, entAliasLogicalIndexOrZero=entAliasLogicalIndexOrZero, entConfigChange=entConfigChange, entAliasMappingIdentifier=entAliasMappingIdentifier, entAliasMappingTable=entAliasMappingTable, entityMIBTraps=entityMIBTraps, entLastChangeTime=entLastChangeTime, entityNotificationsGroup=entityNotificationsGroup, entLogicalEntry=entLogicalEntry, entityLogical=entityLogical, entityMIBObjects=entityMIBObjects, entLogicalCommunity=entLogicalCommunity, entityGeneral=entityGeneral, entPhysicalTable=entPhysicalTable, PhysicalClass=PhysicalClass, entityMIBTrapPrefix=entityMIBTrapPrefix, entityCompliances=entityCompliances, entity2Compliance=entity2Compliance, entityPhysicalGroup=entityPhysicalGroup, PYSNMP_MODULE_ID=entityMIB, entPhysicalName=entPhysicalName, entPhysicalHardwareRev=entPhysicalHardwareRev)
