...
Integer32, TimeTicks, Gauge32, ModuleIdentity, IpAddress, MibIdentifier, Counter64, Unsigned32, iso, NotificationType, mib_2, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "TimeTicks", "Gauge32", "ModuleIdentity", "IpAddress", "MibIdentifier", "Counter64", "Unsigned32", "iso", "NotificationType", "mib-2", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity")
TimeStamp, TruthValue, AutonomousType, RowPointer, DisplayString, TAddress, TDomain, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "AutonomousType", "RowPointer", "DisplayString", "TAddress", "TDomain", "TextualConvention")
...
mibBuilder.exportSymbols("ENTITY-MIB", entityNotificationsGroup=entityNotificationsGroup, SnmpEngineIdOrNone=SnmpEngineIdOrNone, entityLogicalGroup=entityLogicalGroup, entityConformance=entityConformance, entPhysicalContainedIn=entPhysicalContainedIn, entityMIBTraps=entityMIBTraps, entPhysicalParentRelPos=entPhysicalParentRelPos, entityMIB=entityMIB, entPhysicalIndex=entPhysicalIndex, entPhysicalModelName=entPhysicalModelName, entAliasMappingEntry=entAliasMappingEntry, PhysicalIndex=PhysicalIndex, entLogicalContextName=entLogicalContextName, entLogicalCommunity=entLogicalCommunity, entityMappingGroup=entityMappingGroup, entLPMappingTable=entLPMappingTable, entAliasMappingIdentifier=entAliasMappingIdentifier, entityGeneral=entityGeneral, entPhysicalName=entPhysicalName, PYSNMP_MODULE_ID=entityMIB, entPhysicalAlias=entPhysicalAlias, entLPPhysicalIndex=entLPPhysicalIndex, entityPhysical=entityPhysical, entPhysicalSoftwareRev=entPhysicalSoftwareRev, entLPMappingEntry=entLPMappingEntry, entityGroups=entityGroups, entPhysicalContainsTable=entPhysicalContainsTable, entPhysicalMfgName=entPhysicalMfgName, entLogicalDescr=entLogicalDescr, entLastChangeTime=entLastChangeTime, entLogicalTDomain=entLogicalTDomain, entConfigChange=entConfigChange, entLogicalEntry=entLogicalEntry, entLogicalIndex=entLogicalIndex, entPhysicalIsFRU=entPhysicalIsFRU, entityPhysical2Group=entityPhysical2Group, entAliasMappingTable=entAliasMappingTable, entPhysicalVendorType=entPhysicalVendorType, entityPhysicalGroup=entityPhysicalGroup, entLogicalTAddress=entLogicalTAddress, entPhysicalFirmwareRev=entPhysicalFirmwareRev, entPhysicalAssetID=entPhysicalAssetID, entityCompliances=entityCompliances, entPhysicalTable=entPhysicalTable, PhysicalClass=PhysicalClass, entityGeneralGroup=entityGeneralGroup, entityMIBTrapPrefix=entityMIBTrapPrefix, entPhysicalClass=entPhysicalClass, entLogicalContextEngineID=entLogicalContextEngineID, entityMIBObjects=entityMIBObjects, entPhysicalContainsEntry=entPhysicalContainsEntry, entLogicalType=entLogicalType, entPhysicalChildIndex=entPhysicalChildIndex, entityCompliance=entityCompliance, entity2Compliance=entity2Compliance, entPhysicalEntry=entPhysicalEntry, entityLogical2Group=entityLogical2Group, entPhysicalDescr=entPhysicalDescr, entityMapping=entityMapping, entPhysicalHardwareRev=entPhysicalHardwareRev, entAliasLogicalIndexOrZero=entAliasLogicalIndexOrZero, entityLogical=entityLogical, entPhysicalSerialNum=entPhysicalSerialNum, entLogicalTable=entLogicalTable)
