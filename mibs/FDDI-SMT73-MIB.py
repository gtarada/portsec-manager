...
TimeTicks, IpAddress, MibIdentifier, NotificationType, Counter32, transmission, iso, Bits, Integer32, Gauge32, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "MibIdentifier", "NotificationType", "Counter32", "transmission", "iso", "Bits", "Integer32", "Gauge32", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibSMTTNotify=fddimibSMTTNotify, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibSMTStationId=fddimibSMTStationId, fddimibMACIfIndex=fddimibMACIfIndex, fddimibSMTNumber=fddimibSMTNumber, fddimibPORTPCMState=fddimibPORTPCMState, fddimibMACErrorCts=fddimibMACErrorCts, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibMACEntry=fddimibMACEntry, fddimibSMTIndex=fddimibSMTIndex, fddimibMACRMTState=fddimibMACRMTState, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibPATHTable=fddimibPATHTable, FddiTimeMilli=FddiTimeMilli, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibPATHEntry=fddimibPATHEntry, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibMACFrameCts=fddimibMACFrameCts, fddimibPORTAction=fddimibPORTAction, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibSMTECMState=fddimibSMTECMState, fddimibMACLostCts=fddimibMACLostCts, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibPORTMyType=fddimibPORTMyType, fddimibPORTLemCts=fddimibPORTLemCts, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibSMTMACCts=fddimibSMTMACCts, fddimibMACTReq=fddimibMACTReq, fddimibMACTokenCts=fddimibMACTokenCts, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibPORTEntry=fddimibPORTEntry, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibMAC=fddimibMAC, fddimibPORTConnectState=fddimibPORTConnectState, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibMACTNeg=fddimibMACTNeg, fddimibMACCounters=fddimibMACCounters, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibMACTMax=fddimibMACTMax, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibMACDaFlag=fddimibMACDaFlag, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibPORTNumber=fddimibPORTNumber, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibPORT=fddimibPORT, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibMACNumber=fddimibMACNumber, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibPORTIndex=fddimibPORTIndex, fddimibMACIndex=fddimibMACIndex, fddimibPATH=fddimibPATH, FddiResourceId=FddiResourceId, fddimibPATHIndex=fddimibPATHIndex, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, FddiSMTStationIdType=FddiSMTStationIdType, fddimibMACTvxValue=fddimibMACTvxValue, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibSMTTable=fddimibSMTTable, FddiTimeNano=FddiTimeNano, fddimibSMT=fddimibSMT, fddimib=fddimib, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibPORTSMTIndex=fddimibPORTSMTIndex, FddiMACLongAddressType=FddiMACLongAddressType, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibPATHNumber=fddimibPATHNumber, fddimibMACLateCts=fddimibMACLateCts, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibSMTEntry=fddimibSMTEntry, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibPORTTable=fddimibPORTTable, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibSMTCFState=fddimibSMTCFState, fddimibSMTStationAction=fddimibSMTStationAction, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibSMTUserData=fddimibSMTUserData, fddimibMACCountersTable=fddimibMACCountersTable, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddi=fddi, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibMACTable=fddimibMACTable, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound)
