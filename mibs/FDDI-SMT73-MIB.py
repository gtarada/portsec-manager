...
Gauge32, ObjectIdentity, Unsigned32, Counter32, transmission, NotificationType, TimeTicks, MibIdentifier, ModuleIdentity, Bits, Counter64, Integer32, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Unsigned32", "Counter32", "transmission", "NotificationType", "TimeTicks", "MibIdentifier", "ModuleIdentity", "Bits", "Counter64", "Integer32", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibMAC=fddimibMAC, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibMACNumber=fddimibMACNumber, fddimibMACCountersTable=fddimibMACCountersTable, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, FddiSMTStationIdType=FddiSMTStationIdType, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibMACSMTAddress=fddimibMACSMTAddress, FddiMACLongAddressType=FddiMACLongAddressType, fddimibSMTMACCts=fddimibSMTMACCts, fddimibPATHIndex=fddimibPATHIndex, fddimibSMTIndex=fddimibSMTIndex, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibMACLostCts=fddimibMACLostCts, fddimib=fddimib, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibPORTLemCts=fddimibPORTLemCts, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, FddiTimeMilli=FddiTimeMilli, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibSMTStationAction=fddimibSMTStationAction, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibMACIndex=fddimibMACIndex, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibMACDaFlag=fddimibMACDaFlag, fddimibMACTNeg=fddimibMACTNeg, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibPORTEntry=fddimibPORTEntry, fddimibPORTIndex=fddimibPORTIndex, fddi=fddi, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibSMTEntry=fddimibSMTEntry, fddimibMACIfIndex=fddimibMACIfIndex, fddimibSMTCFState=fddimibSMTCFState, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibPORTPCMState=fddimibPORTPCMState, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibPORTAction=fddimibPORTAction, fddimibPORT=fddimibPORT, fddimibSMTStationId=fddimibSMTStationId, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibSMT=fddimibSMT, fddimibMACTable=fddimibMACTable, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibSMTTNotify=fddimibSMTTNotify, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibMACErrorCts=fddimibMACErrorCts, fddimibMACEntry=fddimibMACEntry, fddimibPORTConnectState=fddimibPORTConnectState, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibPORTMyType=fddimibPORTMyType, fddimibMACRMTState=fddimibMACRMTState, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibPORTNumber=fddimibPORTNumber, fddimibSMTECMState=fddimibSMTECMState, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibMACFrameCts=fddimibMACFrameCts, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibMACTMax=fddimibMACTMax, FddiTimeNano=FddiTimeNano, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibMACTvxValue=fddimibMACTvxValue, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, FddiResourceId=FddiResourceId, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibSMTNumber=fddimibSMTNumber, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibSMTUserData=fddimibSMTUserData, fddimibPATHEntry=fddimibPATHEntry, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibMACCounters=fddimibMACCounters, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibPATHNumber=fddimibPATHNumber, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibMACTokenCts=fddimibMACTokenCts, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibMACTReq=fddimibMACTReq, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibPATHTable=fddimibPATHTable, fddimibSMTTable=fddimibSMTTable, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibPORTTable=fddimibPORTTable, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibMACLateCts=fddimibMACLateCts, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibPATH=fddimibPATH, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibPORTLerAlarm=fddimibPORTLerAlarm)
