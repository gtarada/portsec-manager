...
Counter32, ModuleIdentity, ObjectIdentity, Integer32, TimeTicks, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, transmission, IpAddress, MibIdentifier, Bits, Unsigned32, Gauge32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "ObjectIdentity", "Integer32", "TimeTicks", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "transmission", "IpAddress", "MibIdentifier", "Bits", "Unsigned32", "Gauge32", "iso", "NotificationType")
...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibSMTNumber=fddimibSMTNumber, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibSMTUserData=fddimibSMTUserData, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibPORTIndex=fddimibPORTIndex, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibPATHNumber=fddimibPATHNumber, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibSMT=fddimibSMT, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddi=fddi, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimib=fddimib, fddimibMACIndex=fddimibMACIndex, fddimibMACCopiedCts=fddimibMACCopiedCts, FddiTimeMilli=FddiTimeMilli, fddimibMACRMTState=fddimibMACRMTState, fddimibMACTokenCts=fddimibMACTokenCts, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibSMTTable=fddimibSMTTable, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibPORTAction=fddimibPORTAction, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibPORTConnectState=fddimibPORTConnectState, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibSMTMACCts=fddimibSMTMACCts, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibMACIfIndex=fddimibMACIfIndex, fddimibPATHTable=fddimibPATHTable, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibPORTMyType=fddimibPORTMyType, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibSMTECMState=fddimibSMTECMState, fddimibMACNumber=fddimibMACNumber, fddimibSMTStationAction=fddimibSMTStationAction, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibPORT=fddimibPORT, fddimibSMTEntry=fddimibSMTEntry, fddimibSMTIndex=fddimibSMTIndex, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibPORTEntry=fddimibPORTEntry, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibPORTLemCts=fddimibPORTLemCts, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibMACDaFlag=fddimibMACDaFlag, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibMACTNeg=fddimibMACTNeg, fddimibMACTvxValue=fddimibMACTvxValue, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, FddiResourceId=FddiResourceId, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibMACFrameCts=fddimibMACFrameCts, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibSMTStationId=fddimibSMTStationId, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibMACTMax=fddimibMACTMax, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibSMTTNotify=fddimibSMTTNotify, fddimibSMTCFState=fddimibSMTCFState, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibMACErrorCts=fddimibMACErrorCts, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, FddiSMTStationIdType=FddiSMTStationIdType, fddimibPORTNumber=fddimibPORTNumber, fddimibMACTable=fddimibMACTable, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibMACEntry=fddimibMACEntry, fddimibMACTReq=fddimibMACTReq, FddiMACLongAddressType=FddiMACLongAddressType, fddimibPORTTable=fddimibPORTTable, fddimibPATH=fddimibPATH, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibPATHEntry=fddimibPATHEntry, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, FddiTimeNano=FddiTimeNano, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibMACCountersTable=fddimibMACCountersTable, fddimibMAC=fddimibMAC, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibPORTPCMState=fddimibPORTPCMState, fddimibMACCounters=fddimibMACCounters, fddimibPATHIndex=fddimibPATHIndex, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibMACLostCts=fddimibMACLostCts, fddimibMACLateCts=fddimibMACLateCts)
