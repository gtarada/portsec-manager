...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibMACTable=fddimibMACTable, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibSMTECMState=fddimibSMTECMState, fddimibMACLostCts=fddimibMACLostCts, fddimibPATH=fddimibPATH, FddiResourceId=FddiResourceId, FddiTimeNano=FddiTimeNano, FddiTimeMilli=FddiTimeMilli, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibMACNumber=fddimibMACNumber, fddimibPORTConnectState=fddimibPORTConnectState, fddimibPORTTable=fddimibPORTTable, fddimibMACFrameCts=fddimibMACFrameCts, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibSMTStationAction=fddimibSMTStationAction, fddimibMACTvxValue=fddimibMACTvxValue, fddimibSMTStationId=fddimibSMTStationId, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, FddiMACLongAddressType=FddiMACLongAddressType, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimib=fddimib, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibSMTNumber=fddimibSMTNumber, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibPORTNumber=fddimibPORTNumber, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibPATHEntry=fddimibPATHEntry, fddimibMACErrorCts=fddimibMACErrorCts, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibMACRMTState=fddimibMACRMTState, fddimibMACCountersTable=fddimibMACCountersTable, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibMACCounters=fddimibMACCounters, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibSMTMACCts=fddimibSMTMACCts, fddimibPORTLerCutoff=fddimibPORTLerCutoff, FddiSMTStationIdType=FddiSMTStationIdType, fddimibMACLateCts=fddimibMACLateCts, fddimibSMTIndex=fddimibSMTIndex, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibMACTReq=fddimibMACTReq, fddimibMACTokenCts=fddimibMACTokenCts, fddimibPATHTable=fddimibPATHTable, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibSMTTNotify=fddimibSMTTNotify, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibSMTTable=fddimibSMTTable, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibMACIndex=fddimibMACIndex, fddimibPORT=fddimibPORT, fddimibPATHIndex=fddimibPATHIndex, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibPORTPCMState=fddimibPORTPCMState, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibMACSMTIndex=fddimibMACSMTIndex, fddi=fddi, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibMACTNeg=fddimibMACTNeg, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibSMTEntry=fddimibSMTEntry, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibSMTUserData=fddimibSMTUserData, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibPORTMyType=fddimibPORTMyType, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibMACEntry=fddimibMACEntry, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibSMT=fddimibSMT, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibPORTEntry=fddimibPORTEntry, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibMAC=fddimibMAC, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibPATHNumber=fddimibPATHNumber, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibPORTIndex=fddimibPORTIndex, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibMACTMax=fddimibMACTMax, fddimibPORTLemCts=fddimibPORTLemCts, fddimibMACIfIndex=fddimibMACIfIndex, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibSMTCFState=fddimibSMTCFState, fddimibMACDaFlag=fddimibMACDaFlag, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibPORTAction=fddimibPORTAction, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag)
