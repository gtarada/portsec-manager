...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibPORTPCMState=fddimibPORTPCMState, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibMACFrameCts=fddimibMACFrameCts, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, FddiTimeMilli=FddiTimeMilli, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibMACDaFlag=fddimibMACDaFlag, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibPORTIndex=fddimibPORTIndex, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibSMTStationAction=fddimibSMTStationAction, fddimibPORTLemCts=fddimibPORTLemCts, fddimibSMTStationId=fddimibSMTStationId, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibMACIndex=fddimibMACIndex, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibSMTUserData=fddimibSMTUserData, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibSMTCFState=fddimibSMTCFState, fddimibMACTMax=fddimibMACTMax, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibPORTNumber=fddimibPORTNumber, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibPORTTable=fddimibPORTTable, fddimibSMTMACCts=fddimibSMTMACCts, fddimibPORTAction=fddimibPORTAction, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibPATH=fddimibPATH, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, FddiSMTStationIdType=FddiSMTStationIdType, fddimibPATHEntry=fddimibPATHEntry, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibPATHTable=fddimibPATHTable, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibMACLateCts=fddimibMACLateCts, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibSMTTable=fddimibSMTTable, fddimibMACTable=fddimibMACTable, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibMACRMTState=fddimibMACRMTState, FddiTimeNano=FddiTimeNano, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibSMTECMState=fddimibSMTECMState, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, FddiMACLongAddressType=FddiMACLongAddressType, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddi=fddi, fddimibMACIfIndex=fddimibMACIfIndex, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibMACNumber=fddimibMACNumber, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibSMTNumber=fddimibSMTNumber, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibMACErrorCts=fddimibMACErrorCts, fddimib=fddimib, FddiResourceId=FddiResourceId, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibSMTIndex=fddimibSMTIndex, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibSMT=fddimibSMT, fddimibPORTEntry=fddimibPORTEntry, fddimibSMTEntry=fddimibSMTEntry, fddimibSMTTNotify=fddimibSMTTNotify, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibPORTMyType=fddimibPORTMyType, fddimibPATHIndex=fddimibPATHIndex, fddimibPORT=fddimibPORT, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibMACCountersTable=fddimibMACCountersTable, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibMAC=fddimibMAC, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibMACTNeg=fddimibMACTNeg, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibMACCounters=fddimibMACCounters, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibPATHNumber=fddimibPATHNumber, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibMACTokenCts=fddimibMACTokenCts, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibMACLostCts=fddimibMACLostCts, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibPORTConnectState=fddimibPORTConnectState, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibMACEntry=fddimibMACEntry, fddimibMACTvxValue=fddimibMACTvxValue, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibMACTReq=fddimibMACTReq)
