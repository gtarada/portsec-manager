...
# ASN.1 source http://raw.githubusercontent.com:80/simonjj/SnmpMibs/master/BRIDGE-MIB.mib
...
Counter32, ModuleIdentity, ObjectIdentity, TimeTicks, Integer32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, IpAddress, MibIdentifier, Bits, Unsigned32, NotificationType, Gauge32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "Integer32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "IpAddress", "MibIdentifier", "Bits", "Unsigned32", "NotificationType", "Gauge32", "iso", "NotificationType")
...
dot1dStpPortEnable = MibTableColumn((1, 3, 6, 1, 2, 1, 17, 2, 15, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2)))).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("BRIDGE-MIB", dot1dStpRootPort=dot1dStpRootPort, dot1dTp=dot1dTp, dot1dStpPortDesignatedPort=dot1dStpPortDesignatedPort, dot1dStaticEntry=dot1dStaticEntry, dot1dStpTimeSinceTopologyChange=dot1dStpTimeSinceTopologyChange, dot1dStpForwardDelay=dot1dStpForwardDelay, dot1dSr=dot1dSr, dot1dBasePortIfIndex=dot1dBasePortIfIndex, dot1dTpFdbEntry=dot1dTpFdbEntry, dot1dBaseBridgeAddress=dot1dBaseBridgeAddress, dot1dBasePortTable=dot1dBasePortTable, dot1dStpBridgeHelloTime=dot1dStpBridgeHelloTime, dot1dStpPortEntry=dot1dStpPortEntry, dot1dStpPortForwardTransitions=dot1dStpPortForwardTransitions, dot1dStpTopChanges=dot1dStpTopChanges, dot1dStpProtocolSpecification=dot1dStpProtocolSpecification, dot1dTpLearnedEntryDiscards=dot1dTpLearnedEntryDiscards, dot1dStpPortPathCost=dot1dStpPortPathCost, dot1dBasePort=dot1dBasePort, newRoot=newRoot, topologyChange=topologyChange, dot1dStpDesignatedRoot=dot1dStpDesignatedRoot, dot1dStpHoldTime=dot1dStpHoldTime, dot1dTpPortEntry=dot1dTpPortEntry, dot1dBase=dot1dBase, dot1dStpHelloTime=dot1dStpHelloTime, dot1dBaseNumPorts=dot1dBaseNumPorts, dot1dStpPortState=dot1dStpPortState, dot1dStaticTable=dot1dStaticTable, dot1dStaticAddress=dot1dStaticAddress, dot1dTpPortMaxInfo=dot1dTpPortMaxInfo, dot1dStp=dot1dStp, dot1dBridge=dot1dBridge, dot1dBasePortMtuExceededDiscards=dot1dBasePortMtuExceededDiscards, dot1dStatic=dot1dStatic, dot1dStpPortDesignatedRoot=dot1dStpPortDesignatedRoot, dot1dStpPortDesignatedCost=dot1dStpPortDesignatedCost, dot1dTpPortInFrames=dot1dTpPortInFrames, dot1dStpBridgeMaxAge=dot1dStpBridgeMaxAge, dot1dStpPortEnable=dot1dStpPortEnable, MacAddress=MacAddress, dot1dStpPortPriority=dot1dStpPortPriority, dot1dBasePortEntry=dot1dBasePortEntry, dot1dTpPortTable=dot1dTpPortTable, dot1dTpFdbTable=dot1dTpFdbTable, dot1dStpPriority=dot1dStpPriority, dot1dStpMaxAge=dot1dStpMaxAge, dot1dStpBridgeForwardDelay=dot1dStpBridgeForwardDelay, dot1dBasePortDelayExceededDiscards=dot1dBasePortDelayExceededDiscards, dot1dStaticAllowedToGoTo=dot1dStaticAllowedToGoTo, dot1dStaticStatus=dot1dStaticStatus, dot1dStpPortTable=dot1dStpPortTable, dot1dTpFdbPort=dot1dTpFdbPort, dot1dTpPortOutFrames=dot1dTpPortOutFrames, dot1dTpPortInDiscards=dot1dTpPortInDiscards, dot1dStpPort=dot1dStpPort, dot1dTpAgingTime=dot1dTpAgingTime, dot1dStpPortDesignatedBridge=dot1dStpPortDesignatedBridge, dot1dStaticReceivePort=dot1dStaticReceivePort, dot1dBasePortCircuit=dot1dBasePortCircuit, Timeout=Timeout, dot1dTpPort=dot1dTpPort, dot1dStpRootCost=dot1dStpRootCost, dot1dTpFdbAddress=dot1dTpFdbAddress, dot1dTpFdbStatus=dot1dTpFdbStatus, BridgeId=BridgeId, dot1dBaseType=dot1dBaseType)
