...
Gauge32, ObjectIdentity, Unsigned32, Counter32, NotificationType, TimeTicks, MibIdentifier, ModuleIdentity, iso, Bits, Counter64, Integer32, IpAddress, mib_2, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Unsigned32", "Counter32", "NotificationType", "TimeTicks", "MibIdentifier", "ModuleIdentity", "iso", "Bits", "Counter64", "Integer32", "IpAddress", "mib-2", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("BRIDGE-MIB", dot1dTpFdbEntry=dot1dTpFdbEntry, dot1dTpAgingTime=dot1dTpAgingTime, dot1dTpPortOutFrames=dot1dTpPortOutFrames, dot1dTpPortTable=dot1dTpPortTable, dot1dBridge=dot1dBridge, dot1dStaticStatus=dot1dStaticStatus, dot1dStpPortTable=dot1dStpPortTable, dot1dStpPortDesignatedCost=dot1dStpPortDesignatedCost, dot1dTpFdbAddress=dot1dTpFdbAddress, dot1dStpBridgeHelloTime=dot1dStpBridgeHelloTime, dot1dBasePort=dot1dBasePort, dot1dBasePortCircuit=dot1dBasePortCircuit, dot1dStpRootCost=dot1dStpRootCost, dot1dStpPortEntry=dot1dStpPortEntry, dot1dTpPortInDiscards=dot1dTpPortInDiscards, dot1dStpMaxAge=dot1dStpMaxAge, dot1dBaseBridgeAddress=dot1dBaseBridgeAddress, dot1dTpFdbTable=dot1dTpFdbTable, dot1dTpLearnedEntryDiscards=dot1dTpLearnedEntryDiscards, dot1dBaseNumPorts=dot1dBaseNumPorts, dot1dBase=dot1dBase, dot1dBasePortIfIndex=dot1dBasePortIfIndex, dot1dStpHoldTime=dot1dStpHoldTime, dot1dStpPortForwardTransitions=dot1dStpPortForwardTransitions, dot1dStpRootPort=dot1dStpRootPort, Timeout=Timeout, dot1dStatic=dot1dStatic, dot1dTpPortEntry=dot1dTpPortEntry, dot1dStpPortPathCost=dot1dStpPortPathCost, dot1dStpDesignatedRoot=dot1dStpDesignatedRoot, dot1dTpPortMaxInfo=dot1dTpPortMaxInfo, dot1dTpPort=dot1dTpPort, dot1dBasePortEntry=dot1dBasePortEntry, dot1dTpFdbPort=dot1dTpFdbPort, dot1dBasePortMtuExceededDiscards=dot1dBasePortMtuExceededDiscards, dot1dStpPort=dot1dStpPort, dot1dStpPortDesignatedRoot=dot1dStpPortDesignatedRoot, dot1dStpPortDesignatedBridge=dot1dStpPortDesignatedBridge, dot1dStpPortDesignatedPort=dot1dStpPortDesignatedPort, dot1dStpProtocolSpecification=dot1dStpProtocolSpecification, dot1dBaseType=dot1dBaseType, dot1dStaticAllowedToGoTo=dot1dStaticAllowedToGoTo, dot1dBasePortDelayExceededDiscards=dot1dBasePortDelayExceededDiscards, dot1dSr=dot1dSr, dot1dStp=dot1dStp, dot1dStpBridgeForwardDelay=dot1dStpBridgeForwardDelay, dot1dStpPortEnable=dot1dStpPortEnable, newRoot=newRoot, topologyChange=topologyChange, dot1dStpPriority=dot1dStpPriority, dot1dStpTimeSinceTopologyChange=dot1dStpTimeSinceTopologyChange, dot1dStpPortPriority=dot1dStpPortPriority, dot1dStaticTable=dot1dStaticTable, dot1dStpHelloTime=dot1dStpHelloTime, dot1dStaticReceivePort=dot1dStaticReceivePort, dot1dStpTopChanges=dot1dStpTopChanges, dot1dBasePortTable=dot1dBasePortTable, dot1dTp=dot1dTp, dot1dStpPortState=dot1dStpPortState, BridgeId=BridgeId, dot1dStpBridgeMaxAge=dot1dStpBridgeMaxAge, dot1dTpFdbStatus=dot1dTpFdbStatus, dot1dTpPortInFrames=dot1dTpPortInFrames, dot1dStaticAddress=dot1dStaticAddress, dot1dStaticEntry=dot1dStaticEntry, MacAddress=MacAddress, dot1dStpForwardDelay=dot1dStpForwardDelay)
