...
TimeTicks, IpAddress, MibIdentifier, NotificationType, Counter32, mib_2, iso, Bits, Integer32, Gauge32, ModuleIdentity, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "MibIdentifier", "NotificationType", "Counter32", "mib-2", "iso", "Bits", "Integer32", "Gauge32", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("BRIDGE-MIB", dot1dBasePortTable=dot1dBasePortTable, dot1dTpPortTable=dot1dTpPortTable, dot1dTpPortOutFrames=dot1dTpPortOutFrames, dot1dStpBridgeMaxAge=dot1dStpBridgeMaxAge, dot1dStpPort=dot1dStpPort, dot1dBaseBridgeAddress=dot1dBaseBridgeAddress, dot1dStpBridgeForwardDelay=dot1dStpBridgeForwardDelay, dot1dStpBridgeHelloTime=dot1dStpBridgeHelloTime, dot1dBasePortMtuExceededDiscards=dot1dBasePortMtuExceededDiscards, dot1dStpPortDesignatedRoot=dot1dStpPortDesignatedRoot, dot1dBasePortCircuit=dot1dBasePortCircuit, dot1dTpFdbAddress=dot1dTpFdbAddress, dot1dStpPortDesignatedPort=dot1dStpPortDesignatedPort, dot1dStaticAllowedToGoTo=dot1dStaticAllowedToGoTo, dot1dStpPortPathCost=dot1dStpPortPathCost, newRoot=newRoot, dot1dStpPriority=dot1dStpPriority, dot1dTpPortInDiscards=dot1dTpPortInDiscards, dot1dStpPortEnable=dot1dStpPortEnable, dot1dStatic=dot1dStatic, dot1dStaticEntry=dot1dStaticEntry, topologyChange=topologyChange, dot1dTpAgingTime=dot1dTpAgingTime, dot1dStpHoldTime=dot1dStpHoldTime, dot1dStaticAddress=dot1dStaticAddress, dot1dTpFdbEntry=dot1dTpFdbEntry, dot1dBasePortDelayExceededDiscards=dot1dBasePortDelayExceededDiscards, dot1dBasePortIfIndex=dot1dBasePortIfIndex, dot1dStpDesignatedRoot=dot1dStpDesignatedRoot, dot1dStpPortForwardTransitions=dot1dStpPortForwardTransitions, dot1dBaseType=dot1dBaseType, dot1dStpRootPort=dot1dStpRootPort, dot1dStpPortPriority=dot1dStpPortPriority, MacAddress=MacAddress, dot1dStpPortDesignatedBridge=dot1dStpPortDesignatedBridge, BridgeId=BridgeId, dot1dTpFdbStatus=dot1dTpFdbStatus, dot1dStpMaxAge=dot1dStpMaxAge, dot1dStpPortEntry=dot1dStpPortEntry, dot1dStpHelloTime=dot1dStpHelloTime, dot1dBasePortEntry=dot1dBasePortEntry, dot1dStpTimeSinceTopologyChange=dot1dStpTimeSinceTopologyChange, dot1dTpLearnedEntryDiscards=dot1dTpLearnedEntryDiscards, dot1dTpPortMaxInfo=dot1dTpPortMaxInfo, dot1dStaticTable=dot1dStaticTable, dot1dStpForwardDelay=dot1dStpForwardDelay, Timeout=Timeout, dot1dTpFdbPort=dot1dTpFdbPort, dot1dBasePort=dot1dBasePort, dot1dStpRootCost=dot1dStpRootCost, dot1dBase=dot1dBase, dot1dTpFdbTable=dot1dTpFdbTable, dot1dTpPort=dot1dTpPort, dot1dTpPortInFrames=dot1dTpPortInFrames, dot1dStp=dot1dStp, dot1dStpProtocolSpecification=dot1dStpProtocolSpecification, dot1dBridge=dot1dBridge, dot1dStpTopChanges=dot1dStpTopChanges, dot1dStpPortTable=dot1dStpPortTable, dot1dStaticReceivePort=dot1dStaticReceivePort, dot1dSr=dot1dSr, dot1dStpPortState=dot1dStpPortState, dot1dTpPortEntry=dot1dTpPortEntry, dot1dTp=dot1dTp, dot1dStaticStatus=dot1dStaticStatus, dot1dStpPortDesignatedCost=dot1dStpPortDesignatedCost, dot1dBaseNumPorts=dot1dBaseNumPorts)
