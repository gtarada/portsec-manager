...
# ASN.1 source http://raw.githubusercontent.com:80/simonjj/SnmpMibs/master/RMON2-MIB.mib
...
hostControlEntry, matrix, statistics, historyControlEntry, filterEntry, channelEntry, hosts, OwnerString, matrixControlEntry, history, filter, etherStatsEntry = mibBuilder.importSymbols("RMON-MIB", "hostControlEntry", "matrix", "statistics", "historyControlEntry", "filterEntry", "channelEntry", "hosts", "OwnerString", "matrixControlEntry", "history", "filter", "etherStatsEntry")
...
mibBuilder.exportSymbols("RMON2-MIB", usrHistoryValStatus=usrHistoryValStatus, trapDestOwner=trapDestOwner, protocolDistStatsPkts=protocolDistStatsPkts, protocolDirHostConfig=protocolDirHostConfig, protocolDistStatsOctets=protocolDistStatsOctets, alHostEntry=alHostEntry, hlHostControlAlDeletes=hlHostControlAlDeletes, protocolDistControlDroppedFrames=protocolDistControlDroppedFrames, protocolDistControlIndex=protocolDistControlIndex, alHostInOctets=alHostInOctets, channel2Table=channel2Table, protocolDirLastChange=protocolDirLastChange, ringStationControl2Entry=ringStationControl2Entry, rmon=rmon, ringStationControl2Table=ringStationControl2Table, hlHostControlAlInserts=hlHostControlAlInserts, serialTimeout=serialTimeout, hlMatrixControlDataSource=hlMatrixControlDataSource, hlMatrixControlNlDeletes=hlMatrixControlNlDeletes, alMatrixDSPkts=alMatrixDSPkts, hlMatrixControlStatus=hlMatrixControlStatus, nlMatrixSDTimeMark=nlMatrixSDTimeMark, hostControl2Table=hostControl2Table, nlMatrixSDOctets=nlMatrixSDOctets, probeDownloadAction=probeDownloadAction, protocolDirParameters=protocolDirParameters, nlHostTable=nlHostTable, nlMatrixDSTimeMark=nlMatrixDSTimeMark, serialConnectType=serialConnectType, alMatrixSDOctets=alMatrixSDOctets, ringStationControlDroppedFrames=ringStationControlDroppedFrames, protocolDistControlOwner=protocolDistControlOwner, hlHostControlIndex=hlHostControlIndex, trapDestProtocol=trapDestProtocol, nlMatrixGroup=nlMatrixGroup, etherStatsDroppedFrames=etherStatsDroppedFrames, nlHostOutPkts=nlHostOutPkts, nlMatrixTopNControlTable=nlMatrixTopNControlTable, serialModemHangUpString=serialModemHangUpString, channelDroppedFrames=channelDroppedFrames, hlHostControlEntry=hlHostControlEntry, nlMatrixTopNControlGrantedSize=nlMatrixTopNControlGrantedSize, addressMapTable=addressMapTable, nlMatrixTopNReversePktRate=nlMatrixTopNReversePktRate, alHostTable=alHostTable, usrHistoryControlTable=usrHistoryControlTable, protocolDirOwner=protocolDirOwner, alMatrixSDTable=alMatrixSDTable, netDefaultGateway=netDefaultGateway, alMatrixTopNControlStartTime=alMatrixTopNControlStartTime, matrixControlDroppedFrames=matrixControlDroppedFrames, addressMapControlDataSource=addressMapControlDataSource, PYSNMP_MODULE_ID=rmon, alMatrixTopNPktRate=alMatrixTopNPktRate, serialConfigEntry=serialConfigEntry, nlMatrixTopNControlRequestedSize=nlMatrixTopNControlRequestedSize, nlHost=nlHost, hlHostControlTable=hlHostControlTable, alMatrixTopNControlOwner=alMatrixTopNControlOwner, probeConfig=probeConfig, alMatrixTopNControlRequestedSize=alMatrixTopNControlRequestedSize, serialConnectSwitchDisconnectSeq=serialConnectSwitchDisconnectSeq, addressMapSource=addressMapSource, serialMode=serialMode, tokenRingMLStatsDroppedFrames=tokenRingMLStatsDroppedFrames, filterProtocolDirDataLocalIndex=filterProtocolDirDataLocalIndex, addressMapGroup=addressMapGroup, addressMapLastChange=addressMapLastChange, DataSource=DataSource, alHost=alHost, hlMatrixControlNlDroppedFrames=hlMatrixControlNlDroppedFrames, nlMatrixTopNControlDuration=nlMatrixTopNControlDuration, nlMatrixTopNIndex=nlMatrixTopNIndex, usrHistoryAbsValue=usrHistoryAbsValue, rmon2MIBCompliances=rmon2MIBCompliances, alMatrixTopNControlTable=alMatrixTopNControlTable, addressMapEntry=addressMapEntry, serialConnectionEntry=serialConnectionEntry, tokenRingPStats2Table=tokenRingPStats2Table, serialConnectOwner=serialConnectOwner, nlMatrixTopNProtocolDirLocalIndex=nlMatrixTopNProtocolDirLocalIndex, usrHistoryControlEntry=usrHistoryControlEntry, usrHistoryObjectIndex=usrHistoryObjectIndex, usrHistorySampleIndex=usrHistorySampleIndex, protocolDir=protocolDir, protocolDirType=protocolDirType, nlMatrixTopNControlStartTime=nlMatrixTopNControlStartTime, usrHistoryGroup=usrHistoryGroup, hlMatrixControlAlMaxDesiredEntries=hlMatrixControlAlMaxDesiredEntries, usrHistoryControlStatus=usrHistoryControlStatus, nlMatrixTopNControlGeneratedReports=nlMatrixTopNControlGeneratedReports, alMatrixDSEntry=alMatrixDSEntry, trapDestAddress=trapDestAddress, trapDestEntry=trapDestEntry, alMatrixSDTimeMark=alMatrixSDTimeMark, filterProtocolDirLocalIndex=filterProtocolDirLocalIndex, rmon1EthernetEnhancementGroup=rmon1EthernetEnhancementGroup, nlHostOutMacNonUnicastPkts=nlHostOutMacNonUnicastPkts, trapDestCommunity=trapDestCommunity, probeInformationGroup=probeInformationGroup, nlMatrixTopNPktRate=nlMatrixTopNPktRate, serialConnectSwitchResetSeq=serialConnectSwitchResetSeq, usrHistoryControlObjects=usrHistoryControlObjects, nlMatrixTopNControlEntry=nlMatrixTopNControlEntry, tokenRingMLStatsCreateTime=tokenRingMLStatsCreateTime, nlMatrixSDEntry=nlMatrixSDEntry, alMatrixTopNTable=alMatrixTopNTable, hlHostControlDataSource=hlHostControlDataSource, hlMatrixControlTable=hlMatrixControlTable, nlMatrixSDSourceAddress=nlMatrixSDSourceAddress, protocolDirEntry=protocolDirEntry, nlMatrixSDPkts=nlMatrixSDPkts, nlMatrixTopNOctetRate=nlMatrixTopNOctetRate, matrixControl2Table=matrixControl2Table, channel2Entry=channel2Entry, rmon1TokenRingEnhancementGroup=rmon1TokenRingEnhancementGroup, nlMatrixSDCreateTime=nlMatrixSDCreateTime, historyControl2Entry=historyControl2Entry, probeHardwareRev=probeHardwareRev, sourceRoutingStatsDroppedFrames=sourceRoutingStatsDroppedFrames, hlHostControlAlDroppedFrames=hlHostControlAlDroppedFrames, nlMatrixDSPkts=nlMatrixDSPkts, nlMatrixDSTable=nlMatrixDSTable, protocolDirLocalIndex=protocolDirLocalIndex, addressMapControlOwner=addressMapControlOwner, alMatrixTopNControlTimeRemaining=alMatrixTopNControlTimeRemaining, usrHistory=usrHistory, sourceRoutingStats2Table=sourceRoutingStats2Table, rmon1EnhancementGroup=rmon1EnhancementGroup, nlMatrixDSCreateTime=nlMatrixDSCreateTime, alHostCreateTime=alHostCreateTime, hlHostControlNlMaxDesiredEntries=hlHostControlNlMaxDesiredEntries, alMatrixTopNControlGeneratedReports=alMatrixTopNControlGeneratedReports, hostControl2Entry=hostControl2Entry, protocolDist=protocolDist, nlMatrix=nlMatrix, probeDownloadStatus=probeDownloadStatus, trapDestStatus=trapDestStatus, probeDownloadFile=probeDownloadFile, serialConnectDialString=serialConnectDialString, usrHistoryTable=usrHistoryTable, tokenRingMLStats2Entry=tokenRingMLStats2Entry, alMatrixTopNAppProtocolDirLocalIndex=alMatrixTopNAppProtocolDirLocalIndex, alMatrixTopNControlStatus=alMatrixTopNControlStatus, addressMap=addressMap, nlHostAddress=nlHostAddress, hlMatrixControlIndex=hlMatrixControlIndex, hlMatrixControlAlInserts=hlMatrixControlAlInserts, alHostTimeMark=alHostTimeMark, rmonConformance=rmonConformance, hlHostControlStatus=hlHostControlStatus, addressMapDeletes=addressMapDeletes, nlMatrixDSDestAddress=nlMatrixDSDestAddress, nlMatrixTopNReverseOctetRate=nlMatrixTopNReverseOctetRate, nlMatrixTopNControlIndex=nlMatrixTopNControlIndex, etherStats2Entry=etherStats2Entry, tokenRingPStats2Entry=tokenRingPStats2Entry, alMatrixSDCreateTime=alMatrixSDCreateTime, alMatrixTopNControlIndex=alMatrixTopNControlIndex, serialModemConnectResp=serialModemConnectResp, usrHistoryIntervalStart=usrHistoryIntervalStart, channelCreateTime=channelCreateTime, nlHostOutOctets=nlHostOutOctets, ringStationControlCreateTime=ringStationControlCreateTime, nlHostTimeMark=nlHostTimeMark, usrHistoryControlBucketsGranted=usrHistoryControlBucketsGranted, nlHostGroup=nlHostGroup, alMatrixDSCreateTime=alMatrixDSCreateTime, alMatrixTopNDestAddress=alMatrixTopNDestAddress, filter2Table=filter2Table, protocolDistributionGroup=protocolDistributionGroup, protocolDirID=protocolDirID, hlHostControlNlDeletes=hlHostControlNlDeletes, protocolDistControlStatus=protocolDistControlStatus, protocolDirMatrixConfig=protocolDirMatrixConfig, hlMatrixControlNlInserts=hlMatrixControlNlInserts, alMatrixDSTable=alMatrixDSTable, addressMapInserts=addressMapInserts, historyControlDroppedFrames=historyControlDroppedFrames, hlMatrixControlAlDeletes=hlMatrixControlAlDeletes, nlMatrixSDTable=nlMatrixSDTable, nlMatrixDSEntry=nlMatrixDSEntry, nlMatrixTopNControlStatus=nlMatrixTopNControlStatus, sourceRoutingStatsCreateTime=sourceRoutingStatsCreateTime, alMatrixTopNControlGrantedSize=alMatrixTopNControlGrantedSize, usrHistoryControlOwner=usrHistoryControlOwner, trapDestTable=trapDestTable, historyControl2Table=historyControl2Table, alMatrixTopNReversePktRate=alMatrixTopNReversePktRate, usrHistoryControlBucketsRequested=usrHistoryControlBucketsRequested, serialModemNoConnectResp=serialModemNoConnectResp, sourceRoutingStats2Entry=sourceRoutingStats2Entry, nlMatrixTopNTable=nlMatrixTopNTable, netConfigIPAddress=netConfigIPAddress, usrHistoryObjectTable=usrHistoryObjectTable, netConfigEntry=netConfigEntry, addressMapControlDroppedFrames=addressMapControlDroppedFrames, matrixControlCreateTime=matrixControlCreateTime, tokenRingPStatsDroppedFrames=tokenRingPStatsDroppedFrames, hlHostControlOwner=hlHostControlOwner, alMatrixTopNSourceAddress=alMatrixTopNSourceAddress, nlMatrixDSOctets=nlMatrixDSOctets, netConfigTable=netConfigTable, probeConfigurationGroup=probeConfigurationGroup, serialConnectionTable=serialConnectionTable, tokenRingMLStats2Table=tokenRingMLStats2Table, nlHostEntry=nlHostEntry, alMatrixTopNIndex=alMatrixTopNIndex, usrHistoryObjectVariable=usrHistoryObjectVariable, nlHostCreateTime=nlHostCreateTime, probeSoftwareRev=probeSoftwareRev, nlMatrixTopNControlRateBase=nlMatrixTopNControlRateBase, usrHistoryIntervalEnd=usrHistoryIntervalEnd, serialConnectStatus=serialConnectStatus, rmon2MIBApplicationLayerCompliance=rmon2MIBApplicationLayerCompliance, alMatrixTopNControlRateBase=alMatrixTopNControlRateBase, alMatrixTopNProtocolDirLocalIndex=alMatrixTopNProtocolDirLocalIndex, alMatrixGroup=alMatrixGroup, protocolDirectoryGroup=protocolDirectoryGroup, matrixControl2Entry=matrixControl2Entry, usrHistoryControlInterval=usrHistoryControlInterval, usrHistoryObjectEntry=usrHistoryObjectEntry, protocolDistControlDataSource=protocolDistControlDataSource, hlHostControlNlDroppedFrames=hlHostControlNlDroppedFrames, addressMapControlTable=addressMapControlTable, alHostInPkts=alHostInPkts, alMatrixTopNControlEntry=alMatrixTopNControlEntry, serialConnectIndex=serialConnectIndex, serialConnectSwitchConnectSeq=serialConnectSwitchConnectSeq, alHostOutPkts=alHostOutPkts, hlMatrixControlNlMaxDesiredEntries=hlMatrixControlNlMaxDesiredEntries, nlHostInOctets=nlHostInOctets, hlMatrixControlEntry=hlMatrixControlEntry, hostControlCreateTime=hostControlCreateTime, alMatrixDSOctets=alMatrixDSOctets, hlMatrixControlOwner=hlMatrixControlOwner, alHostOutOctets=alHostOutOctets, usrHistoryControlIndex=usrHistoryControlIndex, netConfigStatus=netConfigStatus, probeCapabilities=probeCapabilities, etherStats2Table=etherStats2Table, hostControlDroppedFrames=hostControlDroppedFrames, trapDestIndex=trapDestIndex, rmon2MIBGroups=rmon2MIBGroups, protocolDirAddressMapConfig=protocolDirAddressMapConfig, addressMapTimeMark=addressMapTimeMark, alMatrixDSTimeMark=alMatrixDSTimeMark, protocolDistStatsTable=protocolDistStatsTable, usrHistoryObjectSampleType=usrHistoryObjectSampleType, nlHostInPkts=nlHostInPkts, nlMatrixTopNControlMatrixIndex=nlMatrixTopNControlMatrixIndex, alMatrixTopNControlMatrixIndex=alMatrixTopNControlMatrixIndex, probeResetControl=probeResetControl, LastCreateTime=LastCreateTime)
mibBuilder.exportSymbols("RMON2-MIB", hlHostControlAlMaxDesiredEntries=hlHostControlAlMaxDesiredEntries, hlMatrixControlAlDroppedFrames=hlMatrixControlAlDroppedFrames, alMatrixTopNEntry=alMatrixTopNEntry, alMatrixTopNControlDuration=alMatrixTopNControlDuration, serialConnectDestIpAddress=serialConnectDestIpAddress, addressMapControlStatus=addressMapControlStatus, serialStatus=serialStatus, nlMatrixTopNDestAddress=nlMatrixTopNDestAddress, protocolDirTable=protocolDirTable, protocolDistStatsEntry=protocolDistStatsEntry, nlMatrixSDDestAddress=nlMatrixSDDestAddress, TimeFilter=TimeFilter, nlMatrixDSSourceAddress=nlMatrixDSSourceAddress, addressMapNetworkAddress=addressMapNetworkAddress, addressMapPhysicalAddress=addressMapPhysicalAddress, addressMapControlIndex=addressMapControlIndex, hlHostControlNlInserts=hlHostControlNlInserts, protocolDirDescr=protocolDirDescr, nlMatrixTopNControlTimeRemaining=nlMatrixTopNControlTimeRemaining, alMatrix=alMatrix, protocolDistControlTable=protocolDistControlTable, alMatrixSDEntry=alMatrixSDEntry, serialModemInitString=serialModemInitString, alMatrixTopNOctetRate=alMatrixTopNOctetRate, etherStatsCreateTime=etherStatsCreateTime, nlMatrixTopNEntry=nlMatrixTopNEntry, filter2Entry=filter2Entry, rmon2MIBCompliance=rmon2MIBCompliance, probeDateTime=probeDateTime, alHostGroup=alHostGroup, alMatrixTopNReverseOctetRate=alMatrixTopNReverseOctetRate, protocolDirStatus=protocolDirStatus, serialProtocol=serialProtocol, serialDialoutTimeout=serialDialoutTimeout, protocolDistControlCreateTime=protocolDistControlCreateTime, netConfigSubnetMask=netConfigSubnetMask, tokenRingPStatsCreateTime=tokenRingPStatsCreateTime, nlMatrixTopNControlOwner=nlMatrixTopNControlOwner, protocolDistControlEntry=protocolDistControlEntry, usrHistoryEntry=usrHistoryEntry, addressMapControlEntry=addressMapControlEntry, ControlString=ControlString, probeDownloadTFTPServer=probeDownloadTFTPServer, serialConfigTable=serialConfigTable, addressMapMaxDesiredEntries=addressMapMaxDesiredEntries, ZeroBasedCounter32=ZeroBasedCounter32, nlMatrixTopNSourceAddress=nlMatrixTopNSourceAddress, alMatrixSDPkts=alMatrixSDPkts)
