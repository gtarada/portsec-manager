...
# ASN.1 source http://raw.githubusercontent.com:80/simonjj/SnmpMibs/master/CISCO-VTP-MIB.mib
...
NotificationType, Counter32, ObjectIdentity, IpAddress, MibIdentifier, Integer32, iso, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "ObjectIdentity", "IpAddress", "MibIdentifier", "Integer32", "iso", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "ModuleIdentity", "Unsigned32")
DisplayString, TruthValue, DateAndTime, TimeStamp, TextualConvention, RowStatus, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "DateAndTime", "TimeStamp", "TextualConvention", "RowStatus", "TestAndIncr")
ciscoVtpMIB = ModuleIdentity((1, 3, 6, 1, 4, 1, 9, 9, 46))
ciscoVtpMIB.setRevisions(('2006-02-17 00:00', '2004-02-11 00:00', '2003-11-21 00:00', '2003-08-08 00:00', '2003-07-11 00:00', '2003-04-16 00:00', '2002-04-10 00:00', '2002-02-28 00:00', '2001-08-03 00:00', '2001-02-26 00:00', '2001-02-12 00:00', '2000-09-19 00:00', '2000-04-10 00:00', '2000-01-06 00:00', '1999-02-25 11:30', '1999-01-05 11:30', '1998-05-19 11:30', '1997-08-08 11:38', '1997-05-09 11:30', '1997-02-24 11:15', '1997-01-27 17:30', '1996-09-16 12:30', '1996-07-17 12:30', '1996-01-18 18:20',))
if mibBuilder.loadTexts: ciscoVtpMIB.setLastUpdated('200602170000Z')
...
vtpMIBCompliance = ModuleCompliance((1, 3, 6, 1, 4, 1, 9, 9, 46, 3, 1, 1)).setObjects(("CISCO-VTP-MIB", "vtpBasicGroup"), ("CISCO-VTP-MIB", "vtpVlanInfoGroup"), ("CISCO-VTP-MIB", "vtpStatsGroup"), ("CISCO-VTP-MIB", "vtpTrunkPortGroup"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    vtpMIBCompliance = vtpMIBCompliance.setStatus('deprecated')
vtpMIBCompliance2 = ModuleCompliance((1, 3, 6, 1, 4, 1, 9, 9, 46, 3, 1, 2)).setObjects(("CISCO-VTP-MIB", "vtpBasicGroup"), ("CISCO-VTP-MIB", "vtpVlanInfoGroup"), ("CISCO-VTP-MIB", "vtpStatsGroup"), ("CISCO-VTP-MIB", "vtpTrunkPortGroup"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    vtpMIBCompliance2 = vtpMIBCompliance2.setStatus('deprecated')
vtpMIBCompliance3 = ModuleCompliance((1, 3, 6, 1, 4, 1, 9, 9, 46, 3, 1, 3)).setObjects(("CISCO-VTP-MIB", "vtpBasicGroup"), ("CISCO-VTP-MIB", "vtpVlanInfoGroup"), ("CISCO-VTP-MIB", "vtpStatsGroup"), ("CISCO-VTP-MIB", "vtpTrunkPortGroup"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    vtpMIBCompliance3 = vtpMIBCompliance3.setStatus('deprecated')
vtpMIBCompliance4 = ModuleCompliance((1, 3, 6, 1, 4, 1, 9, 9, 46, 3, 1, 4)).setObjects(("CISCO-VTP-MIB", "vtpBasicGroup"), ("CISCO-VTP-MIB", "vtpVlanInfoGroup"), ("CISCO-VTP-MIB", "vtpStatsGroup"), ("CISCO-VTP-MIB", "vtpTrunkPortGroup"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    vtpMIBCompliance4 = vtpMIBCompliance4.setStatus('deprecated')
vtpMIBCompliance5 = ModuleCompliance((1, 3, 6, 1, 4, 1, 9, 9, 46, 3, 1, 5)).setObjects(("CISCO-VTP-MIB", "vtpBasicGroup"), ("CISCO-VTP-MIB", "vtpVlanInfoGroup"), ("CISCO-VTP-MIB", "vtpStatsGroup"), ("CISCO-VTP-MIB", "vtpTrunkPortGroup"), ("CISCO-VTP-MIB", "vtpVersion2BasicGroup"))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    vtpMIBCompliance5 = vtpMIBCompliance5.setStatus('deprecated')
vtpMIBCompliance6 = ModuleCompliance((1, 3, 6, 1, 4, 1, 9, 9, 46, 3, 1, 6)).setObjects(("CISCO-VTP-MIB", "vtpBasicGroup"), ("CISCO-VTP-MIB", "vtpVlanInfoGroup"), ("CISCO-VTP-MIB", "vtpConfigNotificationsGroup"), ("CISCO-VTP-MIB", "vtpStatsGroup"), ("CISCO-VTP-MIB", "vtpTrunkPortGroup"), ("CISCO-VTP-MIB", "vtpVersion2BasicGroup"), ("CISCO-VTP-MIB", "vtpNotificationObjectsGroup"))
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    vtpMIBCompliance12 = vtpMIBCompliance12.setStatus('current')
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    vtpConfigNotificationsGroup5 = vtpConfigNotificationsGroup5.setStatus('current')
...
mibBuilder.exportSymbols("CISCO-VTP-MIB", vtpInternalVlanOwner=vtpInternalVlanOwner, vtpDatabaseLocalMode=vtpDatabaseLocalMode, vtpVlanEditIndex=vtpVlanEditIndex, vtpVlanEditName=vtpVlanEditName, vtpStatsTable=vtpStatsTable, vtpVlanPortLocalSegment=vtpVlanPortLocalSegment, vtpDatabasePrimaryServerId=vtpDatabasePrimaryServerId, vlanTrunkPortVlansXmitJoined3k=vlanTrunkPortVlansXmitJoined3k, PYSNMP_MODULE_ID=ciscoVtpMIB, managementDomainIndex=managementDomainIndex, vtpInAdvertRequests=vtpInAdvertRequests, vtpDiscoverResultRevNumber=vtpDiscoverResultRevNumber, vtpMIBCompliance10=vtpMIBCompliance10, vlanManagementDomains=vlanManagementDomains, vlanTrunkPortRowStatus=vlanTrunkPortRowStatus, vtpMIBCompliance12=vtpMIBCompliance12, vtpVlanDot10Said=vtpVlanDot10Said, managementDomainLastChange=managementDomainLastChange, vtpVlanEditConfigRevNumber=vtpVlanEditConfigRevNumber, vtpVlanEntry=vtpVlanEntry, vtpDiscoverGroup=vtpDiscoverGroup, vtpVlanInfoGroup=vtpVlanInfoGroup, vtp4kVlanGroupRev1=vtp4kVlanGroupRev1, vtpLocalModeChanged=vtpLocalModeChanged, managementDomainTable=managementDomainTable, vtpConfigNotificationsGroupRev1=vtpConfigNotificationsGroupRev1, vtpVlanBridgeType=vtpVlanBridgeType, vtpOutAdvertRequests=vtpOutAdvertRequests, vtpConfigNotificationsGroup5=vtpConfigNotificationsGroup5, vtpVlanState=vtpVlanState, vtpVlansPruningEligible4k=vtpVlansPruningEligible4k, vtpVlanMtu=vtpVlanMtu, vlanTrunkPortVlansRcvJoined4k=vlanTrunkPortVlansRcvJoined4k, vlanTrunkPortInJoins=vlanTrunkPortInJoins, vlanTrunkPorts=vlanTrunkPorts, vtpDiscoverResultTable=vtpDiscoverResultTable, vtpVersionOneDeviceDetected=vtpVersionOneDeviceDetected, vtpBasicGroup=vtpBasicGroup, vtpConfigRevNumberError=vtpConfigRevNumberError, VlanType=VlanType, vtpVlanIsCRFBackup=vtpVlanIsCRFBackup, vtpMIBCompliance5=vtpMIBCompliance5, vtpInternalVlanEntry=vtpInternalVlanEntry, vtpDatabaseTakeOverPassword=vtpDatabaseTakeOverPassword, vtpVlanTable=vtpVlanTable, vtpMIBCompliance4=vtpMIBCompliance4, vlanTrunkPortIfIndex=vlanTrunkPortIfIndex, vtpVlanEditTypeExt2=vtpVlanEditTypeExt2, vlanTrunkPortVlansXmitJoined2k=vlanTrunkPortVlansXmitJoined2k, vtpMIBCompliance2=vtpMIBCompliance2, vtpVlanName=vtpVlanName, vtpStatsGroup=vtpStatsGroup, vtpInSummaryAdverts=vtpInSummaryAdverts, vtpMIBCompliance11=vtpMIBCompliance11, vtpNotificationsObjects=vtpNotificationsObjects, vtpVlanAreHopCount=vtpVlanAreHopCount, vtpStats=vtpStats, vtpMtuTooBig=vtpMtuTooBig, vtpVlanEditType=vtpVlanEditType, vlanTrunkPortEncapsulationOperType=vlanTrunkPortEncapsulationOperType, vtpDatabasePrimaryServer=vtpDatabasePrimaryServer, vtpOutSubsetAdverts=vtpOutSubsetAdverts, vtpDatabaseGroup=vtpDatabaseGroup, vtpVlanEditOperation=vtpVlanEditOperation, vtpOutSummaryAdverts=vtpOutSummaryAdverts, vtpAuthGroup=vtpAuthGroup, vtpVlanEditRowStatus=vtpVlanEditRowStatus, vtpDiscoverAction=vtpDiscoverAction, vlanTrunkPortSetSerialNo=vlanTrunkPortSetSerialNo, ManagementDomainIndex=ManagementDomainIndex, vlanTrunkPortVlansRcvJoined2k=vlanTrunkPortVlansRcvJoined2k, vtpDatabaseTable=vtpDatabaseTable, vlanTrunkPortVlansXmitJoined4k=vlanTrunkPortVlansXmitJoined4k, vlanTrunkPortVlansXmitJoined=vlanTrunkPortVlansXmitJoined, vtpVlanNotifEnabledGroup=vtpVlanNotifEnabledGroup, vtpTrunkPruningGroup=vtpTrunkPruningGroup, vtpAuthentication=vtpAuthentication, vtpVlanIfIndexGroup=vtpVlanIfIndexGroup, vtpVlanEditTranslationalVlan2=vtpVlanEditTranslationalVlan2, vtpDiscoverResultConflicting=vtpDiscoverResultConflicting, vtpVersionInUseChanged=vtpVersionInUseChanged, vtpDot1qTunnelGroup=vtpDot1qTunnelGroup, managementDomainName=managementDomainName, vtpVlanEditBridgeNumber=vtpVlanEditBridgeNumber, vtpMIBConformance=vtpMIBConformance, vtpConfigRevNumberErrors=vtpConfigRevNumberErrors, vlanTrunkPortVlansPruningEligible=vlanTrunkPortVlansPruningEligible, vtpDiscoverResultDeviceId=vtpDiscoverResultDeviceId, managementDomainConfigRevNumber=managementDomainConfigRevNumber, vtpInSubsetAdverts=vtpInSubsetAdverts, vlanTrunkPortVtpEnabled=vlanTrunkPortVtpEnabled, vtpEditControlEntry=vtpEditControlEntry, vlanTrunkPortsDot1qTag=vlanTrunkPortsDot1qTag, vlanTrunkPortManagementDomain=vlanTrunkPortManagementDomain, managementDomainRowStatus=managementDomainRowStatus, vtpConfigNotificationsGroup4=vtpConfigNotificationsGroup4, vtpVlansPruningEligible2k=vtpVlansPruningEligible2k, vtpMaxVlanStorage=vtpMaxVlanStorage, vtpLastDiscoverTime=vtpLastDiscoverTime, vtpNotificationObjectsGroup=vtpNotificationObjectsGroup, vtpMIBCompliance8=vtpMIBCompliance8, vtpVlanEditTypeExt=vtpVlanEditTypeExt, vtpDiscoverTable=vtpDiscoverTable, managementDomainTftpServer=managementDomainTftpServer, vlanTrunkPortTable=vlanTrunkPortTable, vtpVlanIndex=vtpVlanIndex, vtpVlanBridgeNumber=vtpVlanBridgeNumber, vtpDiscoverResultSystemName=vtpDiscoverResultSystemName, vtpServerDisabled=vtpServerDisabled, vtpAuthPassword=vtpAuthPassword, vtpDiscoverStatus=vtpDiscoverStatus, vtpDatabase=vtpDatabase, vtpAuthenticationTable=vtpAuthenticationTable, managementDomainLocalMode=managementDomainLocalMode, vtpNotificationsEnabled=vtpNotificationsEnabled, vlanTrunkPortVlansEnabled=vlanTrunkPortVlansEnabled, vtpDiscoverResultEntry=vtpDiscoverResultEntry, vtpDot1qTunnelGroup2=vtpDot1qTunnelGroup2, vtpVlanStpType=vtpVlanStpType, vlanTrunkPortVlansRcvJoined3k=vlanTrunkPortVlansRcvJoined3k, vtpVlanEditTable=vtpVlanEditTable, vtpVlanEditDot10Said=vtpVlanEditDot10Said, vtpAuthSecretKey=vtpAuthSecretKey, vtpConfigNotificationsGroup3=vtpConfigNotificationsGroup3, vtpVlanEditParentVlan=vtpVlanEditParentVlan, vtpDatabaseName=vtpDatabaseName, vtpNotifications=vtpNotifications, vtpMIBGroups=vtpMIBGroups, vtpVlanEditTranslationalVlan1=vtpVlanEditTranslationalVlan1, managementDomainPruningState=managementDomainPruningState, ciscoVtpMIB=ciscoVtpMIB, vlanTrunkPortNativeVlan=vlanTrunkPortNativeVlan, vtpDiscoverResultIndex=vtpDiscoverResultIndex, vtpVlanTranslationalVlan1=vtpVlanTranslationalVlan1, vtpDiscoverResultPrimaryServer=vtpDiscoverResultPrimaryServer, vtpDiscover=vtpDiscover, vtpVlanRingNumber=vtpVlanRingNumber, vtpDatabaseIndex=vtpDatabaseIndex, vtpDatabaseEntry=vtpDatabaseEntry, vtpVlanIfIndex=vtpVlanIfIndex, internalVlanInfo=internalVlanInfo, vtpTrunkPortGroup3=vtpTrunkPortGroup3, vtpConfigDigestErrors=vtpConfigDigestErrors, vtpVlanEditAreHopCount=vtpVlanEditAreHopCount, vtpVersion=vtpVersion, managementDomainEntry=managementDomainEntry, vlanTrunkPortDot1qTunnel=vlanTrunkPortDot1qTunnel, vtpNotificationsPrefix=vtpNotificationsPrefix, vtpVlanSteHopCount=vtpVlanSteHopCount, vtpVlanEditBufferOwner=vtpVlanEditBufferOwner, vtpVlanDeleted=vtpVlanDeleted, vtpMIBCompliance9=vtpMIBCompliance9, vtpAuthEntry=vtpAuthEntry, vtpTrunkPruningGroup2=vtpTrunkPruningGroup2, vlanTrunkPortEncapsulationType=vlanTrunkPortEncapsulationType, vlanEdit=vlanEdit, vtpVlanInfoEditGroup2=vtpVlanInfoEditGroup2, vlanTrunkPortVlansRcvJoined=vlanTrunkPortVlansRcvJoined, vtpVlanType=vtpVlanType, vtpVlanInfoEditGroup=vtpVlanInfoEditGroup, vtpVlanEditBridgeType=vtpVlanEditBridgeType, vtpVersion2BasicGroup=vtpVersion2BasicGroup, vtpInternalVlanAllocPolicy=vtpInternalVlanAllocPolicy, vtpVlanDeletedNotifEnabled=vtpVlanDeletedNotifEnabled, vlanTrunkPortVlansEnabled3k=vlanTrunkPortVlansEnabled3k, vtpInternalVlanTable=vtpInternalVlanTable, vlanTrunkPortEntry=vlanTrunkPortEntry, vtpMIBCompliances=vtpMIBCompliances, vtpDatabaseRevNumber=vtpDatabaseRevNumber, vtpVlanEditRingNumber=vtpVlanEditRingNumber, vtpVlanEditSteHopCount=vtpVlanEditSteHopCount, vtpMIBCompliance3=vtpMIBCompliance3, vtpConfigNotificationsGroup=vtpConfigNotificationsGroup, vtpVlanEditIsCRFBackup=vtpVlanEditIsCRFBackup, vlanInfo=vlanInfo, vtpVlanApplyStatus=vtpVlanApplyStatus, vtpVlanEditState=vtpVlanEditState, vlanTrunkPortVlansEnabled2k=vlanTrunkPortVlansEnabled2k, vtpVlanTranslationalVlan2=vtpVlanTranslationalVlan2, vtpAuthPasswordType=vtpAuthPasswordType, vtpDiscoverEntry=vtpDiscoverEntry, vtp4kVlanGroup=vtp4kVlanGroup, managementDomainTftpPathname=managementDomainTftpPathname, vtpConfigNotificationsGroup2=vtpConfigNotificationsGroup2, vtpInternalVlanGrp=vtpInternalVlanGrp, vlanTrunkPortDynamicStatus=vlanTrunkPortDynamicStatus, vtpVlanEditEntry=vtpVlanEditEntry, vlanTrunkPortDynamicStatusChange=vlanTrunkPortDynamicStatusChange, vtpDatabaseTakeOverPrimary=vtpDatabaseTakeOverPrimary, vtpVlanEditStpType=vtpVlanEditStpType, vtpMIBCompliance=vtpMIBCompliance, vtpTrunkPortGroup2=vtpTrunkPortGroup2, vtpMIBObjects=vtpMIBObjects, VlanIndex=VlanIndex, vtpMIBCompliance6=vtpMIBCompliance6, VlanTypeExt=VlanTypeExt, vtpDiscoverResultDatabaseName=vtpDiscoverResultDatabaseName, vtpConfigDigestError=vtpConfigDigestError, managementDomainVersionInUse=managementDomainVersionInUse, vtpVlanEditModifiedVlan=vtpVlanEditModifiedVlan, vtpVlanEditMtu=vtpVlanEditMtu, vtpTrunkPortGroup=vtpTrunkPortGroup, vtpVlanRingNumberConflict=vtpVlanRingNumberConflict, vtpVlanTypeExt=vtpVlanTypeExt, vlanTrunkPortOutJoins=vlanTrunkPortOutJoins, vtpStatus=vtpStatus, vlanTrunkPortOldAdverts=vlanTrunkPortOldAdverts, managementDomainLastUpdater=managementDomainLastUpdater, vtpMIBCompliance7=vtpMIBCompliance7, vlanTrunkPortDynamicState=vlanTrunkPortDynamicState, vtpVlanCreated=vtpVlanCreated, vtpEditControlTable=vtpEditControlTable, vtpVlanParentVlan=vtpVlanParentVlan, vtpStatsEntry=vtpStatsEntry, vlanTrunkPortVlansEnabled4k=vlanTrunkPortVlansEnabled4k, vtpVlanCreatedNotifEnabled=vtpVlanCreatedNotifEnabled, vtpVlansPruningEligible3k=vtpVlansPruningEligible3k)
