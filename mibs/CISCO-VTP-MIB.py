...
DateAndTime, DisplayString, RowStatus, TextualConvention, TimeStamp, TruthValue, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "DisplayString", "RowStatus", "TextualConvention", "TimeStamp", "TruthValue", "TestAndIncr")
...
mibBuilder.exportSymbols("CISCO-VTP-MIB", vtpVlanIsCRFBackup=vtpVlanIsCRFBackup, vtpDatabaseName=vtpDatabaseName, vtpVlanName=vtpVlanName, vtpDiscoverResultDeviceId=vtpDiscoverResultDeviceId, vtpVlanTranslationalVlan2=vtpVlanTranslationalVlan2, vlanTrunkPortDynamicState=vlanTrunkPortDynamicState, vtpConfigNotificationsGroup4=vtpConfigNotificationsGroup4, vtpDatabaseIndex=vtpDatabaseIndex, vtpMIBCompliance6=vtpMIBCompliance6, vtpConfigDigestError=vtpConfigDigestError, VlanIndex=VlanIndex, vtpVlanEditOperation=vtpVlanEditOperation, vtpMIBConformance=vtpMIBConformance, vtpMIBGroups=vtpMIBGroups, vtpDiscoverEntry=vtpDiscoverEntry, managementDomainEntry=managementDomainEntry, vtpTrunkPruningGroup=vtpTrunkPruningGroup, vlanTrunkPortVtpEnabled=vlanTrunkPortVtpEnabled, ManagementDomainIndex=ManagementDomainIndex, vtpVlanInfoEditGroup2=vtpVlanInfoEditGroup2, vtpDiscoverResultIndex=vtpDiscoverResultIndex, vlanTrunkPortNativeVlan=vlanTrunkPortNativeVlan, vtpDiscover=vtpDiscover, vtpDot1qTunnelGroup2=vtpDot1qTunnelGroup2, vtpDatabaseLocalMode=vtpDatabaseLocalMode, vlanTrunkPortOutJoins=vlanTrunkPortOutJoins, vtpVlanParentVlan=vtpVlanParentVlan, VlanTypeExt=VlanTypeExt, vtpVlanEditTranslationalVlan1=vtpVlanEditTranslationalVlan1, vtpNotificationsObjects=vtpNotificationsObjects, vtpVlanEditMtu=vtpVlanEditMtu, vlanTrunkPortVlansEnabled3k=vlanTrunkPortVlansEnabled3k, vtpMaxVlanStorage=vtpMaxVlanStorage, vtpVlanDot10Said=vtpVlanDot10Said, vtpConfigNotificationsGroup2=vtpConfigNotificationsGroup2, vtpInternalVlanAllocPolicy=vtpInternalVlanAllocPolicy, vtpInSubsetAdverts=vtpInSubsetAdverts, vtpEditControlEntry=vtpEditControlEntry, vlanTrunkPortVlansRcvJoined4k=vlanTrunkPortVlansRcvJoined4k, vtpDiscoverStatus=vtpDiscoverStatus, vtpMIBCompliance2=vtpMIBCompliance2, vtpLocalModeChanged=vtpLocalModeChanged, vtpMIBCompliance7=vtpMIBCompliance7, vtpDatabaseEntry=vtpDatabaseEntry, vtpVlanInfoEditGroup=vtpVlanInfoEditGroup, vtpVlanRingNumber=vtpVlanRingNumber, vtpInSummaryAdverts=vtpInSummaryAdverts, vtpVlanCreated=vtpVlanCreated, vtpConfigRevNumberErrors=vtpConfigRevNumberErrors, vtpVlanMtu=vtpVlanMtu, vtpVlanType=vtpVlanType, vtpNotificationObjectsGroup=vtpNotificationObjectsGroup, vlanTrunkPortVlansEnabled2k=vlanTrunkPortVlansEnabled2k, vtpServerDisabled=vtpServerDisabled, vtpNotificationsEnabled=vtpNotificationsEnabled, managementDomainTable=managementDomainTable, vtpDatabaseTakeOverPrimary=vtpDatabaseTakeOverPrimary, vtpVlanRingNumberConflict=vtpVlanRingNumberConflict, vtpVlanEditIndex=vtpVlanEditIndex, vtpConfigRevNumberError=vtpConfigRevNumberError, vlanManagementDomains=vlanManagementDomains, vtpVlanAreHopCount=vtpVlanAreHopCount, vlanTrunkPortOldAdverts=vlanTrunkPortOldAdverts, vtpVersion2BasicGroup=vtpVersion2BasicGroup, vtpMIBCompliance11=vtpMIBCompliance11, managementDomainLastUpdater=managementDomainLastUpdater, vtpVlanEditRingNumber=vtpVlanEditRingNumber, vlanTrunkPortInJoins=vlanTrunkPortInJoins, vtpAuthPasswordType=vtpAuthPasswordType, vtpVersionOneDeviceDetected=vtpVersionOneDeviceDetected, vtpVlanDeleted=vtpVlanDeleted, vtpEditControlTable=vtpEditControlTable, vlanTrunkPortVlansPruningEligible=vlanTrunkPortVlansPruningEligible, vtpAuthentication=vtpAuthentication, vtpVlanPortLocalSegment=vtpVlanPortLocalSegment, vtpVlanEditStpType=vtpVlanEditStpType, vtpAuthEntry=vtpAuthEntry, vtpStats=vtpStats, vlanTrunkPortsDot1qTag=vlanTrunkPortsDot1qTag, vtpDiscoverResultSystemName=vtpDiscoverResultSystemName, vtpVlanBridgeNumber=vtpVlanBridgeNumber, vlanEdit=vlanEdit, vtpVersionInUseChanged=vtpVersionInUseChanged, vtpVlanTypeExt=vtpVlanTypeExt, vtpVlanEditBridgeType=vtpVlanEditBridgeType, vtpVlanEditTranslationalVlan2=vtpVlanEditTranslationalVlan2, vlanTrunkPortEncapsulationType=vlanTrunkPortEncapsulationType, vtpConfigNotificationsGroupRev1=vtpConfigNotificationsGroupRev1, vtpVlanEditTypeExt=vtpVlanEditTypeExt, vlanTrunkPortVlansEnabled4k=vlanTrunkPortVlansEnabled4k, vlanInfo=vlanInfo, vtpMIBCompliance5=vtpMIBCompliance5, vtpTrunkPortGroup2=vtpTrunkPortGroup2, vtpVlanStpType=vtpVlanStpType, vlanTrunkPortDynamicStatusChange=vlanTrunkPortDynamicStatusChange, vtpDatabaseTakeOverPassword=vtpDatabaseTakeOverPassword, vtpMtuTooBig=vtpMtuTooBig, vtpMIBCompliance4=vtpMIBCompliance4, vlanTrunkPortVlansRcvJoined3k=vlanTrunkPortVlansRcvJoined3k, vtpVersion=vtpVersion, vtpDiscoverResultTable=vtpDiscoverResultTable, vtpDatabase=vtpDatabase, managementDomainLastChange=managementDomainLastChange, vtpAuthenticationTable=vtpAuthenticationTable, vtpMIBCompliance12=vtpMIBCompliance12, managementDomainConfigRevNumber=managementDomainConfigRevNumber, vtpStatsGroup=vtpStatsGroup, vtpVlanEditEntry=vtpVlanEditEntry, vtp4kVlanGroupRev1=vtp4kVlanGroupRev1, internalVlanInfo=internalVlanInfo, managementDomainLocalMode=managementDomainLocalMode, vtpVlanEditType=vtpVlanEditType, vtpVlanIndex=vtpVlanIndex, vtpMIBCompliance=vtpMIBCompliance, vtpMIBCompliance9=vtpMIBCompliance9, vtp4kVlanGroup=vtp4kVlanGroup, vtpOutSubsetAdverts=vtpOutSubsetAdverts, vtpTrunkPortGroup=vtpTrunkPortGroup, vtpOutAdvertRequests=vtpOutAdvertRequests, vtpOutSummaryAdverts=vtpOutSummaryAdverts, vtpVlanIfIndex=vtpVlanIfIndex, vtpInternalVlanEntry=vtpInternalVlanEntry, vtpDiscoverResultEntry=vtpDiscoverResultEntry, vtpDatabaseTable=vtpDatabaseTable, vtpDatabasePrimaryServer=vtpDatabasePrimaryServer, vtpVlanNotifEnabledGroup=vtpVlanNotifEnabledGroup, vtpVlanInfoGroup=vtpVlanInfoGroup, vlanTrunkPortEntry=vlanTrunkPortEntry, vtpVlanEditRowStatus=vtpVlanEditRowStatus, vtpVlanSteHopCount=vtpVlanSteHopCount, vlanTrunkPortRowStatus=vlanTrunkPortRowStatus, vtpMIBCompliances=vtpMIBCompliances, vtpVlanEntry=vtpVlanEntry, vtpVlanEditModifiedVlan=vtpVlanEditModifiedVlan, vtpVlanCreatedNotifEnabled=vtpVlanCreatedNotifEnabled, vlanTrunkPortVlansXmitJoined4k=vlanTrunkPortVlansXmitJoined4k, vlanTrunkPortDot1qTunnel=vlanTrunkPortDot1qTunnel, vtpMIBCompliance10=vtpMIBCompliance10, vlanTrunkPortEncapsulationOperType=vlanTrunkPortEncapsulationOperType, vtpAuthPassword=vtpAuthPassword, PYSNMP_MODULE_ID=ciscoVtpMIB, vtpDiscoverResultDatabaseName=vtpDiscoverResultDatabaseName, VlanType=VlanType, vtpInternalVlanTable=vtpInternalVlanTable, vlanTrunkPortVlansXmitJoined2k=vlanTrunkPortVlansXmitJoined2k, vtpDiscoverResultConflicting=vtpDiscoverResultConflicting, vtpLastDiscoverTime=vtpLastDiscoverTime, vtpStatsEntry=vtpStatsEntry, vtpTrunkPruningGroup2=vtpTrunkPruningGroup2, vtpVlanIfIndexGroup=vtpVlanIfIndexGroup, vlanTrunkPortVlansXmitJoined=vlanTrunkPortVlansXmitJoined, vtpDot1qTunnelGroup=vtpDot1qTunnelGroup, vtpMIBObjects=vtpMIBObjects, vtpMIBCompliance8=vtpMIBCompliance8, vtpConfigNotificationsGroup=vtpConfigNotificationsGroup, vtpVlanEditConfigRevNumber=vtpVlanEditConfigRevNumber, managementDomainRowStatus=managementDomainRowStatus, vtpNotificationsPrefix=vtpNotificationsPrefix, vtpVlanEditBridgeNumber=vtpVlanEditBridgeNumber, vtpVlansPruningEligible3k=vtpVlansPruningEligible3k, managementDomainTftpPathname=managementDomainTftpPathname, vtpDiscoverResultRevNumber=vtpDiscoverResultRevNumber, vtpNotifications=vtpNotifications, vtpVlanEditBufferOwner=vtpVlanEditBufferOwner, vlanTrunkPortVlansRcvJoined=vlanTrunkPortVlansRcvJoined, vtpVlanEditName=vtpVlanEditName, vtpConfigDigestErrors=vtpConfigDigestErrors, vtpTrunkPortGroup3=vtpTrunkPortGroup3, vtpVlanEditState=vtpVlanEditState, vtpVlanEditParentVlan=vtpVlanEditParentVlan, vlanTrunkPortDynamicStatus=vlanTrunkPortDynamicStatus, vtpVlanEditTable=vtpVlanEditTable, vlanTrunkPortIfIndex=vlanTrunkPortIfIndex, vtpVlanEditTypeExt2=vtpVlanEditTypeExt2, vtpVlansPruningEligible2k=vtpVlansPruningEligible2k, vtpVlanTable=vtpVlanTable, vtpVlanEditDot10Said=vtpVlanEditDot10Said, vtpVlanEditIsCRFBackup=vtpVlanEditIsCRFBackup, vtpStatsTable=vtpStatsTable, vtpVlanTranslationalVlan1=vtpVlanTranslationalVlan1, vtpConfigNotificationsGroup5=vtpConfigNotificationsGroup5, managementDomainPruningState=managementDomainPruningState, vtpDatabaseRevNumber=vtpDatabaseRevNumber, vtpInternalVlanGrp=vtpInternalVlanGrp, vtpInAdvertRequests=vtpInAdvertRequests, vtpVlanEditSteHopCount=vtpVlanEditSteHopCount, vlanTrunkPortVlansEnabled=vlanTrunkPortVlansEnabled, vtpDiscoverResultPrimaryServer=vtpDiscoverResultPrimaryServer, vtpBasicGroup=vtpBasicGroup, vtpVlanState=vtpVlanState, vlanTrunkPortManagementDomain=vlanTrunkPortManagementDomain, vtpDiscoverAction=vtpDiscoverAction, vtpDatabaseGroup=vtpDatabaseGroup, vtpVlanBridgeType=vtpVlanBridgeType, managementDomainIndex=managementDomainIndex, vlanTrunkPortSetSerialNo=vlanTrunkPortSetSerialNo, vtpDatabasePrimaryServerId=vtpDatabasePrimaryServerId, managementDomainVersionInUse=managementDomainVersionInUse, vtpVlanDeletedNotifEnabled=vtpVlanDeletedNotifEnabled, vtpDiscoverTable=vtpDiscoverTable, vlanTrunkPorts=vlanTrunkPorts, vtpVlansPruningEligible4k=vtpVlansPruningEligible4k, managementDomainName=managementDomainName, vlanTrunkPortVlansRcvJoined2k=vlanTrunkPortVlansRcvJoined2k, vtpInternalVlanOwner=vtpInternalVlanOwner, vtpConfigNotificationsGroup3=vtpConfigNotificationsGroup3, vtpAuthGroup=vtpAuthGroup, ciscoVtpMIB=ciscoVtpMIB, vtpDiscoverGroup=vtpDiscoverGroup, vlanTrunkPortVlansXmitJoined3k=vlanTrunkPortVlansXmitJoined3k, vtpMIBCompliance3=vtpMIBCompliance3, managementDomainTftpServer=managementDomainTftpServer, vtpAuthSecretKey=vtpAuthSecretKey, vtpVlanApplyStatus=vtpVlanApplyStatus, vtpStatus=vtpStatus, vlanTrunkPortTable=vlanTrunkPortTable, vtpVlanEditAreHopCount=vtpVlanEditAreHopCount)
