...
TestAndIncr, TruthValue, DisplayString, RowStatus, DateAndTime, TextualConvention, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "TruthValue", "DisplayString", "RowStatus", "DateAndTime", "TextualConvention", "TimeStamp")
...
mibBuilder.exportSymbols("CISCO-VTP-MIB", vtpVlanEditModifiedVlan=vtpVlanEditModifiedVlan, vlanTrunkPortOldAdverts=vlanTrunkPortOldAdverts, vtpInternalVlanEntry=vtpInternalVlanEntry, vtpVersion=vtpVersion, vtpDiscoverResultConflicting=vtpDiscoverResultConflicting, vtpDatabasePrimaryServerId=vtpDatabasePrimaryServerId, vlanTrunkPortVlansEnabled2k=vlanTrunkPortVlansEnabled2k, vtpDiscoverAction=vtpDiscoverAction, vlanTrunkPortVlansXmitJoined3k=vlanTrunkPortVlansXmitJoined3k, vtpVlanEditMtu=vtpVlanEditMtu, vtpVlansPruningEligible4k=vtpVlansPruningEligible4k, vtpVlanBridgeNumber=vtpVlanBridgeNumber, vtpVersionOneDeviceDetected=vtpVersionOneDeviceDetected, vtpTrunkPortGroup3=vtpTrunkPortGroup3, vtpConfigRevNumberErrors=vtpConfigRevNumberErrors, vlanTrunkPortEncapsulationOperType=vlanTrunkPortEncapsulationOperType, vlanTrunkPortDynamicStatusChange=vlanTrunkPortDynamicStatusChange, vtpVlanIsCRFBackup=vtpVlanIsCRFBackup, vtpMIBCompliance3=vtpMIBCompliance3, vlanTrunkPortDynamicStatus=vlanTrunkPortDynamicStatus, vtpDiscoverTable=vtpDiscoverTable, vtpAuthentication=vtpAuthentication, vtpTrunkPortGroup2=vtpTrunkPortGroup2, vtpConfigNotificationsGroupRev1=vtpConfigNotificationsGroupRev1, vtpVlanEditRowStatus=vtpVlanEditRowStatus, vtpVlanIfIndex=vtpVlanIfIndex, vtpTrunkPortGroup=vtpTrunkPortGroup, managementDomainEntry=managementDomainEntry, managementDomainTable=managementDomainTable, managementDomainConfigRevNumber=managementDomainConfigRevNumber, vtpInSummaryAdverts=vtpInSummaryAdverts, vtpConfigNotificationsGroup3=vtpConfigNotificationsGroup3, vtpDot1qTunnelGroup2=vtpDot1qTunnelGroup2, vlanTrunkPortEntry=vlanTrunkPortEntry, managementDomainPruningState=managementDomainPruningState, vtpMIBConformance=vtpMIBConformance, vtpVlanAreHopCount=vtpVlanAreHopCount, vtpEditControlEntry=vtpEditControlEntry, vtpMaxVlanStorage=vtpMaxVlanStorage, vtpMIBCompliance4=vtpMIBCompliance4, vtpVlansPruningEligible2k=vtpVlansPruningEligible2k, vtpDatabaseEntry=vtpDatabaseEntry, vtpMIBCompliance7=vtpMIBCompliance7, vtpVlanIfIndexGroup=vtpVlanIfIndexGroup, vtpVlanEditBufferOwner=vtpVlanEditBufferOwner, vtpMIBCompliance10=vtpMIBCompliance10, vtpMIBCompliance8=vtpMIBCompliance8, vlanTrunkPortTable=vlanTrunkPortTable, vtpMIBCompliance12=vtpMIBCompliance12, vtpDatabaseTakeOverPassword=vtpDatabaseTakeOverPassword, vtpVlanDot10Said=vtpVlanDot10Said, vtpConfigDigestError=vtpConfigDigestError, vtpVlanDeleted=vtpVlanDeleted, vtpConfigNotificationsGroup=vtpConfigNotificationsGroup, vtpVlanParentVlan=vtpVlanParentVlan, vtpVlanEditStpType=vtpVlanEditStpType, vlanTrunkPortVlansPruningEligible=vlanTrunkPortVlansPruningEligible, vtpInAdvertRequests=vtpInAdvertRequests, vtpMIBCompliance11=vtpMIBCompliance11, vtpServerDisabled=vtpServerDisabled, vtpVlanEditEntry=vtpVlanEditEntry, vtpDatabaseTable=vtpDatabaseTable, vtpNotificationObjectsGroup=vtpNotificationObjectsGroup, vtpVlanIndex=vtpVlanIndex, vtpVlanCreatedNotifEnabled=vtpVlanCreatedNotifEnabled, vtpStatsTable=vtpStatsTable, vtpVlansPruningEligible3k=vtpVlansPruningEligible3k, vtpDiscoverResultRevNumber=vtpDiscoverResultRevNumber, vtpVlanEditTypeExt=vtpVlanEditTypeExt, vtpVlanTypeExt=vtpVlanTypeExt, vtpDatabaseTakeOverPrimary=vtpDatabaseTakeOverPrimary, ciscoVtpMIB=ciscoVtpMIB, vtpVlanEditTranslationalVlan1=vtpVlanEditTranslationalVlan1, vtpVlanSteHopCount=vtpVlanSteHopCount, vtpVlanEditBridgeType=vtpVlanEditBridgeType, managementDomainTftpPathname=managementDomainTftpPathname, vtpInSubsetAdverts=vtpInSubsetAdverts, vtpOutSummaryAdverts=vtpOutSummaryAdverts, vlanTrunkPortsDot1qTag=vlanTrunkPortsDot1qTag, vtpVlanBridgeType=vtpVlanBridgeType, vtpMIBCompliance=vtpMIBCompliance, vtpNotifications=vtpNotifications, vtpVlanStpType=vtpVlanStpType, managementDomainName=managementDomainName, managementDomainRowStatus=managementDomainRowStatus, vtpVlanNotifEnabledGroup=vtpVlanNotifEnabledGroup, vtpDiscoverResultPrimaryServer=vtpDiscoverResultPrimaryServer, vlanTrunkPortVlansXmitJoined4k=vlanTrunkPortVlansXmitJoined4k, vtpInternalVlanTable=vtpInternalVlanTable, managementDomainVersionInUse=managementDomainVersionInUse, vtpVlanTranslationalVlan1=vtpVlanTranslationalVlan1, vtpDiscoverResultIndex=vtpDiscoverResultIndex, vtpVlanPortLocalSegment=vtpVlanPortLocalSegment, vlanTrunkPortSetSerialNo=vlanTrunkPortSetSerialNo, vtpAuthenticationTable=vtpAuthenticationTable, vtpDatabasePrimaryServer=vtpDatabasePrimaryServer, vtpInternalVlanGrp=vtpInternalVlanGrp, vlanTrunkPortVtpEnabled=vlanTrunkPortVtpEnabled, vtpVlanMtu=vtpVlanMtu, vlanTrunkPortVlansEnabled3k=vlanTrunkPortVlansEnabled3k, vtpDatabaseIndex=vtpDatabaseIndex, vtpVlanInfoEditGroup2=vtpVlanInfoEditGroup2, vtpMIBGroups=vtpMIBGroups, VlanIndex=VlanIndex, vtpVlanCreated=vtpVlanCreated, managementDomainLocalMode=managementDomainLocalMode, managementDomainTftpServer=managementDomainTftpServer, vtpVersionInUseChanged=vtpVersionInUseChanged, vtpVersion2BasicGroup=vtpVersion2BasicGroup, vtpAuthSecretKey=vtpAuthSecretKey, vtpEditControlTable=vtpEditControlTable, vtp4kVlanGroupRev1=vtp4kVlanGroupRev1, vtpVlanState=vtpVlanState, vtpVlanEditOperation=vtpVlanEditOperation, vtpConfigNotificationsGroup2=vtpConfigNotificationsGroup2, vtpNotificationsObjects=vtpNotificationsObjects, vtpConfigNotificationsGroup5=vtpConfigNotificationsGroup5, vtpVlanEditTranslationalVlan2=vtpVlanEditTranslationalVlan2, vlanInfo=vlanInfo, vtpConfigDigestErrors=vtpConfigDigestErrors, vtpStatsEntry=vtpStatsEntry, VlanTypeExt=VlanTypeExt, vtpStats=vtpStats, vlanTrunkPortDynamicState=vlanTrunkPortDynamicState, vtpDiscoverGroup=vtpDiscoverGroup, vtpNotificationsEnabled=vtpNotificationsEnabled, vtpMtuTooBig=vtpMtuTooBig, vlanTrunkPortIfIndex=vlanTrunkPortIfIndex, vtpDiscoverResultDeviceId=vtpDiscoverResultDeviceId, vlanManagementDomains=vlanManagementDomains, vlanTrunkPortVlansRcvJoined4k=vlanTrunkPortVlansRcvJoined4k, PYSNMP_MODULE_ID=ciscoVtpMIB, vlanTrunkPortVlansRcvJoined=vlanTrunkPortVlansRcvJoined, vtpVlanInfoEditGroup=vtpVlanInfoEditGroup, vlanTrunkPortManagementDomain=vlanTrunkPortManagementDomain, vtpDiscoverResultSystemName=vtpDiscoverResultSystemName, managementDomainLastChange=managementDomainLastChange, vlanTrunkPortVlansEnabled4k=vlanTrunkPortVlansEnabled4k, vtpDatabase=vtpDatabase, vtpMIBCompliance2=vtpMIBCompliance2, vtpDiscoverResultTable=vtpDiscoverResultTable, vtpVlanEditType=vtpVlanEditType, vtpDatabaseGroup=vtpDatabaseGroup, ManagementDomainIndex=ManagementDomainIndex, vtpVlanEditParentVlan=vtpVlanEditParentVlan, vtpVlanEditName=vtpVlanEditName, vtpTrunkPruningGroup2=vtpTrunkPruningGroup2, vtpMIBCompliances=vtpMIBCompliances, vtpVlanEditTypeExt2=vtpVlanEditTypeExt2, vtpDiscoverEntry=vtpDiscoverEntry, vtpVlanInfoGroup=vtpVlanInfoGroup, vtpDatabaseName=vtpDatabaseName, vtpAuthEntry=vtpAuthEntry, vtpLocalModeChanged=vtpLocalModeChanged, vtpVlanName=vtpVlanName, vtpOutAdvertRequests=vtpOutAdvertRequests, managementDomainLastUpdater=managementDomainLastUpdater, vtpStatus=vtpStatus, vtpVlanEditState=vtpVlanEditState, vtpVlanEditDot10Said=vtpVlanEditDot10Said, internalVlanInfo=internalVlanInfo, vlanTrunkPortVlansXmitJoined2k=vlanTrunkPortVlansXmitJoined2k, vlanTrunkPortVlansRcvJoined2k=vlanTrunkPortVlansRcvJoined2k, vtpVlanEditIsCRFBackup=vtpVlanEditIsCRFBackup, vlanTrunkPorts=vlanTrunkPorts, vtpConfigNotificationsGroup4=vtpConfigNotificationsGroup4, vtpDiscoverStatus=vtpDiscoverStatus, vtpNotificationsPrefix=vtpNotificationsPrefix, vtpVlanEntry=vtpVlanEntry, vtpVlanTranslationalVlan2=vtpVlanTranslationalVlan2, vtpMIBObjects=vtpMIBObjects, vlanTrunkPortVlansRcvJoined3k=vlanTrunkPortVlansRcvJoined3k, managementDomainIndex=managementDomainIndex, vlanTrunkPortNativeVlan=vlanTrunkPortNativeVlan, vtpDiscoverResultDatabaseName=vtpDiscoverResultDatabaseName, vtpAuthPassword=vtpAuthPassword, vtpAuthGroup=vtpAuthGroup, vlanTrunkPortEncapsulationType=vlanTrunkPortEncapsulationType, vtpAuthPasswordType=vtpAuthPasswordType, vtpVlanEditSteHopCount=vtpVlanEditSteHopCount, vtpVlanEditBridgeNumber=vtpVlanEditBridgeNumber, vlanTrunkPortDot1qTunnel=vlanTrunkPortDot1qTunnel, vtpVlanType=vtpVlanType, vtpDiscoverResultEntry=vtpDiscoverResultEntry, vtpVlanEditConfigRevNumber=vtpVlanEditConfigRevNumber, vtpConfigRevNumberError=vtpConfigRevNumberError, vtpBasicGroup=vtpBasicGroup, vtpStatsGroup=vtpStatsGroup, vtpMIBCompliance6=vtpMIBCompliance6, vlanTrunkPortInJoins=vlanTrunkPortInJoins, vtpVlanRingNumberConflict=vtpVlanRingNumberConflict, vtpInternalVlanOwner=vtpInternalVlanOwner, vtpVlanEditIndex=vtpVlanEditIndex, vtpVlanEditRingNumber=vtpVlanEditRingNumber, vtpDatabaseLocalMode=vtpDatabaseLocalMode, vtpInternalVlanAllocPolicy=vtpInternalVlanAllocPolicy, vtpVlanEditAreHopCount=vtpVlanEditAreHopCount, vlanEdit=vlanEdit, vtpTrunkPruningGroup=vtpTrunkPruningGroup, vtpMIBCompliance9=vtpMIBCompliance9, vtp4kVlanGroup=vtp4kVlanGroup, vtpVlanEditTable=vtpVlanEditTable, vtpDiscover=vtpDiscover, vtpVlanDeletedNotifEnabled=vtpVlanDeletedNotifEnabled, vtpOutSubsetAdverts=vtpOutSubsetAdverts, vtpDatabaseRevNumber=vtpDatabaseRevNumber, vtpDot1qTunnelGroup=vtpDot1qTunnelGroup, vlanTrunkPortVlansEnabled=vlanTrunkPortVlansEnabled, vtpVlanApplyStatus=vtpVlanApplyStatus, vtpLastDiscoverTime=vtpLastDiscoverTime, vtpMIBCompliance5=vtpMIBCompliance5, vtpVlanRingNumber=vtpVlanRingNumber, vtpVlanTable=vtpVlanTable, vlanTrunkPortRowStatus=vlanTrunkPortRowStatus, VlanType=VlanType, vlanTrunkPortVlansXmitJoined=vlanTrunkPortVlansXmitJoined, vlanTrunkPortOutJoins=vlanTrunkPortOutJoins)
