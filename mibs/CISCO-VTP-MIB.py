...
Counter64, ModuleIdentity, Gauge32, ObjectIdentity, NotificationType, Integer32, Unsigned32, iso, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "Gauge32", "ObjectIdentity", "NotificationType", "Integer32", "Unsigned32", "iso", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "Counter32")
TestAndIncr, TimeStamp, RowStatus, TextualConvention, DateAndTime, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "TimeStamp", "RowStatus", "TextualConvention", "DateAndTime", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("CISCO-VTP-MIB", vlanTrunkPortRowStatus=vlanTrunkPortRowStatus, vtpDatabaseTakeOverPrimary=vtpDatabaseTakeOverPrimary, vlanTrunkPortVlansRcvJoined4k=vlanTrunkPortVlansRcvJoined4k, vtpAuthPasswordType=vtpAuthPasswordType, vlanTrunkPortEntry=vlanTrunkPortEntry, vtpVlanType=vtpVlanType, vtpDatabaseGroup=vtpDatabaseGroup, vlanTrunkPortInJoins=vlanTrunkPortInJoins, vlanTrunkPortNativeVlan=vlanTrunkPortNativeVlan, vtpDiscoverResultConflicting=vtpDiscoverResultConflicting, vtpInternalVlanEntry=vtpInternalVlanEntry, vlanTrunkPortSetSerialNo=vlanTrunkPortSetSerialNo, vtpVlanEditRowStatus=vtpVlanEditRowStatus, vtpAuthPassword=vtpAuthPassword, managementDomainLastChange=managementDomainLastChange, ciscoVtpMIB=ciscoVtpMIB, vtpConfigRevNumberError=vtpConfigRevNumberError, vtpMIBGroups=vtpMIBGroups, vtpStatsGroup=vtpStatsGroup, vtpVlanInfoEditGroup2=vtpVlanInfoEditGroup2, vtpVlanEditType=vtpVlanEditType, vtpVlanCreatedNotifEnabled=vtpVlanCreatedNotifEnabled, vtpDiscoverAction=vtpDiscoverAction, vtpDiscoverResultTable=vtpDiscoverResultTable, vtpVlanTypeExt=vtpVlanTypeExt, vtpStats=vtpStats, vtpInternalVlanAllocPolicy=vtpInternalVlanAllocPolicy, vtpVlanIndex=vtpVlanIndex, vtpTrunkPortGroup3=vtpTrunkPortGroup3, VlanIndex=VlanIndex, vtpVlanEditBufferOwner=vtpVlanEditBufferOwner, vtpDiscoverResultSystemName=vtpDiscoverResultSystemName, vtpInAdvertRequests=vtpInAdvertRequests, vtpVlanEditConfigRevNumber=vtpVlanEditConfigRevNumber, vtpVersionInUseChanged=vtpVersionInUseChanged, vtpMIBCompliance8=vtpMIBCompliance8, vtpVlanDot10Said=vtpVlanDot10Said, vtpDatabaseName=vtpDatabaseName, vtpVlanEditRingNumber=vtpVlanEditRingNumber, vlanTrunkPortVlansEnabled=vlanTrunkPortVlansEnabled, vtpConfigNotificationsGroup5=vtpConfigNotificationsGroup5, vtpMtuTooBig=vtpMtuTooBig, vtpVlanEditName=vtpVlanEditName, vlanTrunkPortDynamicStatusChange=vlanTrunkPortDynamicStatusChange, vtp4kVlanGroup=vtp4kVlanGroup, vlanTrunkPortVlansXmitJoined=vlanTrunkPortVlansXmitJoined, managementDomainLocalMode=managementDomainLocalMode, vtpVlanEditState=vtpVlanEditState, vtpVlanApplyStatus=vtpVlanApplyStatus, vlanTrunkPortEncapsulationType=vlanTrunkPortEncapsulationType, vtpVlanDeletedNotifEnabled=vtpVlanDeletedNotifEnabled, vlanTrunkPortEncapsulationOperType=vlanTrunkPortEncapsulationOperType, vtpTrunkPruningGroup2=vtpTrunkPruningGroup2, vtpAuthEntry=vtpAuthEntry, vtpNotificationsPrefix=vtpNotificationsPrefix, vtpAuthSecretKey=vtpAuthSecretKey, vtpMIBCompliance2=vtpMIBCompliance2, vtpVlanMtu=vtpVlanMtu, PYSNMP_MODULE_ID=ciscoVtpMIB, vtpConfigDigestErrors=vtpConfigDigestErrors, vlanTrunkPortTable=vlanTrunkPortTable, vtpVlansPruningEligible3k=vtpVlansPruningEligible3k, vtpConfigNotificationsGroupRev1=vtpConfigNotificationsGroupRev1, vtpVlanName=vtpVlanName, vtpDatabaseTakeOverPassword=vtpDatabaseTakeOverPassword, vtpVlanEditDot10Said=vtpVlanEditDot10Said, managementDomainTable=managementDomainTable, vtpConfigRevNumberErrors=vtpConfigRevNumberErrors, vtpVlanEditTable=vtpVlanEditTable, vtpVlansPruningEligible2k=vtpVlansPruningEligible2k, vtpStatsTable=vtpStatsTable, vtpTrunkPruningGroup=vtpTrunkPruningGroup, vtpStatsEntry=vtpStatsEntry, vtpVlanBridgeNumber=vtpVlanBridgeNumber, vtpDiscoverResultRevNumber=vtpDiscoverResultRevNumber, vtpVlanIfIndexGroup=vtpVlanIfIndexGroup, vtpVlanEditTranslationalVlan2=vtpVlanEditTranslationalVlan2, vtpVlanEditTypeExt=vtpVlanEditTypeExt, vtpStatus=vtpStatus, vtpDiscoverResultPrimaryServer=vtpDiscoverResultPrimaryServer, vtpMIBCompliance11=vtpMIBCompliance11, vtpMIBObjects=vtpMIBObjects, vtpDiscover=vtpDiscover, vlanTrunkPortVlansEnabled2k=vlanTrunkPortVlansEnabled2k, vlanInfo=vlanInfo, vtpVlanEditModifiedVlan=vtpVlanEditModifiedVlan, managementDomainTftpServer=managementDomainTftpServer, vlanTrunkPortVlansRcvJoined2k=vlanTrunkPortVlansRcvJoined2k, vtpVlanTranslationalVlan2=vtpVlanTranslationalVlan2, vtpEditControlTable=vtpEditControlTable, vtpVlanEditSteHopCount=vtpVlanEditSteHopCount, vtpVlanEntry=vtpVlanEntry, vlanTrunkPorts=vlanTrunkPorts, vtpMIBCompliances=vtpMIBCompliances, vtpVlanStpType=vtpVlanStpType, vtpConfigNotificationsGroup2=vtpConfigNotificationsGroup2, vlanTrunkPortDot1qTunnel=vlanTrunkPortDot1qTunnel, vtpInternalVlanTable=vtpInternalVlanTable, vlanTrunkPortVtpEnabled=vlanTrunkPortVtpEnabled, vtpVlanEditMtu=vtpVlanEditMtu, vtpTrunkPortGroup=vtpTrunkPortGroup, vtpVlanSteHopCount=vtpVlanSteHopCount, vtpMIBCompliance3=vtpMIBCompliance3, vtpDatabasePrimaryServer=vtpDatabasePrimaryServer, vtpDatabase=vtpDatabase, vtpVersion2BasicGroup=vtpVersion2BasicGroup, vtpVlanRingNumber=vtpVlanRingNumber, managementDomainConfigRevNumber=managementDomainConfigRevNumber, vtpConfigNotificationsGroup=vtpConfigNotificationsGroup, vtpVlanEditTranslationalVlan1=vtpVlanEditTranslationalVlan1, vtpVlanEditBridgeType=vtpVlanEditBridgeType, vlanTrunkPortDynamicStatus=vlanTrunkPortDynamicStatus, vtpAuthenticationTable=vtpAuthenticationTable, vtpBasicGroup=vtpBasicGroup, managementDomainRowStatus=managementDomainRowStatus, vtpMIBCompliance12=vtpMIBCompliance12, vtpAuthGroup=vtpAuthGroup, vtpLocalModeChanged=vtpLocalModeChanged, vtpNotificationsEnabled=vtpNotificationsEnabled, vtpInternalVlanOwner=vtpInternalVlanOwner, vtpNotifications=vtpNotifications, vtpVlanEditEntry=vtpVlanEditEntry, vtpDiscoverResultEntry=vtpDiscoverResultEntry, vtpOutSummaryAdverts=vtpOutSummaryAdverts, vtpDatabasePrimaryServerId=vtpDatabasePrimaryServerId, vtpVlanNotifEnabledGroup=vtpVlanNotifEnabledGroup, managementDomainName=managementDomainName, vtpVlanTable=vtpVlanTable, vtpVlanEditTypeExt2=vtpVlanEditTypeExt2, vtpInSubsetAdverts=vtpInSubsetAdverts, vlanTrunkPortVlansEnabled3k=vlanTrunkPortVlansEnabled3k, vtpVlanInfoEditGroup=vtpVlanInfoEditGroup, vtpInSummaryAdverts=vtpInSummaryAdverts, vtpVlanEditStpType=vtpVlanEditStpType, vtpMIBConformance=vtpMIBConformance, vtpMIBCompliance=vtpMIBCompliance, managementDomainPruningState=managementDomainPruningState, vtpVlanEditIndex=vtpVlanEditIndex, vtp4kVlanGroupRev1=vtp4kVlanGroupRev1, vtpConfigNotificationsGroup3=vtpConfigNotificationsGroup3, vtpVlanIfIndex=vtpVlanIfIndex, managementDomainLastUpdater=managementDomainLastUpdater, vtpMIBCompliance4=vtpMIBCompliance4, vtpConfigNotificationsGroup4=vtpConfigNotificationsGroup4, vtpVlanEditIsCRFBackup=vtpVlanEditIsCRFBackup, vtpVlanState=vtpVlanState, vtpDiscoverStatus=vtpDiscoverStatus, vtpVlanParentVlan=vtpVlanParentVlan, vtpVlanEditAreHopCount=vtpVlanEditAreHopCount, vlanTrunkPortVlansXmitJoined2k=vlanTrunkPortVlansXmitJoined2k, vtpMIBCompliance6=vtpMIBCompliance6, vtpMaxVlanStorage=vtpMaxVlanStorage, managementDomainEntry=managementDomainEntry, vtpOutAdvertRequests=vtpOutAdvertRequests, internalVlanInfo=internalVlanInfo, vtpAuthentication=vtpAuthentication, vtpMIBCompliance7=vtpMIBCompliance7, vtpDatabaseTable=vtpDatabaseTable, managementDomainVersionInUse=managementDomainVersionInUse, vtpVlanInfoGroup=vtpVlanInfoGroup, vtpVlanPortLocalSegment=vtpVlanPortLocalSegment, vtpVlanEditBridgeNumber=vtpVlanEditBridgeNumber, vtpVersion=vtpVersion, vtpConfigDigestError=vtpConfigDigestError, vtpMIBCompliance9=vtpMIBCompliance9, vlanTrunkPortManagementDomain=vlanTrunkPortManagementDomain, ManagementDomainIndex=ManagementDomainIndex, vtpVlanAreHopCount=vtpVlanAreHopCount, vtpVlanCreated=vtpVlanCreated, vtpDiscoverTable=vtpDiscoverTable, vlanTrunkPortVlansRcvJoined=vlanTrunkPortVlansRcvJoined, managementDomainTftpPathname=managementDomainTftpPathname, vtpLastDiscoverTime=vtpLastDiscoverTime, vtpVersionOneDeviceDetected=vtpVersionOneDeviceDetected, vtpDiscoverResultDeviceId=vtpDiscoverResultDeviceId, vtpDatabaseLocalMode=vtpDatabaseLocalMode, vtpVlanIsCRFBackup=vtpVlanIsCRFBackup, vtpDiscoverGroup=vtpDiscoverGroup, vtpDot1qTunnelGroup=vtpDot1qTunnelGroup, vtpNotificationsObjects=vtpNotificationsObjects, vtpVlanTranslationalVlan1=vtpVlanTranslationalVlan1, vtpMIBCompliance10=vtpMIBCompliance10, vtpMIBCompliance5=vtpMIBCompliance5, VlanTypeExt=VlanTypeExt, vlanTrunkPortVlansRcvJoined3k=vlanTrunkPortVlansRcvJoined3k, vtpDiscoverResultIndex=vtpDiscoverResultIndex, vtpEditControlEntry=vtpEditControlEntry, vtpDatabaseIndex=vtpDatabaseIndex, vtpTrunkPortGroup2=vtpTrunkPortGroup2, vlanTrunkPortDynamicState=vlanTrunkPortDynamicState, vtpNotificationObjectsGroup=vtpNotificationObjectsGroup, vtpVlanEditParentVlan=vtpVlanEditParentVlan, vlanTrunkPortVlansXmitJoined3k=vlanTrunkPortVlansXmitJoined3k, vlanTrunkPortsDot1qTag=vlanTrunkPortsDot1qTag, vtpVlanRingNumberConflict=vtpVlanRingNumberConflict, vtpDatabaseEntry=vtpDatabaseEntry, vtpInternalVlanGrp=vtpInternalVlanGrp, vtpDiscoverResultDatabaseName=vtpDiscoverResultDatabaseName, VlanType=VlanType, vtpServerDisabled=vtpServerDisabled, vtpDiscoverEntry=vtpDiscoverEntry, vlanTrunkPortOutJoins=vlanTrunkPortOutJoins, vlanEdit=vlanEdit, vtpDot1qTunnelGroup2=vtpDot1qTunnelGroup2, vlanTrunkPortVlansPruningEligible=vlanTrunkPortVlansPruningEligible, vtpDatabaseRevNumber=vtpDatabaseRevNumber, vtpVlansPruningEligible4k=vtpVlansPruningEligible4k, vlanTrunkPortVlansEnabled4k=vlanTrunkPortVlansEnabled4k, vtpVlanEditOperation=vtpVlanEditOperation, vtpVlanDeleted=vtpVlanDeleted, vlanTrunkPortIfIndex=vlanTrunkPortIfIndex, vlanManagementDomains=vlanManagementDomains, vlanTrunkPortOldAdverts=vlanTrunkPortOldAdverts, vlanTrunkPortVlansXmitJoined4k=vlanTrunkPortVlansXmitJoined4k, managementDomainIndex=managementDomainIndex, vtpOutSubsetAdverts=vtpOutSubsetAdverts, vtpVlanBridgeType=vtpVlanBridgeType)
