...
Integer32, TimeTicks, IpAddress, ModuleIdentity, Gauge32, MibIdentifier, Counter64, Unsigned32, iso, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "TimeTicks", "IpAddress", "ModuleIdentity", "Gauge32", "MibIdentifier", "Counter64", "Unsigned32", "iso", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity")
TestAndIncr, DateAndTime, TruthValue, RowStatus, DisplayString, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "DateAndTime", "TruthValue", "RowStatus", "DisplayString", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("CISCO-VTP-MIB", vtpVlanIfIndex=vtpVlanIfIndex, vtpDiscoverResultRevNumber=vtpDiscoverResultRevNumber, vtpLocalModeChanged=vtpLocalModeChanged, vtpInternalVlanTable=vtpInternalVlanTable, vtpVlanCreatedNotifEnabled=vtpVlanCreatedNotifEnabled, vtpVlanNotifEnabledGroup=vtpVlanNotifEnabledGroup, vtpVlanCreated=vtpVlanCreated, vtpVlanEditMtu=vtpVlanEditMtu, vtpVlanEditParentVlan=vtpVlanEditParentVlan, vtpInAdvertRequests=vtpInAdvertRequests, vtpDatabaseRevNumber=vtpDatabaseRevNumber, vtpStatsGroup=vtpStatsGroup, VlanIndex=VlanIndex, vtpConfigRevNumberErrors=vtpConfigRevNumberErrors, vtpMIBCompliance=vtpMIBCompliance, vtpVlanEditBufferOwner=vtpVlanEditBufferOwner, vtpVersion=vtpVersion, vtpDiscoverAction=vtpDiscoverAction, vlanInfo=vlanInfo, VlanType=VlanType, vtpOutAdvertRequests=vtpOutAdvertRequests, vlanTrunkPortVlansRcvJoined=vlanTrunkPortVlansRcvJoined, vtpVlansPruningEligible4k=vtpVlansPruningEligible4k, vtpMIBCompliance7=vtpMIBCompliance7, ManagementDomainIndex=ManagementDomainIndex, vtpInternalVlanAllocPolicy=vtpInternalVlanAllocPolicy, vtpVersionOneDeviceDetected=vtpVersionOneDeviceDetected, vtpVlanTranslationalVlan1=vtpVlanTranslationalVlan1, vtpDatabaseTakeOverPrimary=vtpDatabaseTakeOverPrimary, vtpVlanEditOperation=vtpVlanEditOperation, vtpVlanState=vtpVlanState, vtpVlanIsCRFBackup=vtpVlanIsCRFBackup, vtpVlanEditIsCRFBackup=vtpVlanEditIsCRFBackup, vtpDiscoverResultIndex=vtpDiscoverResultIndex, vtpDatabaseEntry=vtpDatabaseEntry, vtpVlanInfoGroup=vtpVlanInfoGroup, vtpTrunkPruningGroup2=vtpTrunkPruningGroup2, vtpVlanEditTranslationalVlan1=vtpVlanEditTranslationalVlan1, vlanTrunkPortManagementDomain=vlanTrunkPortManagementDomain, vtpVlanEditAreHopCount=vtpVlanEditAreHopCount, vlanTrunkPortNativeVlan=vlanTrunkPortNativeVlan, vtp4kVlanGroupRev1=vtp4kVlanGroupRev1, vtpDiscoverResultTable=vtpDiscoverResultTable, vtpDatabasePrimaryServer=vtpDatabasePrimaryServer, vtpConfigNotificationsGroup2=vtpConfigNotificationsGroup2, vtpVlanDot10Said=vtpVlanDot10Said, vtpConfigNotificationsGroup3=vtpConfigNotificationsGroup3, vtpMIBCompliance6=vtpMIBCompliance6, vtpVlanTypeExt=vtpVlanTypeExt, vtpMIBCompliance5=vtpMIBCompliance5, vtpStatus=vtpStatus, vtpVlansPruningEligible2k=vtpVlansPruningEligible2k, vtpAuthEntry=vtpAuthEntry, vtpVlanEditName=vtpVlanEditName, vtpMIBCompliance9=vtpMIBCompliance9, vlanTrunkPortSetSerialNo=vlanTrunkPortSetSerialNo, vtpBasicGroup=vtpBasicGroup, managementDomainTftpServer=managementDomainTftpServer, vtpMIBCompliance2=vtpMIBCompliance2, vtpMIBCompliance3=vtpMIBCompliance3, vtpNotifications=vtpNotifications, vtpOutSubsetAdverts=vtpOutSubsetAdverts, vlanTrunkPortsDot1qTag=vlanTrunkPortsDot1qTag, vtpVlanRingNumber=vtpVlanRingNumber, vtpStats=vtpStats, PYSNMP_MODULE_ID=ciscoVtpMIB, vlanTrunkPortEncapsulationType=vlanTrunkPortEncapsulationType, vlanTrunkPortVlansRcvJoined2k=vlanTrunkPortVlansRcvJoined2k, VlanTypeExt=VlanTypeExt, vtpVlanEditDot10Said=vtpVlanEditDot10Said, managementDomainLastChange=managementDomainLastChange, vtpConfigNotificationsGroup5=vtpConfigNotificationsGroup5, vtpMIBObjects=vtpMIBObjects, vtpVlanTranslationalVlan2=vtpVlanTranslationalVlan2, vtpVlanEditTranslationalVlan2=vtpVlanEditTranslationalVlan2, vtpMaxVlanStorage=vtpMaxVlanStorage, vtpDiscoverTable=vtpDiscoverTable, vtpVlanEditConfigRevNumber=vtpVlanEditConfigRevNumber, vtpDiscoverResultSystemName=vtpDiscoverResultSystemName, vtpInternalVlanGrp=vtpInternalVlanGrp, managementDomainConfigRevNumber=managementDomainConfigRevNumber, vtpVersionInUseChanged=vtpVersionInUseChanged, vtpVlanMtu=vtpVlanMtu, vtpLastDiscoverTime=vtpLastDiscoverTime, vtp4kVlanGroup=vtp4kVlanGroup, managementDomainName=managementDomainName, vtpTrunkPortGroup2=vtpTrunkPortGroup2, vtpEditControlTable=vtpEditControlTable, vlanTrunkPortVtpEnabled=vlanTrunkPortVtpEnabled, vtpDot1qTunnelGroup=vtpDot1qTunnelGroup, vtpVlansPruningEligible3k=vtpVlansPruningEligible3k, vtpDiscoverResultEntry=vtpDiscoverResultEntry, vtpAuthPassword=vtpAuthPassword, vtpDatabaseLocalMode=vtpDatabaseLocalMode, vtpDiscoverResultDeviceId=vtpDiscoverResultDeviceId, vtpMIBGroups=vtpMIBGroups, vtpMIBCompliance10=vtpMIBCompliance10, vtpVersion2BasicGroup=vtpVersion2BasicGroup, vtpVlanEditStpType=vtpVlanEditStpType, vtpDatabaseGroup=vtpDatabaseGroup, managementDomainEntry=managementDomainEntry, managementDomainVersionInUse=managementDomainVersionInUse, ciscoVtpMIB=ciscoVtpMIB, vtpNotificationsEnabled=vtpNotificationsEnabled, vtpConfigNotificationsGroupRev1=vtpConfigNotificationsGroupRev1, vtpNotificationsObjects=vtpNotificationsObjects, vtpTrunkPortGroup=vtpTrunkPortGroup, vtpDatabaseName=vtpDatabaseName, vlanTrunkPortIfIndex=vlanTrunkPortIfIndex, vtpVlanParentVlan=vtpVlanParentVlan, vtpServerDisabled=vtpServerDisabled, vtpMIBCompliance4=vtpMIBCompliance4, vtpVlanEditTypeExt2=vtpVlanEditTypeExt2, vtpVlanEditEntry=vtpVlanEditEntry, vtpDatabaseIndex=vtpDatabaseIndex, vlanTrunkPortVlansRcvJoined3k=vlanTrunkPortVlansRcvJoined3k, vtpAuthenticationTable=vtpAuthenticationTable, vtpMIBConformance=vtpMIBConformance, vtpVlanInfoEditGroup2=vtpVlanInfoEditGroup2, vtpStatsEntry=vtpStatsEntry, vtpVlanDeleted=vtpVlanDeleted, vlanTrunkPortDynamicStatusChange=vlanTrunkPortDynamicStatusChange, vtpInternalVlanOwner=vtpInternalVlanOwner, vtpVlanEditTypeExt=vtpVlanEditTypeExt, vtpVlanEditBridgeNumber=vtpVlanEditBridgeNumber, vlanTrunkPortRowStatus=vlanTrunkPortRowStatus, vtpVlanEditBridgeType=vtpVlanEditBridgeType, vtpVlanPortLocalSegment=vtpVlanPortLocalSegment, vlanTrunkPortVlansXmitJoined4k=vlanTrunkPortVlansXmitJoined4k, vlanEdit=vlanEdit, vlanTrunkPortInJoins=vlanTrunkPortInJoins, vlanTrunkPortDot1qTunnel=vlanTrunkPortDot1qTunnel, vtpDiscoverResultDatabaseName=vtpDiscoverResultDatabaseName, vtpTrunkPruningGroup=vtpTrunkPruningGroup, vlanTrunkPortVlansEnabled3k=vlanTrunkPortVlansEnabled3k, vlanTrunkPortEntry=vlanTrunkPortEntry, vtpDiscoverResultConflicting=vtpDiscoverResultConflicting, vtpStatsTable=vtpStatsTable, vtpMIBCompliances=vtpMIBCompliances, vtpVlanAreHopCount=vtpVlanAreHopCount, vtpVlanTable=vtpVlanTable, vtpInSubsetAdverts=vtpInSubsetAdverts, vtpDatabaseTakeOverPassword=vtpDatabaseTakeOverPassword, vtpVlanEditModifiedVlan=vtpVlanEditModifiedVlan, vtpVlanIfIndexGroup=vtpVlanIfIndexGroup, managementDomainLocalMode=managementDomainLocalMode, vtpInternalVlanEntry=vtpInternalVlanEntry, vtpDiscoverGroup=vtpDiscoverGroup, vlanTrunkPortVlansXmitJoined=vlanTrunkPortVlansXmitJoined, vtpEditControlEntry=vtpEditControlEntry, vtpVlanEntry=vtpVlanEntry, vtpAuthSecretKey=vtpAuthSecretKey, vtpInSummaryAdverts=vtpInSummaryAdverts, vtpMtuTooBig=vtpMtuTooBig, vtpMIBCompliance8=vtpMIBCompliance8, vtpVlanEditIndex=vtpVlanEditIndex, vtpVlanEditRowStatus=vtpVlanEditRowStatus, vtpVlanRingNumberConflict=vtpVlanRingNumberConflict, vlanTrunkPortDynamicState=vlanTrunkPortDynamicState, vlanTrunkPortVlansEnabled2k=vlanTrunkPortVlansEnabled2k, vtpVlanEditRingNumber=vtpVlanEditRingNumber, managementDomainRowStatus=managementDomainRowStatus, vtpOutSummaryAdverts=vtpOutSummaryAdverts, vlanTrunkPortTable=vlanTrunkPortTable, vlanManagementDomains=vlanManagementDomains, vlanTrunkPortEncapsulationOperType=vlanTrunkPortEncapsulationOperType, vtpDatabase=vtpDatabase, managementDomainTable=managementDomainTable, vlanTrunkPortOldAdverts=vlanTrunkPortOldAdverts, vtpVlanBridgeType=vtpVlanBridgeType, vlanTrunkPortVlansEnabled4k=vlanTrunkPortVlansEnabled4k, vtpConfigNotificationsGroup=vtpConfigNotificationsGroup, vlanTrunkPortVlansPruningEligible=vlanTrunkPortVlansPruningEligible, vtpVlanSteHopCount=vtpVlanSteHopCount, vtpTrunkPortGroup3=vtpTrunkPortGroup3, vtpVlanType=vtpVlanType, vtpConfigDigestErrors=vtpConfigDigestErrors, vtpDatabaseTable=vtpDatabaseTable, vtpConfigDigestError=vtpConfigDigestError, vtpVlanEditSteHopCount=vtpVlanEditSteHopCount, vtpNotificationObjectsGroup=vtpNotificationObjectsGroup, managementDomainLastUpdater=managementDomainLastUpdater, vtpVlanApplyStatus=vtpVlanApplyStatus, vtpDiscover=vtpDiscover, vtpDatabasePrimaryServerId=vtpDatabasePrimaryServerId, vtpConfigRevNumberError=vtpConfigRevNumberError, vtpVlanEditTable=vtpVlanEditTable, vtpVlanEditState=vtpVlanEditState, vlanTrunkPortVlansXmitJoined2k=vlanTrunkPortVlansXmitJoined2k, vlanTrunkPortVlansXmitJoined3k=vlanTrunkPortVlansXmitJoined3k, vtpVlanStpType=vtpVlanStpType, vlanTrunkPortOutJoins=vlanTrunkPortOutJoins, vtpDiscoverStatus=vtpDiscoverStatus, vtpVlanBridgeNumber=vtpVlanBridgeNumber, managementDomainIndex=managementDomainIndex, vtpVlanInfoEditGroup=vtpVlanInfoEditGroup, vtpAuthGroup=vtpAuthGroup, vtpConfigNotificationsGroup4=vtpConfigNotificationsGroup4, vtpVlanDeletedNotifEnabled=vtpVlanDeletedNotifEnabled, vtpAuthentication=vtpAuthentication, vtpVlanName=vtpVlanName, managementDomainPruningState=managementDomainPruningState, managementDomainTftpPathname=managementDomainTftpPathname, vtpDiscoverResultPrimaryServer=vtpDiscoverResultPrimaryServer, vlanTrunkPortVlansEnabled=vlanTrunkPortVlansEnabled, internalVlanInfo=internalVlanInfo, vlanTrunkPorts=vlanTrunkPorts, vtpAuthPasswordType=vtpAuthPasswordType, vtpVlanEditType=vtpVlanEditType, vtpMIBCompliance11=vtpMIBCompliance11, vtpDot1qTunnelGroup2=vtpDot1qTunnelGroup2, vlanTrunkPortVlansRcvJoined4k=vlanTrunkPortVlansRcvJoined4k, vtpMIBCompliance12=vtpMIBCompliance12, vtpDiscoverEntry=vtpDiscoverEntry, vtpNotificationsPrefix=vtpNotificationsPrefix, vtpVlanIndex=vtpVlanIndex, vlanTrunkPortDynamicStatus=vlanTrunkPortDynamicStatus)
