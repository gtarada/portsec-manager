...
Counter64, Integer32, MibIdentifier, TimeTicks, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, ObjectIdentity, Bits, IpAddress, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "MibIdentifier", "TimeTicks", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "ObjectIdentity", "Bits", "IpAddress", "Counter32", "Gauge32")
TextualConvention, DisplayString, TruthValue, TimeStamp, DateAndTime, RowStatus, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "TruthValue", "TimeStamp", "DateAndTime", "RowStatus", "TestAndIncr")
...
mibBuilder.exportSymbols("CISCO-VTP-MIB", vlanTrunkPortInJoins=vlanTrunkPortInJoins, PYSNMP_MODULE_ID=ciscoVtpMIB, vtpDatabasePrimaryServerId=vtpDatabasePrimaryServerId, vtpInSubsetAdverts=vtpInSubsetAdverts, vtpVlanEditModifiedVlan=vtpVlanEditModifiedVlan, vtpVlanDeletedNotifEnabled=vtpVlanDeletedNotifEnabled, vlanTrunkPortRowStatus=vlanTrunkPortRowStatus, ciscoVtpMIB=ciscoVtpMIB, vtpStatus=vtpStatus, vtpVlanRingNumber=vtpVlanRingNumber, vtpAuthGroup=vtpAuthGroup, vlanInfo=vlanInfo, vtpVlanAreHopCount=vtpVlanAreHopCount, vtpInternalVlanTable=vtpInternalVlanTable, vtpNotificationsEnabled=vtpNotificationsEnabled, vtpVlansPruningEligible2k=vtpVlansPruningEligible2k, vtpLocalModeChanged=vtpLocalModeChanged, vtpVlanApplyStatus=vtpVlanApplyStatus, vtpLastDiscoverTime=vtpLastDiscoverTime, vtpDiscoverTable=vtpDiscoverTable, vtpAuthPassword=vtpAuthPassword, vtpVlanEditConfigRevNumber=vtpVlanEditConfigRevNumber, vtpDiscoverResultDatabaseName=vtpDiscoverResultDatabaseName, vtpVlanSteHopCount=vtpVlanSteHopCount, vlanTrunkPortNativeVlan=vlanTrunkPortNativeVlan, vlanTrunkPortVlansRcvJoined2k=vlanTrunkPortVlansRcvJoined2k, vtpDatabase=vtpDatabase, vtpStatsEntry=vtpStatsEntry, vtpInternalVlanAllocPolicy=vtpInternalVlanAllocPolicy, vtpDatabaseLocalMode=vtpDatabaseLocalMode, vtpMIBConformance=vtpMIBConformance, vtpEditControlEntry=vtpEditControlEntry, vtpVlanEditIndex=vtpVlanEditIndex, vlanTrunkPortManagementDomain=vlanTrunkPortManagementDomain, vtpConfigRevNumberError=vtpConfigRevNumberError, vtpVlanEditRowStatus=vtpVlanEditRowStatus, vtpInSummaryAdverts=vtpInSummaryAdverts, vlanTrunkPortVlansXmitJoined2k=vlanTrunkPortVlansXmitJoined2k, vtpDot1qTunnelGroup2=vtpDot1qTunnelGroup2, vlanTrunkPortVlansEnabled=vlanTrunkPortVlansEnabled, managementDomainName=managementDomainName, vtpBasicGroup=vtpBasicGroup, vtpDiscoverEntry=vtpDiscoverEntry, vlanTrunkPortVlansRcvJoined4k=vlanTrunkPortVlansRcvJoined4k, vtpVlanNotifEnabledGroup=vtpVlanNotifEnabledGroup, vtpVlanCreatedNotifEnabled=vtpVlanCreatedNotifEnabled, vtpConfigNotificationsGroup3=vtpConfigNotificationsGroup3, vtpNotifications=vtpNotifications, vtpConfigDigestError=vtpConfigDigestError, managementDomainConfigRevNumber=managementDomainConfigRevNumber, vtpServerDisabled=vtpServerDisabled, vtpNotificationObjectsGroup=vtpNotificationObjectsGroup, vlanTrunkPortVlansEnabled4k=vlanTrunkPortVlansEnabled4k, vtpAuthSecretKey=vtpAuthSecretKey, vlanTrunkPortVlansEnabled2k=vlanTrunkPortVlansEnabled2k, managementDomainPruningState=managementDomainPruningState, managementDomainLastUpdater=managementDomainLastUpdater, managementDomainTftpServer=managementDomainTftpServer, vtpDiscover=vtpDiscover, vtpVersionInUseChanged=vtpVersionInUseChanged, VlanType=VlanType, vtpVlanPortLocalSegment=vtpVlanPortLocalSegment, vlanTrunkPortVlansRcvJoined=vlanTrunkPortVlansRcvJoined, vtpDiscoverResultPrimaryServer=vtpDiscoverResultPrimaryServer, vlanTrunkPortVlansXmitJoined3k=vlanTrunkPortVlansXmitJoined3k, vtpVlansPruningEligible3k=vtpVlansPruningEligible3k, vtpMIBCompliance6=vtpMIBCompliance6, vtpTrunkPruningGroup=vtpTrunkPruningGroup, vlanTrunkPortOldAdverts=vlanTrunkPortOldAdverts, vtpOutSummaryAdverts=vtpOutSummaryAdverts, vlanTrunkPortVlansRcvJoined3k=vlanTrunkPortVlansRcvJoined3k, vtpInternalVlanGrp=vtpInternalVlanGrp, managementDomainLocalMode=managementDomainLocalMode, vtpConfigRevNumberErrors=vtpConfigRevNumberErrors, vlanTrunkPortsDot1qTag=vlanTrunkPortsDot1qTag, vtpNotificationsPrefix=vtpNotificationsPrefix, vtpOutAdvertRequests=vtpOutAdvertRequests, vtpMIBObjects=vtpMIBObjects, vtpVlanIsCRFBackup=vtpVlanIsCRFBackup, vtpVlanType=vtpVlanType, vtpVlanEditParentVlan=vtpVlanEditParentVlan, vtpVlanEditSteHopCount=vtpVlanEditSteHopCount, vtpVlanCreated=vtpVlanCreated, vlanTrunkPortVlansPruningEligible=vlanTrunkPortVlansPruningEligible, vtpAuthPasswordType=vtpAuthPasswordType, vlanTrunkPortVlansXmitJoined=vlanTrunkPortVlansXmitJoined, vtpInternalVlanOwner=vtpInternalVlanOwner, vtpDatabaseRevNumber=vtpDatabaseRevNumber, vtpNotificationsObjects=vtpNotificationsObjects, vtpMIBGroups=vtpMIBGroups, vtpTrunkPruningGroup2=vtpTrunkPruningGroup2, vtpVlanEditDot10Said=vtpVlanEditDot10Said, managementDomainIndex=managementDomainIndex, vtpMIBCompliances=vtpMIBCompliances, vtpOutSubsetAdverts=vtpOutSubsetAdverts, managementDomainEntry=managementDomainEntry, vtpVlanInfoEditGroup=vtpVlanInfoEditGroup, vtpInAdvertRequests=vtpInAdvertRequests, vtpVlanBridgeNumber=vtpVlanBridgeNumber, vlanTrunkPortVtpEnabled=vlanTrunkPortVtpEnabled, vlanTrunkPortEncapsulationType=vlanTrunkPortEncapsulationType, vtpTrunkPortGroup2=vtpTrunkPortGroup2, vtpVlanEditBridgeNumber=vtpVlanEditBridgeNumber, vtpDiscoverResultConflicting=vtpDiscoverResultConflicting, vtpDiscoverResultTable=vtpDiscoverResultTable, vtpMtuTooBig=vtpMtuTooBig, internalVlanInfo=internalVlanInfo, vtpConfigNotificationsGroup5=vtpConfigNotificationsGroup5, vtpVlanParentVlan=vtpVlanParentVlan, vlanTrunkPortEncapsulationOperType=vlanTrunkPortEncapsulationOperType, vtpVlanEditRingNumber=vtpVlanEditRingNumber, vtpDiscoverResultEntry=vtpDiscoverResultEntry, vtpVlanMtu=vtpVlanMtu, vtpVlanDot10Said=vtpVlanDot10Said, vtpEditControlTable=vtpEditControlTable, vtpDatabaseTakeOverPrimary=vtpDatabaseTakeOverPrimary, vtpConfigDigestErrors=vtpConfigDigestErrors, vtpVlanEditTypeExt=vtpVlanEditTypeExt, vlanTrunkPortEntry=vlanTrunkPortEntry, vtpMIBCompliance3=vtpMIBCompliance3, vtpVlansPruningEligible4k=vtpVlansPruningEligible4k, vtpConfigNotificationsGroup=vtpConfigNotificationsGroup, vlanTrunkPortSetSerialNo=vlanTrunkPortSetSerialNo, vtpDiscoverResultRevNumber=vtpDiscoverResultRevNumber, vtpVlanEditTranslationalVlan1=vtpVlanEditTranslationalVlan1, vtpMIBCompliance9=vtpMIBCompliance9, vtpDiscoverResultIndex=vtpDiscoverResultIndex, vtpVersion2BasicGroup=vtpVersion2BasicGroup, vtpDiscoverResultSystemName=vtpDiscoverResultSystemName, vtpDiscoverGroup=vtpDiscoverGroup, vtpVlanEditTypeExt2=vtpVlanEditTypeExt2, vtpVlanEditTable=vtpVlanEditTable, vtpStatsGroup=vtpStatsGroup, vtpDatabaseEntry=vtpDatabaseEntry, vtpDatabasePrimaryServer=vtpDatabasePrimaryServer, vtpAuthenticationTable=vtpAuthenticationTable, vtpVlanRingNumberConflict=vtpVlanRingNumberConflict, vtpVlanTranslationalVlan1=vtpVlanTranslationalVlan1, vtpDiscoverResultDeviceId=vtpDiscoverResultDeviceId, vtpVlanIndex=vtpVlanIndex, vtpVlanName=vtpVlanName, vtpVlanEditEntry=vtpVlanEditEntry, vtpVlanStpType=vtpVlanStpType, vtpMIBCompliance=vtpMIBCompliance, vlanTrunkPortDynamicStatusChange=vlanTrunkPortDynamicStatusChange, vtpMIBCompliance10=vtpMIBCompliance10, vtpVlanEntry=vtpVlanEntry, vtpMaxVlanStorage=vtpMaxVlanStorage, vtpVlanEditBridgeType=vtpVlanEditBridgeType, vtp4kVlanGroup=vtp4kVlanGroup, vtpTrunkPortGroup=vtpTrunkPortGroup, vlanTrunkPortTable=vlanTrunkPortTable, vtpVlanEditIsCRFBackup=vtpVlanEditIsCRFBackup, vlanTrunkPorts=vlanTrunkPorts, vtpDatabaseIndex=vtpDatabaseIndex, vtpDiscoverStatus=vtpDiscoverStatus, vtpVlanBridgeType=vtpVlanBridgeType, vlanTrunkPortOutJoins=vlanTrunkPortOutJoins, vlanEdit=vlanEdit, vtpVlanEditAreHopCount=vtpVlanEditAreHopCount, vtpVlanState=vtpVlanState, vtpVlanEditTranslationalVlan2=vtpVlanEditTranslationalVlan2, vtpVlanEditStpType=vtpVlanEditStpType, vlanTrunkPortDynamicState=vlanTrunkPortDynamicState, vtpDiscoverAction=vtpDiscoverAction, vtpAuthentication=vtpAuthentication, vtpVersion=vtpVersion, vlanTrunkPortDynamicStatus=vlanTrunkPortDynamicStatus, vtpVersionOneDeviceDetected=vtpVersionOneDeviceDetected, managementDomainTftpPathname=managementDomainTftpPathname, vtpStats=vtpStats, managementDomainTable=managementDomainTable, vtpVlanTable=vtpVlanTable, vtpVlanDeleted=vtpVlanDeleted, VlanIndex=VlanIndex, vtpDatabaseName=vtpDatabaseName, vtpVlanIfIndexGroup=vtpVlanIfIndexGroup, vtpConfigNotificationsGroup2=vtpConfigNotificationsGroup2, vtpConfigNotificationsGroupRev1=vtpConfigNotificationsGroupRev1, managementDomainLastChange=managementDomainLastChange, vtpVlanTranslationalVlan2=vtpVlanTranslationalVlan2, vtpVlanEditBufferOwner=vtpVlanEditBufferOwner, vtpVlanEditMtu=vtpVlanEditMtu, vtpTrunkPortGroup3=vtpTrunkPortGroup3, vtpVlanEditType=vtpVlanEditType, vtpMIBCompliance12=vtpMIBCompliance12, vlanTrunkPortIfIndex=vlanTrunkPortIfIndex, vtpMIBCompliance2=vtpMIBCompliance2, managementDomainRowStatus=managementDomainRowStatus, ManagementDomainIndex=ManagementDomainIndex, vtpAuthEntry=vtpAuthEntry, vtpVlanInfoEditGroup2=vtpVlanInfoEditGroup2, vtpInternalVlanEntry=vtpInternalVlanEntry, vtpStatsTable=vtpStatsTable, vtpConfigNotificationsGroup4=vtpConfigNotificationsGroup4, vtpMIBCompliance11=vtpMIBCompliance11, vlanTrunkPortVlansEnabled3k=vlanTrunkPortVlansEnabled3k, vtpMIBCompliance8=vtpMIBCompliance8, vtp4kVlanGroupRev1=vtp4kVlanGroupRev1, vtpVlanIfIndex=vtpVlanIfIndex, vlanManagementDomains=vlanManagementDomains, vtpVlanTypeExt=vtpVlanTypeExt, vtpDatabaseTakeOverPassword=vtpDatabaseTakeOverPassword, vtpVlanEditState=vtpVlanEditState, vlanTrunkPortDot1qTunnel=vlanTrunkPortDot1qTunnel, vtpDot1qTunnelGroup=vtpDot1qTunnelGroup, vtpVlanInfoGroup=vtpVlanInfoGroup, managementDomainVersionInUse=managementDomainVersionInUse, vtpDatabaseGroup=vtpDatabaseGroup, vtpVlanEditName=vtpVlanEditName, vtpMIBCompliance4=vtpMIBCompliance4, vtpMIBCompliance5=vtpMIBCompliance5, vtpDatabaseTable=vtpDatabaseTable, vtpMIBCompliance7=vtpMIBCompliance7, VlanTypeExt=VlanTypeExt, vtpVlanEditOperation=vtpVlanEditOperation, vlanTrunkPortVlansXmitJoined4k=vlanTrunkPortVlansXmitJoined4k)
