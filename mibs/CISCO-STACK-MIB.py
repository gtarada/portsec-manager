...
ifName, OwnerString, ifIndex = mibBuilder.importSymbols("IF-MIB", "ifName", "OwnerString", "ifIndex")
ObjectGroup, NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "NotificationGroup", "ModuleCompliance")
IpAddress, TimeTicks, MibIdentifier, NotificationType, Counter32, Counter64, iso, Bits, Integer32, Gauge32, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "MibIdentifier", "NotificationType", "Counter32", "Counter64", "iso", "Bits", "Integer32", "Gauge32", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("CISCO-STACK-MIB", ipPermitAccessType=ipPermitAccessType, sysCommunityRo=sysCommunityRo, traceRouteQueryTable=traceRouteQueryTable, tokenRingModuleIndex=tokenRingModuleIndex, tokenRingDripRemotePortStatus=tokenRingDripRemotePortStatus, portCpbCosRewrite=portCpbCosRewrite, ciscoStackgMIBCompliance=ciscoStackgMIBCompliance, mcastRouterPortIndex=mcastRouterPortIndex, optionalSystemTrapGroup1=optionalSystemTrapGroup1, wsc6513sysID=wsc6513sysID, optionalSystemMiscGroup3=optionalSystemMiscGroup3, vlanSpantreeEnable=vlanSpantreeEnable, mcastRouterTable=mcastRouterTable, portTopNModuleNumber=portTopNModuleNumber, portCpbDot1x=portCpbDot1x, portCrossIndex=portCrossIndex, moduleName=moduleName, traceRouteQueryWaitingTime=traceRouteQueryWaitingTime, brouterCamMode=brouterCamMode, filterMacTable=filterMacTable, chassisMajorAlarm=chassisMajorAlarm, chassisMinorAlarm=chassisMinorAlarm, vlanGrp=vlanGrp, filterPortBroadcastDiscards=filterPortBroadcastDiscards, voicePortCallManagerEntry=voicePortCallManagerEntry, authenticationGroup=authenticationGroup, tokenRingPortSetACbits=tokenRingPortSetACbits, sysEnableEntityTrap=sysEnableEntityTrap, moduleSwLoVersion=moduleSwLoVersion, brouterFddiReceiveMax=brouterFddiReceiveMax, portSecurityExtTable=portSecurityExtTable, tokenRingDripAdvertsProcessed=tokenRingDripAdvertsProcessed, wsc3100sysID=wsc3100sysID, portCpbVlanMembership=portCpbVlanMembership, sysEnableConfigTraps=sysEnableConfigTraps, sysExtendedRmonNetflowPassword=sysExtendedRmonNetflowPassword, cpw1601sysID=cpw1601sysID, sysTraffic=sysTraffic, portChannelPorts=portChannelPorts, fileCopyAction=fileCopyAction, vmpsTable=vmpsTable, sysHighAvailabilityEnable=sysHighAvailabilityEnable, filterProtocolModule=filterProtocolModule, wsc1900LiteFxsysID=wsc1900LiteFxsysID, portGrp=portGrp, wsc3900sysID=wsc3900sysID, portModuleIndex=portModuleIndex, monitorGrp=monitorGrp, brouterPortBridgeVlan=brouterPortBridgeVlan, portTopNType=portTopNType, brouterPortIpAddr=brouterPortIpAddr, ciscoStackMIBGroups=ciscoStackMIBGroups, mdgGatewayType=mdgGatewayType, ciscoStackgMIBCompliance4=ciscoStackgMIBCompliance4, portTopNGrp=portTopNGrp, sysTrapReceiverAddr=sysTrapReceiverAddr, portSecurityViolationPolicy=portSecurityViolationPolicy, vmpsGroup=vmpsGroup, syslogTimeStampOption=syslogTimeStampOption, tokenRingPortMode=tokenRingPortMode, cpw1800sysID=cpw1800sysID, moduleHwVersion=moduleHwVersion, moduleAdditionalStatus=moduleAdditionalStatus, systemMiscGroup=systemMiscGroup, switchAccelerationModuleIndex=switchAccelerationModuleIndex, vmpsAction=vmpsAction, portTopNInErrors=portTopNInErrors, mcastRouterModuleIndex=mcastRouterModuleIndex, voicePortIfIpNetMask=voicePortIfIpNetMask, radiusAuthKey=radiusAuthKey, chassisSysType=chassisSysType, filterPort=filterPort, cpw2200sysID=cpw2200sysID, tokenRingDripLastRevision=tokenRingDripLastRevision, filterTestOffset=filterTestOffset, sysReset=sysReset, ciscoStackMIB=ciscoStackMIB, radiusServerAddr=radiusServerAddr, wsc2980gsysID=wsc2980gsysID, tacacsNumLoginAttempts=tacacsNumLoginAttempts, portCpbTosRewrite=portCpbTosRewrite, portSecurityTable=portSecurityTable, wsc6509sysID=wsc6509sysID, brouterPortIpVlan=brouterPortIpVlan, tacacsLoginAuthentication=tacacsLoginAuthentication, sysNetMask=sysNetMask, portGroup1=portGroup1, chassisComponentType=chassisComponentType, filterMacPort=filterMacPort, tokenRingPortSoftErrEntry=tokenRingPortSoftErrEntry, filterVendorModule=filterVendorModule, wsc4503sysID=wsc4503sysID, syslogMessageControlEntry=syslogMessageControlEntry, tokenRingGroup=tokenRingGroup, monitorSourceModule=monitorSourceModule, securityGrp=securityGrp, portTopNIOOctets=portTopNIOOctets, chassisPs3TestResult=chassisPs3TestResult, sysBootedImage=sysBootedImage, ntpAuthenticationEnable=ntpAuthenticationEnable, portChannelAdminStatus=portChannelAdminStatus, sysCommunityEntry=sysCommunityEntry, voicePortDnsModuleIndex=voicePortDnsModuleIndex, chassisBkplType=chassisBkplType, portCrossGroupIndex=portCrossGroupIndex, brouterEnableSpantree=brouterEnableSpantree, tacacsServerType=tacacsServerType, sysExtendedRmonNetflowEnable=sysExtendedRmonNetflowEnable, portInlinePowerDetect=portInlinePowerDetect, monitorDestinationModule=monitorDestinationModule, portCpbPortIndex=portCpbPortIndex, ntpServerType=ntpServerType, mdgGatewayEntry=mdgGatewayEntry, sysBannerMotd=sysBannerMotd, tokenRingPortTable=tokenRingPortTable, chassisGroup=chassisGroup, ntpGroup=ntpGroup, monitorDirection=monitorDirection, chassisComponentHwVersion=chassisComponentHwVersion, cpw1220sysID=cpw1220sysID, wsc1000sysID=wsc1000sysID, ntpGrp=ntpGrp, wsc2820sysID=wsc2820sysID, brouterEthernetTransmitMax=brouterEthernetTransmitMax, optionalSystemMiscGroup5=optionalSystemMiscGroup5, tokenRingPortPriorityMinXmit=tokenRingPortPriorityMinXmit, dnsDomainName=dnsDomainName, mcastGroup1=mcastGroup1, mcastEnableIgmp=mcastEnableIgmp, switchAccelerationGrp=switchAccelerationGrp, sysConsolePrimaryLoginAuthentication=sysConsolePrimaryLoginAuthentication, fileCopyResult=fileCopyResult, radiusServerAuthPort=radiusServerAuthPort, vlanGroup=vlanGroup, ntpServerEntry=ntpServerEntry, tokenRingDripVlan=tokenRingDripVlan, voicePortIfGatewayAddress=voicePortIfGatewayAddress, ntpTimezoneName=ntpTimezoneName, sysEnableStpxTrap=sysEnableStpxTrap, portSecurityExtSecureSrcAddr=portSecurityExtSecureSrcAddr, fileCopyResultRcpErrorMessage=fileCopyResultRcpErrorMessage, switchAccelerationModuleTable=switchAccelerationModuleTable, modulePortStatus=modulePortStatus, configWriteMemStatus=configWriteMemStatus, chassisPs1TestResult=chassisPs1TestResult, tokenRingDripOutputQueueDrops=tokenRingDripOutputQueueDrops, filterTestType=filterTestType, sysTrafficMeterType=sysTrafficMeterType, voicePortIfDHCPEnabled=voicePortIfDHCPEnabled, wsc6509nebasysID=wsc6509nebasysID, tokenRingDripBackupCrf=tokenRingDripBackupCrf, sysFddiRingNext=sysFddiRingNext, portTopNIOMulticast=portTopNIOMulticast, cisco7603sysID=cisco7603sysID, ipPermitType=ipPermitType, portAdminTxFlowControl=portAdminTxFlowControl, chassisSlotConfig=chassisSlotConfig, ntpSummerTimezoneName=ntpSummerTimezoneName, sysTrapReceiverTable=sysTrapReceiverTable, configGrp=configGrp, portChannelGrp=portChannelGrp, portTopNMode=portTopNMode, moduleStatus=moduleStatus, traceRouteQueryMaxTTL=traceRouteQueryMaxTTL, portTopNUtilization=portTopNUtilization, chassisPs2Type=chassisPs2Type, ntpAuthenticationGroup=ntpAuthenticationGroup, dnsGrp=dnsGrp, voicePortOperDnsServerIndex=voicePortOperDnsServerIndex, wsc2948gsysID=wsc2948gsysID, filterGrp=filterGrp, sysTrafficMeterEntry=sysTrafficMeterEntry, portJumboFrameTable=portJumboFrameTable, moduleFwLoVersion=moduleFwLoVersion, ipPermitAddress=ipPermitAddress, portCpbTrunkMode=portCpbTrunkMode, sysExtendedRmonVlanAgentEnable=sysExtendedRmonVlanAgentEnable, portTopNStatus=portTopNStatus, tacacsGrp=tacacsGrp, filterPortModule=filterPortModule, sysConfigChangeTrap=sysConfigChangeTrap, sysEnableRepeaterTraps=sysEnableRepeaterTraps, brouterIpxSnapToEther=brouterIpxSnapToEther, tacacsDirectedRequest=tacacsDirectedRequest, filterPortSuppressionOption=filterPortSuppressionOption, portMacControlTransmitFrames=portMacControlTransmitFrames, chassisSerialNumber=chassisSerialNumber, tokenRingSoftErrorMonitorGroup=tokenRingSoftErrorMonitorGroup, brouterEnableRip=brouterEnableRip, vmpsAddr=vmpsAddr, sysStartupConfigSource=sysStartupConfigSource, wsc1200sysID=wsc1200sysID, moduleModel=moduleModel, moduleSwHiVersion=moduleSwHiVersion, tftpAction=tftpAction, portChannelIfIndex=portChannelIfIndex, tokenRingDripLocalNodeID=tokenRingDripLocalNodeID, sshPublicKeySize=sshPublicKeySize, syslogServerType=syslogServerType, brouterIpx8022ToEther=brouterIpx8022ToEther, wsc6knamsysID=wsc6knamsysID, portSecurityLastSrcAddr=portSecurityLastSrcAddr, portTopNIndex=portTopNIndex, moduleSlotNum=moduleSlotNum, sysExtendedRmonEnable=sysExtendedRmonEnable, systemFddiGroup=systemFddiGroup, filterTestValue=filterTestValue, traceRouteDataIndex=traceRouteDataIndex, voicePortCallManagerIpAddr=voicePortCallManagerIpAddr, brouterIpx8023RawToFddi=brouterIpx8023RawToFddi, ntpSummertimeStatus=ntpSummertimeStatus, vlanTrunkMappingStatus=vlanTrunkMappingStatus, systemTrapGroup1=systemTrapGroup1, mcastRouterOperStatus=mcastRouterOperStatus, tftpModule=tftpModule, vlanTable=vlanTable, portSecurityModuleIndex=portSecurityModuleIndex, ntpServerAddress=ntpServerAddress, voicePortOperDnsServerIpAddr=voicePortOperDnsServerIpAddr, mdgGatewayTable=mdgGatewayTable, filterVendorTable=filterVendorTable, ciscoStackgMIBCompliance2=ciscoStackgMIBCompliance2, portCpbUdld=portCpbUdld, sysExtendedRmonNetflowModuleMask=sysExtendedRmonNetflowModuleMask, portCpbIgmpFilter=portCpbIgmpFilter, portJumboFrameEnable=portJumboFrameEnable, moduleGroup1=moduleGroup1, portGroup4=portGroup4, monitorDestinationPort=monitorDestinationPort, sysMacReductionOperEnable=sysMacReductionOperEnable, cpw1220csysID=cpw1220csysID, sysCommunityRw=sysCommunityRw, portOperRxFlowControl=portOperRxFlowControl, ntpBcastDelay=ntpBcastDelay, portIfIndex=portIfIndex, moduleUp=moduleUp, ipPermitDeniedAccess=ipPermitDeniedAccess, filterProtocolEntry=filterProtocolEntry, moduleGroup=moduleGroup, sysClearPortTime=sysClearPortTime, voicePortOperDnsServerEntry=voicePortOperDnsServerEntry, wsc2926sysID=wsc2926sysID, vlanTrunkMappingFromVlan=vlanTrunkMappingFromVlan, vlanPortIslVlansAllowed=vlanPortIslVlansAllowed, chassisComponentSerialNumber=chassisComponentSerialNumber, radiusTimeout=radiusTimeout, vlanTrunkMappingTable=vlanTrunkMappingTable, tokenRingPortEarlyTokenRel=tokenRingPortEarlyTokenRel, dnsServerType=dnsServerType, voicePortCallManagerTable=voicePortCallManagerTable, tokenRingDripInputQueueDrops=tokenRingDripInputQueueDrops, portCpbAuxiliaryVlan=portCpbAuxiliaryVlan, voicePortOperDnsServerTable=voicePortOperDnsServerTable, vlanIndex=vlanIndex)
mibBuilder.exportSymbols("CISCO-STACK-MIB", tokenRingPortSoftErrThresh=tokenRingPortSoftErrThresh, traceRouteGroup=traceRouteGroup, tsStack=tsStack, vlanPortIslAdminStatus=vlanPortIslAdminStatus, ipPermitDeniedListEntry=ipPermitDeniedListEntry, wsc1100sysID=wsc1100sysID, filterPortBroadcastThreshold=filterPortBroadcastThreshold, voicePortIfConfigPortIndex=voicePortIfConfigPortIndex, ntpTimezoneOffsetHour=ntpTimezoneOffsetHour, wsc3000sysID=wsc3000sysID, moduleIPAddressVlan=moduleIPAddressVlan, ntpAuthenticationPublicKey=ntpAuthenticationPublicKey, systemStatusGroup=systemStatusGroup, sysEnableBridgeTraps=sysEnableBridgeTraps, chassisComponentEntry=chassisComponentEntry, wsc3001sysID=wsc3001sysID, tacacsLocalEnableAuthentication=tacacsLocalEnableAuthentication, voicePortIfConfigEntry=voicePortIfConfigEntry, tokenRingSoftErrExceededTrap=tokenRingSoftErrExceededTrap, traceRouteQueryIndex=traceRouteQueryIndex, esStack=esStack, vlanTrunkMappingOper=vlanTrunkMappingOper, tokenRingDripLastChangedRevision=tokenRingDripLastChangedRevision, cisco7609sysID=cisco7609sysID, systemTrapGroup=systemTrapGroup, portTopNEntry=portTopNEntry, tftpResult=tftpResult, portCpbTable=portCpbTable, radiusRetransmits=radiusRetransmits, voicePortIfDnsServerAddress=voicePortIfDnsServerAddress, tokenRingDripLocalPortStatus=tokenRingDripLocalPortStatus, moduleIndex=moduleIndex, voicePortOperDnsServerSource=voicePortOperDnsServerSource, ntpAuthenticationTable=ntpAuthenticationTable, ntpServerTable=ntpServerTable, portEntry=portEntry, configWriteMem=configWriteMem, sysTrafficPeakTime=sysTrafficPeakTime, radiusEnableAuthentication=radiusEnableAuthentication, traceRouteQueryEntry=traceRouteQueryEntry, filterVendorType=filterVendorType, optionalSystemMiscGroup4=optionalSystemMiscGroup4, filterPortBroadcastThresholdFraction=filterPortBroadcastThresholdFraction, sysEnableRedirects=sysEnableRedirects, portMacControlPauseReceiveFrames=portMacControlPauseReceiveFrames, switchAccelerationModuleGroup=switchAccelerationModuleGroup, portCpbGroup4=portCpbGroup4, ciscoStackNotificationsPrefix=ciscoStackNotificationsPrefix, radiusServerType=radiusServerType, chassisFanTestResult=chassisFanTestResult, sysBroadcast=sysBroadcast, sysConfigRegister=sysConfigRegister, vlanPortAdminStatus=vlanPortAdminStatus, monitorAdminSourcePorts=monitorAdminSourcePorts, tftpFile=tftpFile, traceRouteGrp=traceRouteGrp, vlanPortAuxiliaryVlan=vlanPortAuxiliaryVlan, tokenRingPortSoftErrLastCounterReset=tokenRingPortSoftErrLastCounterReset, ntpBcastClient=ntpBcastClient, PYSNMP_MODULE_ID=ciscoStackMIB, fileCopyModuleNumber=fileCopyModuleNumber, tokenRingDripLocalVlanStatusEntry=tokenRingDripLocalVlanStatusEntry, moduleSerialNumber=moduleSerialNumber, tokenRingPortEntry=tokenRingPortEntry, voicePortIndex=voicePortIndex, sysTrapReceiverEntry=sysTrapReceiverEntry, portMacControlPauseTransmitFrames=portMacControlPauseTransmitFrames, wsc6009sysID=wsc6009sysID, brouterPort=brouterPort, filterTestEntry=filterTestEntry, portIndex=portIndex, brouterPortModule=brouterPortModule, traceRouteDataGatewayName=traceRouteDataGatewayName, filterProtocolValue=filterProtocolValue, moduleStandbyStatus=moduleStandbyStatus, portGroup2=portGroup2, mcastEnableCgmp=mcastEnableCgmp, portChannelNeighbourDeviceId=portChannelNeighbourDeviceId, syslogServerAddr=syslogServerAddr, portName=portName, filterTestModule=filterTestModule, sysFddiRingEntry=sysFddiRingEntry, portSecurityGroup1=portSecurityGroup1, filterGroup1=filterGroup1, voicePortIfConfigTable=voicePortIfConfigTable, traceRouteQueryPacketCount=traceRouteQueryPacketCount, sysInsertMode=sysInsertMode, ciscoStackgMIBCompliance6=ciscoStackgMIBCompliance6, tokenRingPortSoftErrReportInterval=tokenRingPortSoftErrReportInterval, wsc6509nebsysID=wsc6509nebsysID, sysStartupConfigSourceFile=sysStartupConfigSourceFile, portTopNRateBase=portTopNRateBase, portSecurityMaxSrcAddr=portSecurityMaxSrcAddr, traceRouteQueryStatus=traceRouteQueryStatus, sysTrafficPeak=sysTrafficPeak, portMacControlReceiveFrames=portMacControlReceiveFrames, tokenRingPortCfgLossThresh=tokenRingPortCfgLossThresh, syslogTelnetEnable=syslogTelnetEnable, systemRmonGroup2=systemRmonGroup2, portTopNTable=portTopNTable, wsc1400sysID=wsc1400sysID, filterGroup2=filterGroup2, syslogGroup2=syslogGroup2, portTopNStartTime=portTopNStartTime, sysHighAvailabilityOperStatus=sysHighAvailabilityOperStatus, portSecurityExtControlStatus=portSecurityExtControlStatus, portSecuritySecureSrcAddr=portSecuritySecureSrcAddr, portCpbTrunkEncapsulationType=portCpbTrunkEncapsulationType, wsc6506sysID=wsc6506sysID, chassisPs3Status=chassisPs3Status, chassisSerialNumberString=chassisSerialNumberString, syslogGrp=syslogGrp, dnsServerTable=dnsServerTable, ntpAuthenticationEntry=ntpAuthenticationEntry, ipPermitDeniedTime=ipPermitDeniedTime, cisco7606sysID=cisco7606sysID, moduleGroup2=moduleGroup2, sysTrafficMonitorHighWaterMark=sysTrafficMonitorHighWaterMark, sysCommunityRwa=sysCommunityRwa, vlanPortVlan=vlanPortVlan, syslogServerTable=syslogServerTable, portCpbModuleIndex=portCpbModuleIndex, brouterEnableUnreachables=brouterEnableUnreachables, vlanTrunkMappingMax=vlanTrunkMappingMax, chassisComponentTable=chassisComponentTable, filterVendorId=filterVendorId, sysTelnetPrimaryLoginAuthentication=sysTelnetPrimaryLoginAuthentication, portCpbEntry=portCpbEntry, optionalSystemMiscGroup2=optionalSystemMiscGroup2, sysTelnetPrimaryEnableAuthentication=sysTelnetPrimaryEnableAuthentication, sysConfigSupervisorModuleNo=sysConfigSupervisorModuleNo, vlanEntry=vlanEntry, vlanPort=vlanPort, portSpantreeFastStart=portSpantreeFastStart, ciscoStackgMIBCompliance5=ciscoStackgMIBCompliance5, sysMgmtType=sysMgmtType, portType=portType, brouterEnableGiantCheck=brouterEnableGiantCheck, portTopNTimeRemaining=portTopNTimeRemaining, sysCommunityString=sysCommunityString, ipPermitListEntry=ipPermitListEntry, moduleDown=moduleDown, vlanTrunkMappingType=vlanTrunkMappingType, wsc6504esysID=wsc6504esysID, sysTrapReceiverComm=sysTrapReceiverComm, sysMacReductionAdminEnable=sysMacReductionAdminEnable, systemGrp=systemGrp, portGroup3=portGroup3, syslogHostEnable=syslogHostEnable, sysClearMacTime=sysClearMacTime, systemMiscGroup1=systemMiscGroup1, portTopNGrantedSize=portTopNGrantedSize, syslogMessageControlTable=syslogMessageControlTable, portChannelNeighbourPortId=portChannelNeighbourPortId, sysTrafficMeter=sysTrafficMeter, filterProtocolType=filterProtocolType, vlanPortIslOperStatus=vlanPortIslOperStatus, ntpAuthenticationSecretKey=ntpAuthenticationSecretKey, notificationGroup=notificationGroup, portSecurityPortIndex=portSecurityPortIndex, filterPortComplex=filterPortComplex, vmpsAccessed=vmpsAccessed, portTopNControlTable=portTopNControlTable, mcastEnableRgmp=mcastEnableRgmp, syslogConsoleEnable=syslogConsoleEnable, vlanTrunkMappingEntry=vlanTrunkMappingEntry, voiceGroup=voiceGroup, brouterFddiTransmitMax=brouterFddiTransmitMax, mcastGroup=mcastGroup, portCpbSpan=portCpbSpan, chassisPs2TestResult=chassisPs2TestResult, tokenRingDripAdvertsReceived=tokenRingDripAdvertsReceived, radiusServerTable=radiusServerTable, switchAccelerationModuleEnable=switchAccelerationModuleEnable, portOperTxFlowControl=portOperTxFlowControl, sysFddiRingSMTIndex=sysFddiRingSMTIndex, optionalModuleGroup=optionalModuleGroup, traceRouteQueryDNSEnable=traceRouteQueryDNSEnable, sysTrafficMeterTable=sysTrafficMeterTable, cpw1900sysID=cpw1900sysID, sysIpAddr=sysIpAddr, portTopNOwner=portTopNOwner, sysConfigChangeInfo=sysConfigChangeInfo, portJumboFrameGroup=portJumboFrameGroup, chassisPEMInstalled=chassisPEMInstalled, moduleHwHiVersion=moduleHwHiVersion, brouterEnableAPaRT=brouterEnableAPaRT, vlanPortEntry=vlanPortEntry, portAdditionalStatus=portAdditionalStatus, portSecurityEntry=portSecurityEntry, authenticationGroup1=authenticationGroup1, voicePortCallManagerIndex=voicePortCallManagerIndex, wsc5500sysID=wsc5500sysID, wsc4506sysID=wsc4506sysID, configurationGroup=configurationGroup, sysErrDisableTimeoutInterval=sysErrDisableTimeoutInterval, portChannelModuleIndex=portChannelModuleIndex, monitorOperSourcePorts=monitorOperSourcePorts, vlanPortModule=vlanPortModule, monitorEnable=monitorEnable, moduleAction=moduleAction, ciscoStackMIBCompliances=ciscoStackMIBCompliances, moduleNumPorts=moduleNumPorts, portChannelProtInPackets=portChannelProtInPackets, wsc3200sysID=wsc3200sysID, brouterEthernetReceiveMax=brouterEthernetReceiveMax, portCpbDuplex=portCpbDuplex, sysEnableRmon=sysEnableRmon, sysTrafficMeterPeakTime=sysTrafficMeterPeakTime, brouterPortNetMask=brouterPortNetMask, tftpHost=tftpHost, portAdditionalOperStatus=portAdditionalOperStatus, chassisModel=chassisModel, portSecurityAgingTime=portSecurityAgingTime, syslogGroup=syslogGroup, mcastRouterAdminStatus=mcastRouterAdminStatus, portSecurityShutdownTimeOut=portSecurityShutdownTimeOut, adapterCard=adapterCard, tokenRingDripLocalVlanStatusTable=tokenRingDripLocalVlanStatusTable, ntpAuthenticationTrustedMode=ntpAuthenticationTrustedMode, chassisFanStatus=chassisFanStatus, moduleSubType=moduleSubType, wsc4006sysID=wsc4006sysID, filterVendorEntry=filterVendorEntry, vlanTrunkMappingToVlan=vlanTrunkMappingToVlan, wsc4912gsysID=wsc4912gsysID, ipPermitDeniedListTable=ipPermitDeniedListTable, traceRouteQueryTOS=traceRouteQueryTOS, portCpbSpeed=portCpbSpeed, wsc5002sysID=wsc5002sysID, wsc6006sysID=wsc6006sysID, moduleSubType2=moduleSubType2, moduleType=moduleType, filterMacEntry=filterMacEntry, cpw1420sysID=cpw1420sysID, portChannelPortIndex=portChannelPortIndex, brouteEnableGroup=brouteEnableGroup, configTextFileLocation=configTextFileLocation, syslogMessageFacility=syslogMessageFacility, portSecurityOperStatus=portSecurityOperStatus, filterTestIndex=filterTestIndex, optionalPortGroup=optionalPortGroup, portChannelProtOutPackets=portChannelProtOutPackets, mdgGatewayGroup=mdgGatewayGroup, wsc1900isysID=wsc1900isysID, tacacsServerTable=tacacsServerTable, sysConsolePrimaryEnableAuthentication=sysConsolePrimaryEnableAuthentication, moduleFwHiVersion=moduleFwHiVersion, brouterEnableFddiCheck=brouterEnableFddiCheck, sysCommunityTable=sysCommunityTable, sysEnableModuleTraps=sysEnableModuleTraps, tokenRingDripDistributedCrf=tokenRingDripDistributedCrf, fileCopyGroup=fileCopyGroup, systemTrafficGroup=systemTrafficGroup)
mibBuilder.exportSymbols("CISCO-STACK-MIB", traceRouteQueryResult=traceRouteQueryResult, optionalSystemMiscGroup1=optionalSystemMiscGroup1, portCpbSecurity=portCpbSecurity, tokenRingDripOwnerNodeID=tokenRingDripOwnerNodeID, wsc4003sysID=wsc4003sysID, traceRouteDataRtt=traceRouteDataRtt, ipPermitDeniedTrap=ipPermitDeniedTrap, optionalSystemMiscGroup=optionalSystemMiscGroup, wsc5509sysID=wsc5509sysID, filterMacModule=filterMacModule, traceRouteQueryPacketSize=traceRouteQueryPacketSize, portTopNPortNumber=portTopNPortNumber, traceRouteHost=traceRouteHost, configMode=configMode, chassisComponentIndex=chassisComponentIndex, ipPermitListGrp=ipPermitListGrp, chassisGrp=chassisGrp, sysCommunityAccess=sysCommunityAccess, portCpbGroup1=portCpbGroup1, sysStandbyPortEnable=sysStandbyPortEnable, vlanIfIndex=vlanIfIndex, moduleEntry=moduleEntry, wsc2948ggetxsysID=wsc2948ggetxsysID, brouterPortIpHelpers=brouterPortIpHelpers, tacacsServerAddr=tacacsServerAddr, multicastGrp=multicastGrp, portTopNReportStatus=portTopNReportStatus, systemRmonGroup=systemRmonGroup, portGroup=portGroup, mcastRouterEntry=mcastRouterEntry, monitorGroup=monitorGroup, sysHighAvailabilityVersioningEnable=sysHighAvailabilityVersioningEnable, portCpbGroup3=portCpbGroup3, wsc1900sysID=wsc1900sysID, traceRouteDataTable=traceRouteDataTable, tftpGroup=tftpGroup, optionalChassisGroup1=optionalChassisGroup1, wsc1900csysID=wsc1900csysID, brouterEnableIpFragmentation=brouterEnableIpFragmentation, moduleTestResult=moduleTestResult, brouterEnableTransitEncapsulation=brouterEnableTransitEncapsulation, filterPortSuppressionViolation=filterPortSuppressionViolation, filterTestPort=filterTestPort, sysFddiRingAddress=sysFddiRingAddress, portCpbGrp=portCpbGrp, tftpGrp=tftpGrp, syslogMessageSeverity=syslogMessageSeverity, vmpsEntry=vmpsEntry, portTopNControlIndex=portTopNControlIndex, traceRouteMaxQueries=traceRouteMaxQueries, fileCopyRuntimeConfigPart=fileCopyRuntimeConfigPart, portLinkFaultStatus=portLinkFaultStatus, filterVendorPort=filterVendorPort, traceRouteDataErrors=traceRouteDataErrors, tokenRingPortPriorityThresh=tokenRingPortPriorityThresh, voicePortIfDnsDomain=voicePortIfDnsDomain, voicePortIfIpAddress=voicePortIfIpAddress, moduleIPAddress=moduleIPAddress, portEntPhysicalIndex=portEntPhysicalIndex, portChannelOperStatus=portChannelOperStatus, traceRouteQueryTime=traceRouteQueryTime, sysAttachType=sysAttachType, optionalPortGroup1=optionalPortGroup1, filterMacType=filterMacType, sysArpAgingTime=sysArpAgingTime, voicePortIfTftpServerAddress=voicePortIfTftpServerAddress, filterTestTable=filterTestTable, monitorSourcePort=monitorSourcePort, sysBaudRate=sysBaudRate, cpw1600sysID=cpw1600sysID, portDuplex=portDuplex, portCpbInlinePower=portCpbInlinePower, vlanPortOperStatus=vlanPortOperStatus, chassisPs1Status=chassisPs1Status, mdgGatewayAddr=mdgGatewayAddr, portTopNIOPkts=portTopNIOPkts, wsc6503sysID=wsc6503sysID, portAdminRxFlowControl=portAdminRxFlowControl, traceRouteDataGatewayIp=traceRouteDataGatewayIp, portCpbCopsGrouping=portCpbCopsGrouping, tokenRingDripAreReductionMode=tokenRingDripAreReductionMode, brouterPortEntry=brouterPortEntry, traceRouteQueryUDPPort=traceRouteQueryUDPPort, sysEnableIpPermitTraps=sysEnableIpPermitTraps, sysStatus=sysStatus, tacacsTimeout=tacacsTimeout, traceRouteQueryOwner=traceRouteQueryOwner, VendorIdType=VendorIdType, filterPortEntry=filterPortEntry, ntpAuthenticationType=ntpAuthenticationType, tokenRingPortSoftErrTable=tokenRingPortSoftErrTable, portErrDisableTimeOutEnable=portErrDisableTimeOutEnable, filterTestMask=filterTestMask, portCpbFlowControl=portCpbFlowControl, ipPermitEnable=ipPermitEnable, ipPermitDeniedAddress=ipPermitDeniedAddress, tokenRingPortCfgLossInterval=tokenRingPortCfgLossInterval, portCpbBroadcastSuppression=portCpbBroadcastSuppression, portTopNControlEntry=portTopNControlEntry, systemTrapGroup2=systemTrapGroup2, tokenRingPortSoftErrEnable=tokenRingPortSoftErrEnable, moduleGrp=moduleGrp, fileCopyRemoteServer=fileCopyRemoteServer, chassisGroup1=chassisGroup1, portCpbPortfast=portCpbPortfast, tacacsEnableAuthentication=tacacsEnableAuthentication, portChannelTable=portChannelTable, ipPermitGroup1=ipPermitGroup1, ipPermitGroup=ipPermitGroup, lerAlarmOn=lerAlarmOn, tacacsAuthKey=tacacsAuthKey, tokenRingGrp=tokenRingGrp, vmpsType=vmpsType, switchAccelerationModuleEntry=switchAccelerationModuleEntry, filterPortTable=filterPortTable, tokenRingPortSoftErrResetCounters=tokenRingPortSoftErrResetCounters, portAdminSpeed=portAdminSpeed, chassisPs3Type=chassisPs3Type, portJumboFramePortIndex=portJumboFramePortIndex, sysHighAvailabilityNotRunningReason=sysHighAvailabilityNotRunningReason, radiusGrp=radiusGrp, chassisNumSlots=chassisNumSlots, portTopNRequestedSize=portTopNRequestedSize, dcd=dcd, vlanPortSwitchLevel=vlanPortSwitchLevel, fileCopyGrp=fileCopyGrp, fileCopyGroup2=fileCopyGroup2, dnsServerEntry=dnsServerEntry, traceRouteQueryInitTTL=traceRouteQueryInitTTL, cpw1220isysID=cpw1220isysID, portSecurityAdminStatus=portSecurityAdminStatus, authenticationGroup2=authenticationGroup2, sysConfigChangeTime=sysConfigChangeTime, moduleEntPhysicalIndex=moduleEntPhysicalIndex, tokenRingPortIndex=tokenRingPortIndex, portMacControlUnknownProtocolFrames=portMacControlUnknownProtocolFrames, voicePortDnsPortIndex=voicePortDnsPortIndex, ipPermitListTable=ipPermitListTable, ciscoStackMIBConformance=ciscoStackMIBConformance, fileCopyProtocol=fileCopyProtocol, portTopNBufferOverFlow=portTopNBufferOverFlow, fileCopyDstFileName=fileCopyDstFileName, portCpbGroup5=portCpbGroup5, chassisAlarmOff=chassisAlarmOff, portChannelEntry=portChannelEntry, brouterGrp=brouterGrp, brouterCamAgingTime=brouterCamAgingTime, optionalChassisGroup=optionalChassisGroup, ipPermitAccessTypeEnable=ipPermitAccessTypeEnable, brouterPortBroadcast=brouterPortBroadcast, moduleFwVersion=moduleFwVersion, sysTrafficMeterPeak=sysTrafficMeterPeak, moduleSerialNumberString=moduleSerialNumberString, traceRouteDataEntry=traceRouteDataEntry, wsc2980gasysID=wsc2980gasysID, ciscoStackgMIBCompliance7=ciscoStackgMIBCompliance7, ntpClient=ntpClient, filterProtocolPort=filterProtocolPort, voicePortModuleIndex=voicePortModuleIndex, ntpTimezoneOffsetMinute=ntpTimezoneOffsetMinute, sysEnableVmpsTraps=sysEnableVmpsTraps, mdgGrp=mdgGrp, vlanPortTable=vlanPortTable, optionalSystemMiscGroup6=optionalSystemMiscGroup6, sysEnableModem=sysEnableModem, filterMacAddress=filterMacAddress, wsc5505sysID=wsc5505sysID, sysBootVariable=sysBootVariable, syslogServerEntry=syslogServerEntry, chassisPs2Status=chassisPs2Status, moduleTable=moduleTable, wsc2900sysID=wsc2900sysID, chassisPs1Type=chassisPs1Type, dnsEnable=dnsEnable, ipPermitMask=ipPermitMask, optionalSystemTrapGroup=optionalSystemTrapGroup, deprecatedObjectGroup=deprecatedObjectGroup, portCpbGroup2=portCpbGroup2, vlanPortIslPriorityVlans=vlanPortIslPriorityVlans, voicePortIfOperDnsDomain=voicePortIfOperDnsDomain, portJumboFrameEntry=portJumboFrameEntry, moduleSwVersion=moduleSwVersion, tacacsServerEntry=tacacsServerEntry, vlanGroup1=vlanGroup1, sysEnableChassisTraps=sysEnableChassisTraps, vlanTrunkMappingGroup=vlanTrunkMappingGroup, chassisComponentModel=chassisComponentModel, wsc5000sysID=wsc5000sysID, portSecurityExtPortIndex=portSecurityExtPortIndex, tokenRingDripRemotePortConfigured=tokenRingDripRemotePortConfigured, cisco7604sysID=cisco7604sysID, radiusServerEntry=radiusServerEntry, voicePortIfConfigModuleIndex=voicePortIfConfigModuleIndex, vlanGroup2=vlanGroup2, portTable=portTable, wsc1600sysID=wsc1600sysID, tokenRingDripDistCrfMode=tokenRingDripDistCrfMode, portOperStatus=portOperStatus, sysPortFastBpduGuard=sysPortFastBpduGuard, cisco7613sysID=cisco7613sysID, sysExtendedRmonVlanModeEnable=sysExtendedRmonVlanModeEnable, sysTrapReceiverType=sysTrapReceiverType, moduleHwLoVersion=moduleHwLoVersion, brouterPortTable=brouterPortTable, dnsGroup=dnsGroup, voiceGrp=voiceGrp, sysFddiRingTable=sysFddiRingTable, sysIpVlan=sysIpVlan, filterPortBroadcastThrottle=filterPortBroadcastThrottle, portJumboFrameModuleIndex=portJumboFrameModuleIndex, radiusDeadtime=radiusDeadtime, fileCopySrcFileName=fileCopySrcFileName, ntpServerPublicKey=ntpServerPublicKey, radiusLoginAuthentication=radiusLoginAuthentication, lerAlarmOff=lerAlarmOff, filterGroup=filterGroup, portSecurityExtModuleIndex=portSecurityExtModuleIndex, filterGroup3=filterGroup3, tokenRingDripAdvertsTransmitted=tokenRingDripAdvertsTransmitted, portTopNDuration=portTopNDuration, tacacsLocalLoginAuthentication=tacacsLocalLoginAuthentication, fileCopyUserName=fileCopyUserName, chassisAlarmOn=chassisAlarmOn, dnsServerAddr=dnsServerAddr, filterProtocolTable=filterProtocolTable, sysMaxRmonMemory=sysMaxRmonMemory, chassisTempAlarm=chassisTempAlarm, sysErrDisableTimeoutEnable=sysErrDisableTimeoutEnable, wsc3920sysID=wsc3920sysID, ipPermitGroup2=ipPermitGroup2, portCpbChannel=portCpbChannel, portTopNIOBroadcast=portTopNIOBroadcast, portSecurityExtEntry=portSecurityExtEntry, portJumboFrameGrp=portJumboFrameGrp, ciscoStackgMIBCompliance3=ciscoStackgMIBCompliance3, traceRouteDataHopCount=traceRouteDataHopCount)
