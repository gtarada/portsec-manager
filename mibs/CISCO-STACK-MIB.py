...
ifName, ifIndex, OwnerString = mibBuilder.importSymbols("IF-MIB", "ifName", "ifIndex", "OwnerString")
NotificationGroup, ModuleCompliance, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance", "ObjectGroup")
Counter32, ModuleIdentity, ObjectIdentity, TimeTicks, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, Bits, Unsigned32, Gauge32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "Bits", "Unsigned32", "Gauge32", "iso", "NotificationType")
...
mibBuilder.exportSymbols("CISCO-STACK-MIB", portCpbPortIndex=portCpbPortIndex, chassisMajorAlarm=chassisMajorAlarm, filterPortBroadcastDiscards=filterPortBroadcastDiscards, sysExtendedRmonEnable=sysExtendedRmonEnable, filterMacPort=filterMacPort, tokenRingPortSetACbits=tokenRingPortSetACbits, dnsGroup=dnsGroup, dnsServerAddr=dnsServerAddr, ipPermitType=ipPermitType, vlanPortIslOperStatus=vlanPortIslOperStatus, sysBootVariable=sysBootVariable, traceRouteQueryTable=traceRouteQueryTable, portCpbDuplex=portCpbDuplex, ipPermitEnable=ipPermitEnable, portIndex=portIndex, portInlinePowerDetect=portInlinePowerDetect, sysNetMask=sysNetMask, portAdminSpeed=portAdminSpeed, ipPermitMask=ipPermitMask, fileCopyGrp=fileCopyGrp, brouterCamAgingTime=brouterCamAgingTime, sysStartupConfigSourceFile=sysStartupConfigSourceFile, moduleName=moduleName, brouterCamMode=brouterCamMode, monitorDestinationPort=monitorDestinationPort, switchAccelerationModuleGroup=switchAccelerationModuleGroup, radiusDeadtime=radiusDeadtime, sysEnableModuleTraps=sysEnableModuleTraps, voiceGrp=voiceGrp, filterVendorEntry=filterVendorEntry, filterProtocolTable=filterProtocolTable, voicePortDnsPortIndex=voicePortDnsPortIndex, vlanTrunkMappingFromVlan=vlanTrunkMappingFromVlan, voicePortIfDHCPEnabled=voicePortIfDHCPEnabled, portTopNGrantedSize=portTopNGrantedSize, switchAccelerationGrp=switchAccelerationGrp, brouterPortIpHelpers=brouterPortIpHelpers, optionalChassisGroup1=optionalChassisGroup1, dnsDomainName=dnsDomainName, voicePortCallManagerIpAddr=voicePortCallManagerIpAddr, fileCopyModuleNumber=fileCopyModuleNumber, wsc6503sysID=wsc6503sysID, ipPermitDeniedListTable=ipPermitDeniedListTable, portSecurityAdminStatus=portSecurityAdminStatus, filterGroup1=filterGroup1, chassisComponentIndex=chassisComponentIndex, brouterEnableSpantree=brouterEnableSpantree, vmpsGroup=vmpsGroup, sysBroadcast=sysBroadcast, wsc5505sysID=wsc5505sysID, sysFddiRingAddress=sysFddiRingAddress, portJumboFrameGrp=portJumboFrameGrp, brouterIpx8023RawToFddi=brouterIpx8023RawToFddi, traceRouteGrp=traceRouteGrp, tokenRingDripLocalVlanStatusEntry=tokenRingDripLocalVlanStatusEntry, traceRouteQueryTOS=traceRouteQueryTOS, chassisPEMInstalled=chassisPEMInstalled, ipPermitAccessType=ipPermitAccessType, portTopNIOBroadcast=portTopNIOBroadcast, wsc6513sysID=wsc6513sysID, portGrp=portGrp, ntpAuthenticationEntry=ntpAuthenticationEntry, portErrDisableTimeOutEnable=portErrDisableTimeOutEnable, fileCopyRemoteServer=fileCopyRemoteServer, filterGroup2=filterGroup2, cisco7604sysID=cisco7604sysID, filterProtocolValue=filterProtocolValue, sysInsertMode=sysInsertMode, portSecurityExtControlStatus=portSecurityExtControlStatus, filterMacType=filterMacType, sysTrafficMeterEntry=sysTrafficMeterEntry, sysCommunityRo=sysCommunityRo, vlanPortTable=vlanPortTable, PYSNMP_MODULE_ID=ciscoStackMIB, tacacsLoginAuthentication=tacacsLoginAuthentication, brouterPortIpAddr=brouterPortIpAddr, sysTelnetPrimaryLoginAuthentication=sysTelnetPrimaryLoginAuthentication, portCpbGroup4=portCpbGroup4, sysEnableConfigTraps=sysEnableConfigTraps, configMode=configMode, mcastRouterAdminStatus=mcastRouterAdminStatus, portCpbAuxiliaryVlan=portCpbAuxiliaryVlan, wsc6009sysID=wsc6009sysID, voicePortDnsModuleIndex=voicePortDnsModuleIndex, syslogMessageControlTable=syslogMessageControlTable, vmpsTable=vmpsTable, tftpResult=tftpResult, sysTraffic=sysTraffic, syslogServerTable=syslogServerTable, portCpbCopsGrouping=portCpbCopsGrouping, tokenRingPortSoftErrTable=tokenRingPortSoftErrTable, chassisSerialNumber=chassisSerialNumber, vlanPortIslVlansAllowed=vlanPortIslVlansAllowed, filterPortBroadcastThresholdFraction=filterPortBroadcastThresholdFraction, voicePortIfDnsServerAddress=voicePortIfDnsServerAddress, sysCommunityEntry=sysCommunityEntry, vlanTrunkMappingMax=vlanTrunkMappingMax, chassisSysType=chassisSysType, ciscoStackgMIBCompliance5=ciscoStackgMIBCompliance5, cisco7609sysID=cisco7609sysID, voicePortIfConfigTable=voicePortIfConfigTable, sysExtendedRmonNetflowEnable=sysExtendedRmonNetflowEnable, ciscoStackNotificationsPrefix=ciscoStackNotificationsPrefix, voicePortIfDnsDomain=voicePortIfDnsDomain, filterTestPort=filterTestPort, tacacsEnableAuthentication=tacacsEnableAuthentication, systemRmonGroup=systemRmonGroup, sysFddiRingSMTIndex=sysFddiRingSMTIndex, portOperTxFlowControl=portOperTxFlowControl, securityGrp=securityGrp, tokenRingDripInputQueueDrops=tokenRingDripInputQueueDrops, portCpbUdld=portCpbUdld, mdgGatewayAddr=mdgGatewayAddr, syslogServerType=syslogServerType, systemFddiGroup=systemFddiGroup, ntpAuthenticationType=ntpAuthenticationType, portJumboFrameTable=portJumboFrameTable, traceRouteDataGatewayIp=traceRouteDataGatewayIp, chassisPs1TestResult=chassisPs1TestResult, moduleHwVersion=moduleHwVersion, sysFddiRingNext=sysFddiRingNext, portSecurityEntry=portSecurityEntry, portSpantreeFastStart=portSpantreeFastStart, portTopNUtilization=portTopNUtilization, portTopNStartTime=portTopNStartTime, traceRouteDataEntry=traceRouteDataEntry, traceRouteDataGatewayName=traceRouteDataGatewayName, ciscoStackMIBCompliances=ciscoStackMIBCompliances, portCpbGroup3=portCpbGroup3, syslogGrp=syslogGrp, sysConsolePrimaryLoginAuthentication=sysConsolePrimaryLoginAuthentication, wsc3000sysID=wsc3000sysID, tacacsServerTable=tacacsServerTable, traceRouteQueryTime=traceRouteQueryTime, ciscoStackgMIBCompliance7=ciscoStackgMIBCompliance7, filterPortTable=filterPortTable, portEntPhysicalIndex=portEntPhysicalIndex, voicePortOperDnsServerIndex=voicePortOperDnsServerIndex, moduleType=moduleType, filterMacModule=filterMacModule, cisco7606sysID=cisco7606sysID, sysMaxRmonMemory=sysMaxRmonMemory, moduleModel=moduleModel, vlanPortIslAdminStatus=vlanPortIslAdminStatus, chassisPs1Type=chassisPs1Type, portTopNIOPkts=portTopNIOPkts, wsc3100sysID=wsc3100sysID, chassisBkplType=chassisBkplType, ntpServerAddress=ntpServerAddress, chassisPs2Status=chassisPs2Status, portCpbTrunkEncapsulationType=portCpbTrunkEncapsulationType, moduleHwHiVersion=moduleHwHiVersion, cpw1220isysID=cpw1220isysID, sysEnableEntityTrap=sysEnableEntityTrap, sysStatus=sysStatus, tokenRingPortCfgLossInterval=tokenRingPortCfgLossInterval, portTable=portTable, optionalChassisGroup=optionalChassisGroup, wsc6506sysID=wsc6506sysID, moduleIndex=moduleIndex, moduleDown=moduleDown, wsc4503sysID=wsc4503sysID, wsc1600sysID=wsc1600sysID, filterTestValue=filterTestValue, systemTrapGroup2=systemTrapGroup2, multicastGrp=multicastGrp, voiceGroup=voiceGroup, traceRouteQueryWaitingTime=traceRouteQueryWaitingTime, radiusServerTable=radiusServerTable, traceRouteQueryMaxTTL=traceRouteQueryMaxTTL, voicePortIfIpAddress=voicePortIfIpAddress, portJumboFrameModuleIndex=portJumboFrameModuleIndex, vlanIfIndex=vlanIfIndex, portTopNTable=portTopNTable, vlanTrunkMappingStatus=vlanTrunkMappingStatus, portSecurityExtEntry=portSecurityExtEntry, wsc6509nebsysID=wsc6509nebsysID, wsc2980gsysID=wsc2980gsysID, traceRouteDataRtt=traceRouteDataRtt, portCpbSpan=portCpbSpan, wsc5002sysID=wsc5002sysID, monitorGroup=monitorGroup, filterPortEntry=filterPortEntry, tokenRingDripLocalNodeID=tokenRingDripLocalNodeID, portSecuritySecureSrcAddr=portSecuritySecureSrcAddr, ipPermitListTable=ipPermitListTable, brouterPortModule=brouterPortModule, fileCopySrcFileName=fileCopySrcFileName, ntpServerEntry=ntpServerEntry, tokenRingSoftErrorMonitorGroup=tokenRingSoftErrorMonitorGroup, syslogServerAddr=syslogServerAddr, portCpbInlinePower=portCpbInlinePower, fileCopyGroup=fileCopyGroup, vmpsEntry=vmpsEntry, sysExtendedRmonVlanModeEnable=sysExtendedRmonVlanModeEnable, wsc5000sysID=wsc5000sysID, tokenRingPortTable=tokenRingPortTable, mcastEnableRgmp=mcastEnableRgmp, cpw1601sysID=cpw1601sysID, ipPermitListGrp=ipPermitListGrp, voicePortIfConfigModuleIndex=voicePortIfConfigModuleIndex, chassisAlarmOff=chassisAlarmOff, portSecurityMaxSrcAddr=portSecurityMaxSrcAddr, vlanPortAuxiliaryVlan=vlanPortAuxiliaryVlan, portTopNIOOctets=portTopNIOOctets, mcastEnableCgmp=mcastEnableCgmp, mdgGatewayEntry=mdgGatewayEntry, brouterPortBridgeVlan=brouterPortBridgeVlan, sysTrafficMeter=sysTrafficMeter, systemMiscGroup1=systemMiscGroup1, chassisTempAlarm=chassisTempAlarm, tokenRingGrp=tokenRingGrp, vlanSpantreeEnable=vlanSpantreeEnable, sysConfigSupervisorModuleNo=sysConfigSupervisorModuleNo, tokenRingPortPriorityMinXmit=tokenRingPortPriorityMinXmit, moduleSerialNumber=moduleSerialNumber, moduleAction=moduleAction, moduleEntPhysicalIndex=moduleEntPhysicalIndex, vlanGroup1=vlanGroup1, tokenRingDripLastRevision=tokenRingDripLastRevision, wsc1100sysID=wsc1100sysID, filterGroup=filterGroup, portLinkFaultStatus=portLinkFaultStatus, wsc6504esysID=wsc6504esysID, moduleHwLoVersion=moduleHwLoVersion, wsc4506sysID=wsc4506sysID, sysMacReductionOperEnable=sysMacReductionOperEnable, chassisNumSlots=chassisNumSlots, tokenRingDripBackupCrf=tokenRingDripBackupCrf, fileCopyResult=fileCopyResult, dnsEnable=dnsEnable, traceRouteDataHopCount=traceRouteDataHopCount, filterTestIndex=filterTestIndex, portTopNOwner=portTopNOwner, ipPermitAddress=ipPermitAddress, tokenRingDripOwnerNodeID=tokenRingDripOwnerNodeID, filterPortSuppressionViolation=filterPortSuppressionViolation, sysStartupConfigSource=sysStartupConfigSource, portTopNControlEntry=portTopNControlEntry, chassisPs3Status=chassisPs3Status, radiusAuthKey=radiusAuthKey, portOperRxFlowControl=portOperRxFlowControl, portCpbEntry=portCpbEntry, voicePortIfConfigPortIndex=voicePortIfConfigPortIndex, portJumboFrameEnable=portJumboFrameEnable, ntpSummerTimezoneName=ntpSummerTimezoneName, ciscoStackgMIBCompliance2=ciscoStackgMIBCompliance2, moduleGroup2=moduleGroup2, sysTrapReceiverEntry=sysTrapReceiverEntry, voicePortIfConfigEntry=voicePortIfConfigEntry, ciscoStackgMIBCompliance6=ciscoStackgMIBCompliance6, portTopNInErrors=portTopNInErrors, portCpbChannel=portCpbChannel, mdgGatewayType=mdgGatewayType)
mibBuilder.exportSymbols("CISCO-STACK-MIB", portTopNRateBase=portTopNRateBase, portChannelModuleIndex=portChannelModuleIndex, systemStatusGroup=systemStatusGroup, sysTrafficMeterPeakTime=sysTrafficMeterPeakTime, portCpbBroadcastSuppression=portCpbBroadcastSuppression, sysTrafficMonitorHighWaterMark=sysTrafficMonitorHighWaterMark, sysHighAvailabilityVersioningEnable=sysHighAvailabilityVersioningEnable, moduleSwHiVersion=moduleSwHiVersion, ipPermitGroup1=ipPermitGroup1, ntpBcastClient=ntpBcastClient, moduleAdditionalStatus=moduleAdditionalStatus, wsc6509nebasysID=wsc6509nebasysID, sysMgmtType=sysMgmtType, mcastRouterTable=mcastRouterTable, ntpAuthenticationTable=ntpAuthenticationTable, sysCommunityRwa=sysCommunityRwa, traceRouteQueryIndex=traceRouteQueryIndex, brouterPortTable=brouterPortTable, chassisComponentTable=chassisComponentTable, wsc2926sysID=wsc2926sysID, tokenRingPortEarlyTokenRel=tokenRingPortEarlyTokenRel, modulePortStatus=modulePortStatus, voicePortOperDnsServerIpAddr=voicePortOperDnsServerIpAddr, portAdminTxFlowControl=portAdminTxFlowControl, wsc1900isysID=wsc1900isysID, portTopNMode=portTopNMode, wsc2948ggetxsysID=wsc2948ggetxsysID, filterMacAddress=filterMacAddress, voicePortIfOperDnsDomain=voicePortIfOperDnsDomain, portGroup=portGroup, portMacControlPauseReceiveFrames=portMacControlPauseReceiveFrames, vlanGrp=vlanGrp, brouterFddiReceiveMax=brouterFddiReceiveMax, filterGroup3=filterGroup3, mcastGroup=mcastGroup, VendorIdType=VendorIdType, chassisPs3Type=chassisPs3Type, chassisFanTestResult=chassisFanTestResult, brouterGrp=brouterGrp, tokenRingPortPriorityThresh=tokenRingPortPriorityThresh, ntpTimezoneOffsetMinute=ntpTimezoneOffsetMinute, portCpbCosRewrite=portCpbCosRewrite, syslogTimeStampOption=syslogTimeStampOption, optionalSystemMiscGroup4=optionalSystemMiscGroup4, portTopNControlTable=portTopNControlTable, vlanGroup2=vlanGroup2, vmpsAccessed=vmpsAccessed, tokenRingPortSoftErrThresh=tokenRingPortSoftErrThresh, tacacsTimeout=tacacsTimeout, wsc2820sysID=wsc2820sysID, sysBannerMotd=sysBannerMotd, ipPermitGroup=ipPermitGroup, sysFddiRingTable=sysFddiRingTable, syslogHostEnable=syslogHostEnable, wsc4006sysID=wsc4006sysID, filterPortComplex=filterPortComplex, optionalSystemTrapGroup=optionalSystemTrapGroup, ciscoStackgMIBCompliance3=ciscoStackgMIBCompliance3, switchAccelerationModuleEnable=switchAccelerationModuleEnable, filterPortBroadcastThreshold=filterPortBroadcastThreshold, configurationGroup=configurationGroup, wsc2980gasysID=wsc2980gasysID, tftpAction=tftpAction, filterVendorTable=filterVendorTable, portCpbGroup5=portCpbGroup5, monitorOperSourcePorts=monitorOperSourcePorts, voicePortOperDnsServerTable=voicePortOperDnsServerTable, portMacControlTransmitFrames=portMacControlTransmitFrames, cpw1420sysID=cpw1420sysID, wsc4912gsysID=wsc4912gsysID, optionalModuleGroup=optionalModuleGroup, sysExtendedRmonNetflowPassword=sysExtendedRmonNetflowPassword, wsc6509sysID=wsc6509sysID, tacacsServerEntry=tacacsServerEntry, wsc4003sysID=wsc4003sysID, filterPortSuppressionOption=filterPortSuppressionOption, ipPermitDeniedAccess=ipPermitDeniedAccess, portAdditionalStatus=portAdditionalStatus, moduleTable=moduleTable, chassisSlotConfig=chassisSlotConfig, portSecurityOperStatus=portSecurityOperStatus, tokenRingDripLastChangedRevision=tokenRingDripLastChangedRevision, moduleSlotNum=moduleSlotNum, sysIpVlan=sysIpVlan, brouterEthernetReceiveMax=brouterEthernetReceiveMax, moduleTestResult=moduleTestResult, systemMiscGroup=systemMiscGroup, portChannelProtInPackets=portChannelProtInPackets, ntpGrp=ntpGrp, moduleFwVersion=moduleFwVersion, vlanPortSwitchLevel=vlanPortSwitchLevel, portCpbVlanMembership=portCpbVlanMembership, portTopNPortNumber=portTopNPortNumber, portName=portName, switchAccelerationModuleEntry=switchAccelerationModuleEntry, systemRmonGroup2=systemRmonGroup2, traceRouteQueryResult=traceRouteQueryResult, tftpHost=tftpHost, portJumboFrameEntry=portJumboFrameEntry, sysTrapReceiverAddr=sysTrapReceiverAddr, vlanPortIslPriorityVlans=vlanPortIslPriorityVlans, sysEnableIpPermitTraps=sysEnableIpPermitTraps, chassisSerialNumberString=chassisSerialNumberString, mdgGatewayTable=mdgGatewayTable, wsc1900LiteFxsysID=wsc1900LiteFxsysID, moduleEntry=moduleEntry, radiusEnableAuthentication=radiusEnableAuthentication, syslogConsoleEnable=syslogConsoleEnable, portTopNReportStatus=portTopNReportStatus, systemTrafficGroup=systemTrafficGroup, mcastRouterPortIndex=mcastRouterPortIndex, fileCopyGroup2=fileCopyGroup2, portCrossIndex=portCrossIndex, syslogGroup=syslogGroup, portChannelNeighbourDeviceId=portChannelNeighbourDeviceId, portSecurityLastSrcAddr=portSecurityLastSrcAddr, wsc2948gsysID=wsc2948gsysID, radiusTimeout=radiusTimeout, vmpsAddr=vmpsAddr, ipPermitDeniedListEntry=ipPermitDeniedListEntry, chassisMinorAlarm=chassisMinorAlarm, portCpbGroup1=portCpbGroup1, portSecurityPortIndex=portSecurityPortIndex, cpw2200sysID=cpw2200sysID, sysEnableRedirects=sysEnableRedirects, mcastRouterEntry=mcastRouterEntry, monitorEnable=monitorEnable, portDuplex=portDuplex, tftpModule=tftpModule, brouterEnableUnreachables=brouterEnableUnreachables, syslogServerEntry=syslogServerEntry, sysCommunityString=sysCommunityString, chassisComponentModel=chassisComponentModel, chassisPs2TestResult=chassisPs2TestResult, voicePortCallManagerEntry=voicePortCallManagerEntry, moduleSwVersion=moduleSwVersion, portType=portType, switchAccelerationModuleTable=switchAccelerationModuleTable, vlanTrunkMappingType=vlanTrunkMappingType, ntpTimezoneOffsetHour=ntpTimezoneOffsetHour, moduleFwLoVersion=moduleFwLoVersion, portChannelEntry=portChannelEntry, portTopNIndex=portTopNIndex, filterPortBroadcastThrottle=filterPortBroadcastThrottle, ipPermitAccessTypeEnable=ipPermitAccessTypeEnable, tokenRingPortSoftErrResetCounters=tokenRingPortSoftErrResetCounters, switchAccelerationModuleIndex=switchAccelerationModuleIndex, cpw1900sysID=cpw1900sysID, portCpbModuleIndex=portCpbModuleIndex, wsc6006sysID=wsc6006sysID, portCpbSecurity=portCpbSecurity, sysExtendedRmonVlanAgentEnable=sysExtendedRmonVlanAgentEnable, chassisPs1Status=chassisPs1Status, fileCopyDstFileName=fileCopyDstFileName, sysPortFastBpduGuard=sysPortFastBpduGuard, monitorDestinationModule=monitorDestinationModule, optionalPortGroup=optionalPortGroup, voicePortIfIpNetMask=voicePortIfIpNetMask, vlanEntry=vlanEntry, brouterEnableRip=brouterEnableRip, vlanPortAdminStatus=vlanPortAdminStatus, tokenRingPortCfgLossThresh=tokenRingPortCfgLossThresh, brouterPortEntry=brouterPortEntry, optionalSystemMiscGroup=optionalSystemMiscGroup, moduleGrp=moduleGrp, wsc2900sysID=wsc2900sysID, dnsServerEntry=dnsServerEntry, moduleGroup=moduleGroup, portTopNControlIndex=portTopNControlIndex, moduleUp=moduleUp, sysEnableRepeaterTraps=sysEnableRepeaterTraps, ntpServerTable=ntpServerTable, traceRouteQueryInitTTL=traceRouteQueryInitTTL, wsc1200sysID=wsc1200sysID, sysBootedImage=sysBootedImage, brouterEnableAPaRT=brouterEnableAPaRT, sysClearMacTime=sysClearMacTime, tacacsLocalLoginAuthentication=tacacsLocalLoginAuthentication, voicePortIndex=voicePortIndex, ntpAuthenticationGroup=ntpAuthenticationGroup, chassisFanStatus=chassisFanStatus, tokenRingDripLocalPortStatus=tokenRingDripLocalPortStatus, wsc1400sysID=wsc1400sysID, systemTrapGroup=systemTrapGroup, portCpbGroup2=portCpbGroup2, brouterEnableIpFragmentation=brouterEnableIpFragmentation, traceRouteQueryDNSEnable=traceRouteQueryDNSEnable, chassisComponentSerialNumber=chassisComponentSerialNumber, chassisComponentHwVersion=chassisComponentHwVersion, sysHighAvailabilityNotRunningReason=sysHighAvailabilityNotRunningReason, systemTrapGroup1=systemTrapGroup1, vlanTrunkMappingOper=vlanTrunkMappingOper, ntpAuthenticationTrustedMode=ntpAuthenticationTrustedMode, ntpAuthenticationPublicKey=ntpAuthenticationPublicKey, sysHighAvailabilityOperStatus=sysHighAvailabilityOperStatus, configTextFileLocation=configTextFileLocation, brouterPortBroadcast=brouterPortBroadcast, ntpTimezoneName=ntpTimezoneName, mcastEnableIgmp=mcastEnableIgmp, sysEnableChassisTraps=sysEnableChassisTraps, sysEnableModem=sysEnableModem, portChannelAdminStatus=portChannelAdminStatus, optionalSystemMiscGroup2=optionalSystemMiscGroup2, voicePortOperDnsServerSource=voicePortOperDnsServerSource, ciscoStackMIB=ciscoStackMIB, wsc1900sysID=wsc1900sysID, filterTestOffset=filterTestOffset, tokenRingModuleIndex=tokenRingModuleIndex, ciscoStackMIBConformance=ciscoStackMIBConformance, radiusGrp=radiusGrp, chassisComponentEntry=chassisComponentEntry, tacacsServerAddr=tacacsServerAddr, traceRouteQueryPacketCount=traceRouteQueryPacketCount, portGroup2=portGroup2, filterProtocolPort=filterProtocolPort, mdgGrp=mdgGrp, wsc1900csysID=wsc1900csysID, syslogGroup2=syslogGroup2, sysTrapReceiverType=sysTrapReceiverType, filterProtocolType=filterProtocolType, chassisPs3TestResult=chassisPs3TestResult, voicePortCallManagerIndex=voicePortCallManagerIndex, fileCopyRuntimeConfigPart=fileCopyRuntimeConfigPart, vlanGroup=vlanGroup, sshPublicKeySize=sshPublicKeySize, configWriteMemStatus=configWriteMemStatus, tokenRingPortMode=tokenRingPortMode, sysConfigRegister=sysConfigRegister, brouterIpx8022ToEther=brouterIpx8022ToEther, tokenRingDripLocalVlanStatusTable=tokenRingDripLocalVlanStatusTable, ntpServerType=ntpServerType, portChannelTable=portChannelTable, filterMacEntry=filterMacEntry, sysTrafficMeterTable=sysTrafficMeterTable, sysClearPortTime=sysClearPortTime, tacacsDirectedRequest=tacacsDirectedRequest, traceRouteDataErrors=traceRouteDataErrors, moduleSubType2=moduleSubType2, traceRouteQueryUDPPort=traceRouteQueryUDPPort, brouterEnableGiantCheck=brouterEnableGiantCheck, monitorSourcePort=monitorSourcePort, traceRouteGroup=traceRouteGroup, moduleStatus=moduleStatus, authenticationGroup1=authenticationGroup1, sysExtendedRmonNetflowModuleMask=sysExtendedRmonNetflowModuleMask, vlanPortOperStatus=vlanPortOperStatus, portChannelOperStatus=portChannelOperStatus, filterTestEntry=filterTestEntry, traceRouteQueryStatus=traceRouteQueryStatus, filterVendorModule=filterVendorModule, sysTrapReceiverTable=sysTrapReceiverTable, portMacControlReceiveFrames=portMacControlReceiveFrames, brouterPortNetMask=brouterPortNetMask, cpw1220sysID=cpw1220sysID)
mibBuilder.exportSymbols("CISCO-STACK-MIB", portChannelNeighbourPortId=portChannelNeighbourPortId, radiusServerAuthPort=radiusServerAuthPort, ntpAuthenticationSecretKey=ntpAuthenticationSecretKey, vlanPort=vlanPort, filterGrp=filterGrp, filterProtocolModule=filterProtocolModule, vlanPortModule=vlanPortModule, tokenRingDripAdvertsTransmitted=tokenRingDripAdvertsTransmitted, portSecurityModuleIndex=portSecurityModuleIndex, syslogTelnetEnable=syslogTelnetEnable, lerAlarmOn=lerAlarmOn, ciscoStackgMIBCompliance=ciscoStackgMIBCompliance, filterTestMask=filterTestMask, traceRouteDataIndex=traceRouteDataIndex, cisco7603sysID=cisco7603sysID, cisco7613sysID=cisco7613sysID, brouterIpxSnapToEther=brouterIpxSnapToEther, chassisAlarmOn=chassisAlarmOn, chassisGroup1=chassisGroup1, portGroup4=portGroup4, sysEnableStpxTrap=sysEnableStpxTrap, brouteEnableGroup=brouteEnableGroup, mdgGatewayGroup=mdgGatewayGroup, portOperStatus=portOperStatus, tokenRingDripAdvertsReceived=tokenRingDripAdvertsReceived, moduleStandbyStatus=moduleStandbyStatus, tftpFile=tftpFile, radiusLoginAuthentication=radiusLoginAuthentication, portSecurityExtSecureSrcAddr=portSecurityExtSecureSrcAddr, ntpClient=ntpClient, wsc3900sysID=wsc3900sysID, filterPortModule=filterPortModule, sysReset=sysReset, tokenRingDripDistCrfMode=tokenRingDripDistCrfMode, portSecurityExtModuleIndex=portSecurityExtModuleIndex, ntpSummertimeStatus=ntpSummertimeStatus, fileCopyResultRcpErrorMessage=fileCopyResultRcpErrorMessage, sysFddiRingEntry=sysFddiRingEntry, tokenRingPortSoftErrEntry=tokenRingPortSoftErrEntry, sysErrDisableTimeoutInterval=sysErrDisableTimeoutInterval, tftpGrp=tftpGrp, tacacsGrp=tacacsGrp, wsc5509sysID=wsc5509sysID, tokenRingDripRemotePortStatus=tokenRingDripRemotePortStatus, ciscoStackMIBGroups=ciscoStackMIBGroups, monitorDirection=monitorDirection, sysTrapReceiverComm=sysTrapReceiverComm, portSecurityTable=portSecurityTable, vlanTable=vlanTable, tacacsNumLoginAttempts=tacacsNumLoginAttempts, fileCopyProtocol=fileCopyProtocol, moduleGroup1=moduleGroup1, sysAttachType=sysAttachType, sysEnableBridgeTraps=sysEnableBridgeTraps, portEntry=portEntry, moduleSubType=moduleSubType, tokenRingDripAreReductionMode=tokenRingDripAreReductionMode, tacacsAuthKey=tacacsAuthKey, chassisGrp=chassisGrp, portCpbGrp=portCpbGrp, sysHighAvailabilityEnable=sysHighAvailabilityEnable, monitorAdminSourcePorts=monitorAdminSourcePorts, optionalSystemTrapGroup1=optionalSystemTrapGroup1, sysEnableRmon=sysEnableRmon, optionalSystemMiscGroup3=optionalSystemMiscGroup3, portCpbTosRewrite=portCpbTosRewrite, lerAlarmOff=lerAlarmOff, voicePortIfGatewayAddress=voicePortIfGatewayAddress, tokenRingPortIndex=tokenRingPortIndex, optionalPortGroup1=optionalPortGroup1, ciscoStackgMIBCompliance4=ciscoStackgMIBCompliance4, portChannelPortIndex=portChannelPortIndex, tokenRingDripDistributedCrf=tokenRingDripDistributedCrf, tokenRingPortSoftErrLastCounterReset=tokenRingPortSoftErrLastCounterReset, portSecurityGroup1=portSecurityGroup1, radiusRetransmits=radiusRetransmits, tokenRingPortSoftErrReportInterval=tokenRingPortSoftErrReportInterval, vmpsType=vmpsType, portSecurityShutdownTimeOut=portSecurityShutdownTimeOut, dnsServerType=dnsServerType, sysEnableVmpsTraps=sysEnableVmpsTraps, sysConsolePrimaryEnableAuthentication=sysConsolePrimaryEnableAuthentication, sysConfigChangeTrap=sysConfigChangeTrap, portChannelProtOutPackets=portChannelProtOutPackets, wsc3200sysID=wsc3200sysID, moduleNumPorts=moduleNumPorts, authenticationGroup=authenticationGroup, ntpBcastDelay=ntpBcastDelay, portTopNIOMulticast=portTopNIOMulticast, moduleSerialNumberString=moduleSerialNumberString, mcastRouterModuleIndex=mcastRouterModuleIndex, chassisModel=chassisModel, vlanPortEntry=vlanPortEntry, portSecurityViolationPolicy=portSecurityViolationPolicy, portTopNType=portTopNType, voicePortOperDnsServerEntry=voicePortOperDnsServerEntry, vlanIndex=vlanIndex, portCrossGroupIndex=portCrossGroupIndex, portChannelGrp=portChannelGrp, voicePortCallManagerTable=voicePortCallManagerTable, traceRouteQueryPacketSize=traceRouteQueryPacketSize, sysArpAgingTime=sysArpAgingTime, filterPort=filterPort, portAdminRxFlowControl=portAdminRxFlowControl, tokenRingDripVlan=tokenRingDripVlan, portTopNTimeRemaining=portTopNTimeRemaining, sysTrafficPeakTime=sysTrafficPeakTime, portSecurityExtTable=portSecurityExtTable, cpw1600sysID=cpw1600sysID, portChannelIfIndex=portChannelIfIndex, portSecurityExtPortIndex=portSecurityExtPortIndex, sysMacReductionAdminEnable=sysMacReductionAdminEnable, voicePortModuleIndex=voicePortModuleIndex, brouterEnableTransitEncapsulation=brouterEnableTransitEncapsulation, cpw1220csysID=cpw1220csysID, tacacsLocalEnableAuthentication=tacacsLocalEnableAuthentication, brouterFddiTransmitMax=brouterFddiTransmitMax, ipPermitDeniedTime=ipPermitDeniedTime, cpw1800sysID=cpw1800sysID, filterVendorPort=filterVendorPort, filterTestModule=filterTestModule, vlanTrunkMappingTable=vlanTrunkMappingTable, portCpbIgmpFilter=portCpbIgmpFilter, notificationGroup=notificationGroup, vlanPortVlan=vlanPortVlan, tacacsServerType=tacacsServerType, portMacControlUnknownProtocolFrames=portMacControlUnknownProtocolFrames, radiusServerEntry=radiusServerEntry, portTopNRequestedSize=portTopNRequestedSize, chassisPs2Type=chassisPs2Type, portSecurityAgingTime=portSecurityAgingTime, portCpbFlowControl=portCpbFlowControl, moduleIPAddressVlan=moduleIPAddressVlan, sysTrafficMeterPeak=sysTrafficMeterPeak, tokenRingDripRemotePortConfigured=tokenRingDripRemotePortConfigured, filterTestType=filterTestType, traceRouteMaxQueries=traceRouteMaxQueries, traceRouteQueryOwner=traceRouteQueryOwner, ipPermitDeniedTrap=ipPermitDeniedTrap, ntpGroup=ntpGroup, wsc5500sysID=wsc5500sysID, monitorSourceModule=monitorSourceModule, radiusServerAddr=radiusServerAddr, tokenRingPortEntry=tokenRingPortEntry, chassisComponentType=chassisComponentType, tsStack=tsStack, wsc3920sysID=wsc3920sysID, portMacControlPauseTransmitFrames=portMacControlPauseTransmitFrames, voicePortIfTftpServerAddress=voicePortIfTftpServerAddress, portTopNDuration=portTopNDuration, fileCopyUserName=fileCopyUserName, moduleSwLoVersion=moduleSwLoVersion, dnsGrp=dnsGrp, portAdditionalOperStatus=portAdditionalOperStatus, filterMacTable=filterMacTable, tokenRingDripAdvertsProcessed=tokenRingDripAdvertsProcessed, dnsServerTable=dnsServerTable, tftpGroup=tftpGroup, radiusServerType=radiusServerType, sysCommunityTable=sysCommunityTable, optionalSystemMiscGroup1=optionalSystemMiscGroup1, portJumboFramePortIndex=portJumboFramePortIndex, syslogMessageSeverity=syslogMessageSeverity, tokenRingSoftErrExceededTrap=tokenRingSoftErrExceededTrap, tokenRingDripOutputQueueDrops=tokenRingDripOutputQueueDrops, portCpbTable=portCpbTable, tokenRingPortSoftErrEnable=tokenRingPortSoftErrEnable, sysTelnetPrimaryEnableAuthentication=sysTelnetPrimaryEnableAuthentication, vmpsAction=vmpsAction, traceRouteHost=traceRouteHost, traceRouteQueryEntry=traceRouteQueryEntry, tokenRingGroup=tokenRingGroup, portIfIndex=portIfIndex, sysBaudRate=sysBaudRate, ipPermitListEntry=ipPermitListEntry, monitorGrp=monitorGrp, moduleIPAddress=moduleIPAddress, mcastGroup1=mcastGroup1, wsc3001sysID=wsc3001sysID, filterTestTable=filterTestTable, vlanTrunkMappingEntry=vlanTrunkMappingEntry, authenticationGroup2=authenticationGroup2, ipPermitDeniedAddress=ipPermitDeniedAddress, sysCommunityRw=sysCommunityRw, filterVendorType=filterVendorType, wsc6knamsysID=wsc6knamsysID, sysIpAddr=sysIpAddr, optionalSystemMiscGroup5=optionalSystemMiscGroup5, sysConfigChangeInfo=sysConfigChangeInfo, configWriteMem=configWriteMem, syslogMessageFacility=syslogMessageFacility, vlanTrunkMappingToVlan=vlanTrunkMappingToVlan, portChannelPorts=portChannelPorts, portCpbDot1x=portCpbDot1x, configGrp=configGrp, fileCopyAction=fileCopyAction, sysCommunityAccess=sysCommunityAccess, systemGrp=systemGrp, brouterPortIpVlan=brouterPortIpVlan, portTopNGrp=portTopNGrp, dcd=dcd, portTopNModuleNumber=portTopNModuleNumber, ipPermitGroup2=ipPermitGroup2, sysTrafficMeterType=sysTrafficMeterType, sysTrafficPeak=sysTrafficPeak, optionalSystemMiscGroup6=optionalSystemMiscGroup6, chassisGroup=chassisGroup, deprecatedObjectGroup=deprecatedObjectGroup, brouterEthernetTransmitMax=brouterEthernetTransmitMax, syslogMessageControlEntry=syslogMessageControlEntry, portTopNEntry=portTopNEntry, portTopNStatus=portTopNStatus, portGroup3=portGroup3, wsc1000sysID=wsc1000sysID, brouterPort=brouterPort, traceRouteDataTable=traceRouteDataTable, adapterCard=adapterCard, sysConfigChangeTime=sysConfigChangeTime, portCpbPortfast=portCpbPortfast, vlanTrunkMappingGroup=vlanTrunkMappingGroup, filterProtocolEntry=filterProtocolEntry, mcastRouterOperStatus=mcastRouterOperStatus, brouterEnableFddiCheck=brouterEnableFddiCheck, portJumboFrameGroup=portJumboFrameGroup, portCpbTrunkMode=portCpbTrunkMode, ntpAuthenticationEnable=ntpAuthenticationEnable, esStack=esStack, portTopNBufferOverFlow=portTopNBufferOverFlow, sysErrDisableTimeoutEnable=sysErrDisableTimeoutEnable, sysStandbyPortEnable=sysStandbyPortEnable, portCpbSpeed=portCpbSpeed, ntpServerPublicKey=ntpServerPublicKey, portGroup1=portGroup1, moduleFwHiVersion=moduleFwHiVersion, filterVendorId=filterVendorId, portModuleIndex=portModuleIndex)
