...
# ASN.1 source http://raw.githubusercontent.com:80/simonjj/SnmpMibs/master/RMON-MIB.mib
...
Counter64, ModuleIdentity, ObjectIdentity, Gauge32, NotificationType, Integer32, TimeTicks, iso, Unsigned32, IpAddress, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "ObjectIdentity", "Gauge32", "NotificationType", "Integer32", "TimeTicks", "iso", "Unsigned32", "IpAddress", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "Counter32")
...
mibBuilder.exportSymbols("RMON-MIB", hostTimeCreationOrder=hostTimeCreationOrder, rmonMibModule=rmonMibModule, matrixControlStatus=matrixControlStatus, bufferControlStatus=bufferControlStatus, etherStatsCRCAlignErrors=etherStatsCRCAlignErrors, etherStatsPkts64Octets=etherStatsPkts64Octets, channelDescription=channelDescription, historyControlEntry=historyControlEntry, hostControlDataSource=hostControlDataSource, captureBufferPacketTime=captureBufferPacketTime, hosts=hosts, rmonConformance=rmonConformance, etherStatsDataSource=etherStatsDataSource, matrixDSDestAddress=matrixDSDestAddress, etherHistoryIntervalStart=etherHistoryIntervalStart, etherHistoryOctets=etherHistoryOctets, eventTable=eventTable, fallingAlarm=fallingAlarm, rmonCompliances=rmonCompliances, risingAlarm=risingAlarm, filterTable=filterTable, filterIndex=filterIndex, hostOutMulticastPkts=hostOutMulticastPkts, alarmFallingEventIndex=alarmFallingEventIndex, matrixSDSourceAddress=matrixSDSourceAddress, captureBufferIndex=captureBufferIndex, etherStatsIndex=etherStatsIndex, filterPktDataNotMask=filterPktDataNotMask, hostTimeOutOctets=hostTimeOutOctets, etherStatsStatus=etherStatsStatus, hostTopN=hostTopN, hostTopNTimeRemaining=hostTopNTimeRemaining, channelOwner=channelOwner, rmonEthernetHistoryGroup=rmonEthernetHistoryGroup, logIndex=logIndex, filterOwner=filterOwner, hostControlOwner=hostControlOwner, rmonHostTopNGroup=rmonHostTopNGroup, filterEntry=filterEntry, alarmVariable=alarmVariable, etherStatsPkts256to511Octets=etherStatsPkts256to511Octets, hostTopNOwner=hostTopNOwner, filterPktDataMask=filterPktDataMask, etherStatsPkts=etherStatsPkts, historyControlDataSource=historyControlDataSource, etherHistoryTable=etherHistoryTable, filterPktStatusNotMask=filterPktStatusNotMask, bufferControlFullAction=bufferControlFullAction, logDescription=logDescription, captureBufferPacketLength=captureBufferPacketLength, hostTopNStartTime=hostTopNStartTime, hostControlTable=hostControlTable, captureBufferTable=captureBufferTable, matrixControlEntry=matrixControlEntry, eventType=eventType, rmon=rmon, alarmIndex=alarmIndex, etherStatsDropEvents=etherStatsDropEvents, matrixDSSourceAddress=matrixDSSourceAddress, bufferControlMaxOctetsRequested=bufferControlMaxOctetsRequested, alarmRisingEventIndex=alarmRisingEventIndex, etherHistorySampleIndex=etherHistorySampleIndex, etherStatsEntry=etherStatsEntry, channelEventIndex=channelEventIndex, eventStatus=eventStatus, matrixControlTableSize=matrixControlTableSize, logTable=logTable, rmonEventsV2=rmonEventsV2, historyControlInterval=historyControlInterval, logTime=logTime, etherStatsPkts1024to1518Octets=etherStatsPkts1024to1518Octets, channelTable=channelTable, etherStatsMulticastPkts=etherStatsMulticastPkts, hostTimeInOctets=hostTimeInOctets, eventIndex=eventIndex, bufferControlIndex=bufferControlIndex, rmonFilterGroup=rmonFilterGroup, filterPktStatusMask=filterPktStatusMask, channelStatus=channelStatus, etherStatsPkts128to255Octets=etherStatsPkts128to255Octets, matrixSDTable=matrixSDTable, bufferControlDownloadSliceSize=bufferControlDownloadSliceSize, alarmInterval=alarmInterval, rmonCompliance=rmonCompliance, etherHistoryBroadcastPkts=etherHistoryBroadcastPkts, channelIfIndex=channelIfIndex, hostAddress=hostAddress, history=history, bufferControlEntry=bufferControlEntry, captureBufferPacketID=captureBufferPacketID, hostTimeOutPkts=hostTimeOutPkts, bufferControlCaptureSliceSize=bufferControlCaptureSliceSize, logEventIndex=logEventIndex, hostControlIndex=hostControlIndex, etherHistoryCRCAlignErrors=etherHistoryCRCAlignErrors, hostTopNGrantedSize=hostTopNGrantedSize, alarmRisingThreshold=alarmRisingThreshold, hostTopNAddress=hostTopNAddress, hostTopNStatus=hostTopNStatus, eventLastTimeSent=eventLastTimeSent, etherHistoryEntry=etherHistoryEntry, rmonAlarmGroup=rmonAlarmGroup, rmonHostGroup=rmonHostGroup, historyControlIndex=historyControlIndex, etherHistoryMulticastPkts=etherHistoryMulticastPkts, statistics=statistics, matrixDSPkts=matrixDSPkts, historyControlBucketsGranted=historyControlBucketsGranted, etherStatsOversizePkts=etherStatsOversizePkts, matrixControlLastDeleteTime=matrixControlLastDeleteTime, matrixDSOctets=matrixDSOctets, channelEventStatus=channelEventStatus, matrixDSTable=matrixDSTable, OwnerString=OwnerString, channelTurnOffEventIndex=channelTurnOffEventIndex, etherHistoryUndersizePkts=etherHistoryUndersizePkts, etherStatsBroadcastPkts=etherStatsBroadcastPkts, filterStatus=filterStatus, hostTopNRequestedSize=hostTopNRequestedSize, hostTimeTable=hostTimeTable, hostTopNIndex=hostTopNIndex, matrixSDEntry=matrixSDEntry, matrixControlDataSource=matrixControlDataSource, matrix=matrix, bufferControlDownloadOffset=bufferControlDownloadOffset, filterChannelIndex=filterChannelIndex, etherStatsCollisions=etherStatsCollisions, rmonHistoryControlGroup=rmonHistoryControlGroup, captureBufferPacketStatus=captureBufferPacketStatus, alarmOwner=alarmOwner, historyControlStatus=historyControlStatus, etherHistoryOversizePkts=etherHistoryOversizePkts, matrixControlOwner=matrixControlOwner, hostOutPkts=hostOutPkts, hostTopNControlIndex=hostTopNControlIndex, eventCommunity=eventCommunity, channelDataControl=channelDataControl, hostOutBroadcastPkts=hostOutBroadcastPkts, filterPktData=filterPktData, matrixDSErrors=matrixDSErrors, etherStatsUndersizePkts=etherStatsUndersizePkts, hostOutOctets=hostOutOctets, alarm=alarm, etherHistoryUtilization=etherHistoryUtilization, hostEntry=hostEntry, hostTopNDuration=hostTopNDuration, matrixSDErrors=matrixSDErrors, captureBufferPacketData=captureBufferPacketData, EntryStatus=EntryStatus, etherStatsPkts65to127Octets=etherStatsPkts65to127Octets, hostTimeInPkts=hostTimeInPkts, hostCreationOrder=hostCreationOrder, rmonEtherStatsGroup=rmonEtherStatsGroup, capture=capture, etherHistoryIndex=etherHistoryIndex, hostTopNTable=hostTopNTable, channelIndex=channelIndex, bufferControlChannelIndex=bufferControlChannelIndex, hostTimeOutMulticastPkts=hostTimeOutMulticastPkts, etherStatsOctets=etherStatsOctets, hostControlEntry=hostControlEntry, hostTopNRateBase=hostTopNRateBase, hostTopNControlTable=hostTopNControlTable, bufferControlOwner=bufferControlOwner, rmonPacketCaptureGroup=rmonPacketCaptureGroup, etherHistoryCollisions=etherHistoryCollisions, filterPktDataOffset=filterPktDataOffset, event=event, channelEntry=channelEntry, filterPktStatus=filterPktStatus, etherStatsJabbers=etherStatsJabbers, captureBufferEntry=captureBufferEntry, PYSNMP_MODULE_ID=rmonMibModule, hostTopNRate=hostTopNRate, captureBufferControlIndex=captureBufferControlIndex, historyControlTable=historyControlTable, etherHistoryJabbers=etherHistoryJabbers, channelMatches=channelMatches, bufferControlTable=bufferControlTable, alarmFallingThreshold=alarmFallingThreshold, bufferControlTurnOnTime=bufferControlTurnOnTime, etherStatsFragments=etherStatsFragments, etherHistoryPkts=etherHistoryPkts, hostControlTableSize=hostControlTableSize, matrixControlTable=matrixControlTable, logEntry=logEntry, hostTimeAddress=hostTimeAddress, hostTable=hostTable, alarmStatus=alarmStatus, matrixSDOctets=matrixSDOctets, eventDescription=eventDescription, eventOwner=eventOwner, historyControlBucketsRequested=historyControlBucketsRequested, hostTopNControlEntry=hostTopNControlEntry, hostControlStatus=hostControlStatus, hostTimeOutErrors=hostTimeOutErrors, matrixSDDestAddress=matrixSDDestAddress, etherHistoryFragments=etherHistoryFragments, hostIndex=hostIndex, hostTimeIndex=hostTimeIndex, matrixDSIndex=matrixDSIndex, hostInPkts=hostInPkts, hostTimeEntry=hostTimeEntry, alarmValue=alarmValue, historyControlOwner=historyControlOwner, hostControlLastDeleteTime=hostControlLastDeleteTime, hostTopNEntry=hostTopNEntry, alarmEntry=alarmEntry, eventEntry=eventEntry, hostInOctets=hostInOctets, etherStatsTable=etherStatsTable, matrixControlIndex=matrixControlIndex, filter=filter, channelTurnOnEventIndex=channelTurnOnEventIndex, etherHistoryDropEvents=etherHistoryDropEvents, alarmTable=alarmTable, hostTopNReport=hostTopNReport, bufferControlFullStatus=bufferControlFullStatus, hostTopNHostIndex=hostTopNHostIndex, hostTimeOutBroadcastPkts=hostTimeOutBroadcastPkts, matrixSDIndex=matrixSDIndex, etherStatsPkts512to1023Octets=etherStatsPkts512to1023Octets, matrixSDPkts=matrixSDPkts, rmonGroups=rmonGroups, bufferControlMaxOctetsGranted=bufferControlMaxOctetsGranted, alarmSampleType=alarmSampleType, alarmStartupAlarm=alarmStartupAlarm, rmonNotificationGroup=rmonNotificationGroup, hostOutErrors=hostOutErrors, rmonEventGroup=rmonEventGroup, rmonMatrixGroup=rmonMatrixGroup, channelAcceptType=channelAcceptType, matrixDSEntry=matrixDSEntry, etherStatsOwner=etherStatsOwner, bufferControlCapturedPackets=bufferControlCapturedPackets)
