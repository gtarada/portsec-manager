...
# ASN.1 source http://raw.githubusercontent.com:80/simonjj/SnmpMibs/master/SNMPv2-MIB.txt
...
Counter32, ModuleIdentity, ObjectIdentity, TimeTicks, Integer32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, IpAddress, MibIdentifier, Bits, Unsigned32, snmpModules, Gauge32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "Integer32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "IpAddress", "MibIdentifier", "Bits", "Unsigned32", "snmpModules", "Gauge32", "iso", "NotificationType")
...
mibBuilder.exportSymbols("SNMPv2-MIB", snmpBasicCompliance=snmpBasicCompliance, snmpTrapEnterprise=snmpTrapEnterprise, snmpSetSerialNo=snmpSetSerialNo, snmpEnableAuthenTraps=snmpEnableAuthenTraps, snmpMIBObjects=snmpMIBObjects, PYSNMP_MODULE_ID=snmpMIB, snmp=snmp, snmpTrap=snmpTrap, snmpCommunityGroup=snmpCommunityGroup, snmpGroup=snmpGroup, snmpObsoleteGroup=snmpObsoleteGroup, snmpMIBGroups=snmpMIBGroups, snmpOutNoSuchNames=snmpOutNoSuchNames, sysName=sysName, sysORID=sysORID, sysORTable=sysORTable, sysDescr=sysDescr, snmpInBadCommunityUses=snmpInBadCommunityUses, warmStart=warmStart, snmpMIBCompliances=snmpMIBCompliances, snmpOutGetRequests=snmpOutGetRequests, coldStart=coldStart, snmpInTraps=snmpInTraps, snmpBasicNotificationsGroup=snmpBasicNotificationsGroup, snmpInGenErrs=snmpInGenErrs, sysORUpTime=sysORUpTime, sysUpTime=sysUpTime, snmpOutTooBigs=snmpOutTooBigs, systemGroup=systemGroup, snmpInGetNexts=snmpInGetNexts, snmpWarmStartNotificationGroup=snmpWarmStartNotificationGroup, system=system, snmpInBadCommunityNames=snmpInBadCommunityNames, snmpNotificationGroup=snmpNotificationGroup, sysORLastChange=sysORLastChange, snmpOutPkts=snmpOutPkts, snmpInReadOnlys=snmpInReadOnlys, sysORDescr=sysORDescr, snmpSilentDrops=snmpSilentDrops, snmpOutSetRequests=snmpOutSetRequests, snmpTrapOID=snmpTrapOID, authenticationFailure=authenticationFailure, snmpProxyDrops=snmpProxyDrops, snmpInNoSuchNames=snmpInNoSuchNames, snmpInSetRequests=snmpInSetRequests, snmpInTooBigs=snmpInTooBigs, snmpMIB=snmpMIB, snmpSet=snmpSet, snmpInASNParseErrs=snmpInASNParseErrs, snmpInTotalSetVars=snmpInTotalSetVars, snmpOutGetNexts=snmpOutGetNexts, snmpInBadValues=snmpInBadValues, snmpOutTraps=snmpOutTraps, snmpSetGroup=snmpSetGroup, sysObjectID=sysObjectID, snmpInGetResponses=snmpInGetResponses, snmpOutGenErrs=snmpOutGenErrs, snmpTraps=snmpTraps, sysServices=sysServices, snmpInPkts=snmpInPkts, sysLocation=sysLocation, snmpInBadVersions=snmpInBadVersions, sysContact=sysContact, snmpMIBConformance=snmpMIBConformance, snmpBasicComplianceRev2=snmpBasicComplianceRev2, snmpInTotalReqVars=snmpInTotalReqVars, sysORIndex=sysORIndex, snmpOutBadValues=snmpOutBadValues, sysOREntry=sysOREntry, snmpOutGetResponses=snmpOutGetResponses, snmpInGetRequests=snmpInGetRequests)
