...
mibBuilder.exportSymbols("CISCO-VLAN-MEMBERSHIP-MIB", vmVQPNotificationsGroup=vmVQPNotificationsGroup, vmStatusGroup=vmStatusGroup, vmInsufficientResources=vmInsufficientResources, vmStatus=vmStatus, vmVQPDenied=vmVQPDenied, vmStatistics=vmStatistics, vmVmpsEntry=vmVmpsEntry, vmVQPResponses=vmVQPResponses, vmMIBCompliance3=vmMIBCompliance3, PYSNMP_MODULE_ID=ciscoVlanMembershipMIB, vmVlans=vmVlans, vm4kVlanGroup=vm4kVlanGroup, vmVlans3k=vmVlans3k, vmVmpsChanges=vmVmpsChanges, vmVoiceVlanEntry=vmVoiceVlanEntry, vmMIBCompliance2=vmMIBCompliance2, vmMIBCompliance5=vmMIBCompliance5, vmMembershipTable=vmMembershipTable, vmVQPQueries=vmVQPQueries, vmMembershipGroup=vmMembershipGroup, vmVmpsReconfirmResult=vmVmpsReconfirmResult, vmVlanType=vmVlanType, vmVmpsReconfirm=vmVmpsReconfirm, vmMembershipSummaryEntry=vmMembershipSummaryEntry, vmMIBGroups=vmMIBGroups, vmVlans2k=vmVlans2k, vmMembership=vmMembership, vmVmpsTable=vmVmpsTable, ciscoVlanMembershipMIB=ciscoVlanMembershipMIB, vmVmpsRetries=vmVmpsRetries, vmMembershipEntry=vmMembershipEntry, vmVoiceVlanCdpVerifyEnable=vmVoiceVlanCdpVerifyEnable, vmNotifications=vmNotifications, vmMembershipGroup2=vmMembershipGroup2, vmMIBCompliances=vmMIBCompliances, vmVmpsCurrent=vmVmpsCurrent, vmVmpsChange=vmVmpsChange, vmVlan=vmVlan, vmVQPWrongVersion=vmVQPWrongVersion, vmVmpsIpAddress=vmVmpsIpAddress, vmVQPShutdown=vmVQPShutdown, vmMIBConformance=vmMIBConformance, vmVmpsRowStatus=vmVmpsRowStatus, vmVoiceVlanId=vmVoiceVlanId, vmMembershipGroup3=vmMembershipGroup3, vmVmpsPrimary=vmVmpsPrimary, vmMIBCompliance4=vmMIBCompliance4, vm1kVlanGroup=vm1kVlanGroup, vmMembershipSummaryMemberPorts=vmMembershipSummaryMemberPorts, vmMembershipSummaryTable=vmMembershipSummaryTable, vmVoiceVlan=vmVoiceVlan, vmVmpsReconfirmInterval=vmVmpsReconfirmInterval, vmMembershipSummaryVlanIndex=vmMembershipSummaryVlanIndex, ciscoVlanMembershipMIBObjects=ciscoVlanMembershipMIBObjects, vmVmps=vmVmps, vmVlans4k=vmVlans4k, vmNotificationsEnabled=vmNotificationsEnabled, vmVoiceVlanTable=vmVoiceVlanTable, vmNotificationsPrefix=vmNotificationsPrefix, vmMIBCompliance=vmMIBCompliance, vmVQPClientGroup=vmVQPClientGroup, vmVoiceVlanGroup=vmVoiceVlanGroup, vmMembershipSummaryMember2kPorts=vmMembershipSummaryMember2kPorts, vmVmpsVQPVersion=vmVmpsVQPVersion, vmVoiceVlanExtGroup=vmVoiceVlanExtGroup, vmVQPWrongDomain=vmVQPWrongDomain, vmPortStatus=vmPortStatus)
