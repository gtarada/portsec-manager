...
Counter32, ModuleIdentity, ObjectIdentity, Counter64, Integer32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, IpAddress, MibIdentifier, Bits, Unsigned32, Gauge32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "ObjectIdentity", "Counter64", "Integer32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "IpAddress", "MibIdentifier", "Bits", "Unsigned32", "Gauge32", "iso", "NotificationType")
AutonomousType, TestAndIncr, TruthValue, DisplayString, RowStatus, TextualConvention, PhysAddress, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TestAndIncr", "TruthValue", "DisplayString", "RowStatus", "TextualConvention", "PhysAddress", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifOutBroadcastPkts=ifOutBroadcastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifPhysAddress=ifPhysAddress, ifInNUcastPkts=ifInNUcastPkts, interfaces=interfaces, ifOutQLen=ifOutQLen, ifHCInOctets=ifHCInOctets, ifHighSpeed=ifHighSpeed, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifXEntry=ifXEntry, ifRcvAddressAddress=ifRcvAddressAddress, ifStackStatus=ifStackStatus, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifHCOutOctets=ifHCOutOctets, linkDown=linkDown, ifCompliances=ifCompliances, ifTable=ifTable, ifCompliance3=ifCompliance3, ifTestOwner=ifTestOwner, ifMIBObjects=ifMIBObjects, ifTableLastChange=ifTableLastChange, ifRcvAddressGroup=ifRcvAddressGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifRcvAddressTable=ifRcvAddressTable, ifPacketGroup=ifPacketGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifConnectorPresent=ifConnectorPresent, ifInMulticastPkts=ifInMulticastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifConformance=ifConformance, ifTestId=ifTestId, PYSNMP_MODULE_ID=ifMIB, ifDescr=ifDescr, ifOutDiscards=ifOutDiscards, ifStackTable=ifStackTable, ifStackGroup2=ifStackGroup2, ifTestEntry=ifTestEntry, ifPromiscuousMode=ifPromiscuousMode, ifMIB=ifMIB, ifSpecific=ifSpecific, ifTestStatus=ifTestStatus, OwnerString=OwnerString, ifGroups=ifGroups, ifStackGroup=ifStackGroup, ifMtu=ifMtu, ifCompliance2=ifCompliance2, ifOperStatus=ifOperStatus, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifNumber=ifNumber, ifStackHigherLayer=ifStackHigherLayer, ifVHCPacketGroup=ifVHCPacketGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifSpeed=ifSpeed, ifType=ifType, InterfaceIndex=InterfaceIndex, ifHCInUcastPkts=ifHCInUcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifStackLowerLayer=ifStackLowerLayer, ifInUcastPkts=ifInUcastPkts, ifAlias=ifAlias, ifTestTable=ifTestTable, ifAdminStatus=ifAdminStatus, ifTestCode=ifTestCode, ifTestResult=ifTestResult, ifInErrors=ifInErrors, ifRcvAddressEntry=ifRcvAddressEntry, ifTestGroup=ifTestGroup, ifOutErrors=ifOutErrors, ifHCFixedLengthGroup=ifHCFixedLengthGroup, linkUp=linkUp, ifInOctets=ifInOctets, ifInDiscards=ifInDiscards, ifOutUcastPkts=ifOutUcastPkts, ifXTable=ifXTable, ifStackLastChange=ifStackLastChange, ifCompliance=ifCompliance, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifName=ifName, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestType=ifTestType, ifLastChange=ifLastChange, ifRcvAddressStatus=ifRcvAddressStatus, ifOldObjectsGroup=ifOldObjectsGroup, ifIndex=ifIndex, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifOutOctets=ifOutOctets, ifStackEntry=ifStackEntry, ifInUnknownProtos=ifInUnknownProtos, ifOutMulticastPkts=ifOutMulticastPkts, ifGeneralGroup=ifGeneralGroup, ifEntry=ifEntry, ifHCOutUcastPkts=ifHCOutUcastPkts, ifRcvAddressType=ifRcvAddressType)
