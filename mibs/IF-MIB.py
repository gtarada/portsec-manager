...
Counter64, Integer32, mib_2, MibIdentifier, TimeTicks, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, ObjectIdentity, Bits, IpAddress, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "mib-2", "MibIdentifier", "TimeTicks", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "ObjectIdentity", "Bits", "IpAddress", "Counter32", "Gauge32")
TextualConvention, DisplayString, TruthValue, TimeStamp, RowStatus, PhysAddress, AutonomousType, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "TruthValue", "TimeStamp", "RowStatus", "PhysAddress", "AutonomousType", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifAlias=ifAlias, ifHCOutOctets=ifHCOutOctets, linkDown=linkDown, ifTestEntry=ifTestEntry, PYSNMP_MODULE_ID=ifMIB, InterfaceIndexOrZero=InterfaceIndexOrZero, ifTestStatus=ifTestStatus, ifRcvAddressGroup=ifRcvAddressGroup, ifNumber=ifNumber, ifStackTable=ifStackTable, ifCompliance3=ifCompliance3, ifOutMulticastPkts=ifOutMulticastPkts, ifInNUcastPkts=ifInNUcastPkts, ifCompliance2=ifCompliance2, ifOperStatus=ifOperStatus, ifTableLastChange=ifTableLastChange, ifRcvAddressAddress=ifRcvAddressAddress, ifOutUcastPkts=ifOutUcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifStackEntry=ifStackEntry, ifTestResult=ifTestResult, ifVHCPacketGroup=ifVHCPacketGroup, ifTestId=ifTestId, ifTestGroup=ifTestGroup, ifHCPacketGroup=ifHCPacketGroup, ifTable=ifTable, ifXTable=ifXTable, ifOutOctets=ifOutOctets, ifHCOutUcastPkts=ifHCOutUcastPkts, ifInOctets=ifInOctets, ifRcvAddressStatus=ifRcvAddressStatus, ifInErrors=ifInErrors, ifCompliances=ifCompliances, ifDescr=ifDescr, ifStackHigherLayer=ifStackHigherLayer, interfaces=interfaces, ifTestType=ifTestType, ifName=ifName, ifPhysAddress=ifPhysAddress, ifInMulticastPkts=ifInMulticastPkts, ifStackLowerLayer=ifStackLowerLayer, ifSpecific=ifSpecific, ifAdminStatus=ifAdminStatus, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifGroups=ifGroups, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHCInUcastPkts=ifHCInUcastPkts, ifOldObjectsGroup=ifOldObjectsGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifSpeed=ifSpeed, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifIndex=ifIndex, ifRcvAddressEntry=ifRcvAddressEntry, InterfaceIndex=InterfaceIndex, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTestOwner=ifTestOwner, ifType=ifType, ifHCFixedLengthGroup=ifHCFixedLengthGroup, OwnerString=OwnerString, ifOutNUcastPkts=ifOutNUcastPkts, ifInDiscards=ifInDiscards, ifOutDiscards=ifOutDiscards, ifInUnknownProtos=ifInUnknownProtos, ifMtu=ifMtu, ifHCInOctets=ifHCInOctets, ifStackGroup=ifStackGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifRcvAddressTable=ifRcvAddressTable, ifHighSpeed=ifHighSpeed, ifConnectorPresent=ifConnectorPresent, ifFixedLengthGroup=ifFixedLengthGroup, ifStackGroup2=ifStackGroup2, ifXEntry=ifXEntry, ifPacketGroup=ifPacketGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifStackStatus=ifStackStatus, ifMIB=ifMIB, ifGeneralGroup=ifGeneralGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifConformance=ifConformance, ifEntry=ifEntry, ifOutQLen=ifOutQLen, ifInUcastPkts=ifInUcastPkts, linkUp=linkUp, ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackLastChange=ifStackLastChange, ifCompliance=ifCompliance, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOutErrors=ifOutErrors, ifMIBObjects=ifMIBObjects, ifTestCode=ifTestCode, ifLastChange=ifLastChange, ifRcvAddressType=ifRcvAddressType, ifTestTable=ifTestTable)
