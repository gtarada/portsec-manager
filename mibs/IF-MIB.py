...
TestAndIncr, TruthValue, AutonomousType, RowStatus, PhysAddress, DisplayString, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "TruthValue", "AutonomousType", "RowStatus", "PhysAddress", "DisplayString", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("IF-MIB", ifHCInOctets=ifHCInOctets, ifInBroadcastPkts=ifInBroadcastPkts, ifTestId=ifTestId, PYSNMP_MODULE_ID=ifMIB, ifXEntry=ifXEntry, ifCompliances=ifCompliances, ifRcvAddressGroup=ifRcvAddressGroup, linkUp=linkUp, ifInNUcastPkts=ifInNUcastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifPacketGroup=ifPacketGroup, ifSpeed=ifSpeed, ifGeneralInformationGroup=ifGeneralInformationGroup, ifCompliance2=ifCompliance2, ifOutErrors=ifOutErrors, ifInErrors=ifInErrors, ifVHCPacketGroup=ifVHCPacketGroup, ifOutDiscards=ifOutDiscards, ifSpecific=ifSpecific, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, interfaces=interfaces, ifHCPacketGroup=ifHCPacketGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifCompliance=ifCompliance, ifRcvAddressType=ifRcvAddressType, ifName=ifName, ifAlias=ifAlias, ifCompliance3=ifCompliance3, OwnerString=OwnerString, ifPromiscuousMode=ifPromiscuousMode, ifStackGroup=ifStackGroup, ifIndex=ifIndex, ifInUnknownProtos=ifInUnknownProtos, ifTestEntry=ifTestEntry, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifGeneralGroup=ifGeneralGroup, ifLastChange=ifLastChange, ifRcvAddressTable=ifRcvAddressTable, ifMIB=ifMIB, ifRcvAddressAddress=ifRcvAddressAddress, ifNumber=ifNumber, ifRcvAddressStatus=ifRcvAddressStatus, ifTestResult=ifTestResult, ifFixedLengthGroup=ifFixedLengthGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, linkDown=linkDown, ifInDiscards=ifInDiscards, ifXTable=ifXTable, ifEntry=ifEntry, InterfaceIndex=InterfaceIndex, ifOutOctets=ifOutOctets, ifStackEntry=ifStackEntry, ifConnectorPresent=ifConnectorPresent, ifTestStatus=ifTestStatus, ifAdminStatus=ifAdminStatus, ifTestTable=ifTestTable, ifTestCode=ifTestCode, ifTestType=ifTestType, ifOutUcastPkts=ifOutUcastPkts, ifInMulticastPkts=ifInMulticastPkts, ifTestOwner=ifTestOwner, ifType=ifType, ifHCOutUcastPkts=ifHCOutUcastPkts, ifTable=ifTable, ifOutMulticastPkts=ifOutMulticastPkts, ifGroups=ifGroups, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifStackStatus=ifStackStatus, ifTestGroup=ifTestGroup, ifStackHigherLayer=ifStackHigherLayer, ifHCOutOctets=ifHCOutOctets, ifInUcastPkts=ifInUcastPkts, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifConformance=ifConformance, ifOutQLen=ifOutQLen, ifOperStatus=ifOperStatus, ifHCInUcastPkts=ifHCInUcastPkts, ifMtu=ifMtu, ifMIBObjects=ifMIBObjects, ifInOctets=ifInOctets, ifHighSpeed=ifHighSpeed, ifOldObjectsGroup=ifOldObjectsGroup, ifStackLastChange=ifStackLastChange, ifStackGroup2=ifStackGroup2, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTableLastChange=ifTableLastChange, ifPhysAddress=ifPhysAddress, ifRcvAddressEntry=ifRcvAddressEntry, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifStackTable=ifStackTable, ifDescr=ifDescr, ifStackLowerLayer=ifStackLowerLayer, ifHCInMulticastPkts=ifHCInMulticastPkts)
