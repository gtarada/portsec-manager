...
# ASN.1 source http://raw.githubusercontent.com:80/simonjj/SnmpMibs/master/IF-MIB.txt
...
Counter64, ModuleIdentity, Gauge32, ObjectIdentity, NotificationType, Integer32, TimeTicks, iso, Unsigned32, IpAddress, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "Gauge32", "ObjectIdentity", "NotificationType", "Integer32", "TimeTicks", "iso", "Unsigned32", "IpAddress", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "Counter32")
TimeStamp, PhysAddress, TestAndIncr, RowStatus, TextualConvention, DisplayString, TruthValue, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "PhysAddress", "TestAndIncr", "RowStatus", "TextualConvention", "DisplayString", "TruthValue", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", ifNumber=ifNumber, ifInNUcastPkts=ifInNUcastPkts, ifGeneralGroup=ifGeneralGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOutErrors=ifOutErrors, ifMIB=ifMIB, ifCompliance=ifCompliance, ifStackGroup2=ifStackGroup2, ifHCInUcastPkts=ifHCInUcastPkts, ifOutOctets=ifOutOctets, ifMtu=ifMtu, ifInErrors=ifInErrors, ifDescr=ifDescr, ifInBroadcastPkts=ifInBroadcastPkts, ifTestEntry=ifTestEntry, ifStackGroup=ifStackGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifOutDiscards=ifOutDiscards, ifStackLowerLayer=ifStackLowerLayer, ifXEntry=ifXEntry, ifMIBObjects=ifMIBObjects, ifTable=ifTable, ifType=ifType, ifStackHigherLayer=ifStackHigherLayer, ifGeneralInformationGroup=ifGeneralInformationGroup, ifFixedLengthGroup=ifFixedLengthGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifOutNUcastPkts=ifOutNUcastPkts, linkDown=linkDown, ifTestCode=ifTestCode, ifStackTable=ifStackTable, ifPhysAddress=ifPhysAddress, ifInMulticastPkts=ifInMulticastPkts, ifOperStatus=ifOperStatus, ifRcvAddressTable=ifRcvAddressTable, PYSNMP_MODULE_ID=ifMIB, ifTestGroup=ifTestGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, interfaces=interfaces, ifTestId=ifTestId, ifPacketGroup=ifPacketGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifGroups=ifGroups, OwnerString=OwnerString, ifAdminStatus=ifAdminStatus, ifInDiscards=ifInDiscards, ifOutUcastPkts=ifOutUcastPkts, ifTestStatus=ifTestStatus, ifTableLastChange=ifTableLastChange, ifStackEntry=ifStackEntry, ifRcvAddressType=ifRcvAddressType, InterfaceIndex=InterfaceIndex, ifLastChange=ifLastChange, ifStackStatus=ifStackStatus, ifOutBroadcastPkts=ifOutBroadcastPkts, ifCompliance3=ifCompliance3, ifCompliances=ifCompliances, ifTestResult=ifTestResult, ifStackLastChange=ifStackLastChange, ifXTable=ifXTable, ifHighSpeed=ifHighSpeed, ifName=ifName, ifRcvAddressStatus=ifRcvAddressStatus, ifTestOwner=ifTestOwner, ifHCOutOctets=ifHCOutOctets, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifHCInOctets=ifHCInOctets, linkUp=linkUp, ifAlias=ifAlias, ifEntry=ifEntry, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCOutUcastPkts=ifHCOutUcastPkts, ifInUcastPkts=ifInUcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifTestType=ifTestType, ifSpeed=ifSpeed, ifRcvAddressGroup=ifRcvAddressGroup, ifConnectorPresent=ifConnectorPresent, ifConformance=ifConformance, ifSpecific=ifSpecific, ifRcvAddressEntry=ifRcvAddressEntry, ifPromiscuousMode=ifPromiscuousMode, ifHCPacketGroup=ifHCPacketGroup, ifTestTable=ifTestTable, ifInOctets=ifInOctets, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifOutMulticastPkts=ifOutMulticastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifCompliance2=ifCompliance2, ifOutQLen=ifOutQLen, ifIndex=ifIndex, ifHCOutMulticastPkts=ifHCOutMulticastPkts)
