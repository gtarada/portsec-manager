...
TimeTicks, IpAddress, MibIdentifier, NotificationType, Counter32, mib_2, Integer32, iso, Bits, Gauge32, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "MibIdentifier", "NotificationType", "Counter32", "mib-2", "Integer32", "iso", "Bits", "Gauge32", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64")
AutonomousType, TimeStamp, PhysAddress, TextualConvention, RowStatus, TruthValue, DisplayString, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TimeStamp", "PhysAddress", "TextualConvention", "RowStatus", "TruthValue", "DisplayString", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifInNUcastPkts=ifInNUcastPkts, ifHCInOctets=ifHCInOctets, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, PYSNMP_MODULE_ID=ifMIB, ifTableLastChange=ifTableLastChange, ifStackLowerLayer=ifStackLowerLayer, ifRcvAddressStatus=ifRcvAddressStatus, ifCompliances=ifCompliances, ifName=ifName, ifTestStatus=ifTestStatus, OwnerString=OwnerString, InterfaceIndex=InterfaceIndex, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifOutErrors=ifOutErrors, ifHCOutUcastPkts=ifHCOutUcastPkts, ifStackGroup=ifStackGroup, ifMtu=ifMtu, ifRcvAddressType=ifRcvAddressType, ifTestId=ifTestId, ifInErrors=ifInErrors, ifInUnknownProtos=ifInUnknownProtos, InterfaceIndexOrZero=InterfaceIndexOrZero, ifGeneralInformationGroup=ifGeneralInformationGroup, ifCompliance2=ifCompliance2, ifOldObjectsGroup=ifOldObjectsGroup, ifGeneralGroup=ifGeneralGroup, ifSpeed=ifSpeed, ifPromiscuousMode=ifPromiscuousMode, ifStackGroup2=ifStackGroup2, ifInUcastPkts=ifInUcastPkts, ifStackStatus=ifStackStatus, ifOutQLen=ifOutQLen, ifType=ifType, ifXTable=ifXTable, ifXEntry=ifXEntry, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifStackTable=ifStackTable, ifTable=ifTable, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifConnectorPresent=ifConnectorPresent, ifTestCode=ifTestCode, ifGroups=ifGroups, ifIndex=ifIndex, ifRcvAddressGroup=ifRcvAddressGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifTestGroup=ifTestGroup, ifOutOctets=ifOutOctets, ifOutNUcastPkts=ifOutNUcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifMIB=ifMIB, ifHCInUcastPkts=ifHCInUcastPkts, ifAdminStatus=ifAdminStatus, linkDown=linkDown, ifHighSpeed=ifHighSpeed, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOutMulticastPkts=ifOutMulticastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, linkUp=linkUp, ifTestTable=ifTestTable, ifVHCPacketGroup=ifVHCPacketGroup, ifLastChange=ifLastChange, ifOperStatus=ifOperStatus, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestResult=ifTestResult, ifDescr=ifDescr, ifRcvAddressTable=ifRcvAddressTable, ifCompliance=ifCompliance, ifMIBObjects=ifMIBObjects, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifNumber=ifNumber, ifHCInMulticastPkts=ifHCInMulticastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifInOctets=ifInOctets, ifSpecific=ifSpecific, ifStackEntry=ifStackEntry, ifRcvAddressEntry=ifRcvAddressEntry, ifTestType=ifTestType, ifInMulticastPkts=ifInMulticastPkts, ifAlias=ifAlias, ifStackLastChange=ifStackLastChange, ifRcvAddressAddress=ifRcvAddressAddress, ifConformance=ifConformance, ifOutUcastPkts=ifOutUcastPkts, ifHCOutOctets=ifHCOutOctets, ifCompliance3=ifCompliance3, ifPhysAddress=ifPhysAddress, ifInDiscards=ifInDiscards, ifTestOwner=ifTestOwner, ifOutDiscards=ifOutDiscards, ifTestEntry=ifTestEntry, ifPacketGroup=ifPacketGroup, interfaces=interfaces, ifStackHigherLayer=ifStackHigherLayer, ifEntry=ifEntry)
