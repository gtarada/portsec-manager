...
Counter32, NotificationType, ObjectIdentity, IpAddress, MibIdentifier, Integer32, Counter64, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Gauge32, Bits, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "ObjectIdentity", "IpAddress", "MibIdentifier", "Integer32", "Counter64", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Gauge32", "Bits", "ModuleIdentity", "Unsigned32")
DisplayString, AutonomousType, TruthValue, TimeStamp, TextualConvention, PhysAddress, RowStatus, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "AutonomousType", "TruthValue", "TimeStamp", "TextualConvention", "PhysAddress", "RowStatus", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifOutDiscards=ifOutDiscards, InterfaceIndexOrZero=InterfaceIndexOrZero, ifConnectorPresent=ifConnectorPresent, ifFixedLengthGroup=ifFixedLengthGroup, ifHCInOctets=ifHCInOctets, ifTestStatus=ifTestStatus, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressEntry=ifRcvAddressEntry, linkUp=linkUp, ifEntry=ifEntry, ifOperStatus=ifOperStatus, ifCompliance3=ifCompliance3, ifHighSpeed=ifHighSpeed, ifXEntry=ifXEntry, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifSpeed=ifSpeed, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, InterfaceIndex=InterfaceIndex, ifTestEntry=ifTestEntry, ifMtu=ifMtu, linkDown=linkDown, ifStackTable=ifStackTable, ifConformance=ifConformance, ifInNUcastPkts=ifInNUcastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifDescr=ifDescr, ifXTable=ifXTable, ifLastChange=ifLastChange, ifInUcastPkts=ifInUcastPkts, ifTestType=ifTestType, ifRcvAddressType=ifRcvAddressType, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifSpecific=ifSpecific, ifInUnknownProtos=ifInUnknownProtos, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifTestTable=ifTestTable, ifTestCode=ifTestCode, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifHCOutOctets=ifHCOutOctets, ifCompliance2=ifCompliance2, ifMIBObjects=ifMIBObjects, ifStackEntry=ifStackEntry, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifAdminStatus=ifAdminStatus, ifInErrors=ifInErrors, ifHCPacketGroup=ifHCPacketGroup, ifInBroadcastPkts=ifInBroadcastPkts, OwnerString=OwnerString, ifHCOutUcastPkts=ifHCOutUcastPkts, PYSNMP_MODULE_ID=ifMIB, ifStackGroup2=ifStackGroup2, ifTableLastChange=ifTableLastChange, ifPhysAddress=ifPhysAddress, ifVHCPacketGroup=ifVHCPacketGroup, ifIndex=ifIndex, ifOutQLen=ifOutQLen, ifTestGroup=ifTestGroup, ifOutMulticastPkts=ifOutMulticastPkts, ifInDiscards=ifInDiscards, ifTable=ifTable, ifOutErrors=ifOutErrors, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifStackHigherLayer=ifStackHigherLayer, ifInMulticastPkts=ifInMulticastPkts, ifAlias=ifAlias, ifOldObjectsGroup=ifOldObjectsGroup, ifInOctets=ifInOctets, ifRcvAddressStatus=ifRcvAddressStatus, ifPacketGroup=ifPacketGroup, ifNumber=ifNumber, ifStackLowerLayer=ifStackLowerLayer, ifGeneralInformationGroup=ifGeneralInformationGroup, ifName=ifName, ifCompliances=ifCompliances, ifCompliance=ifCompliance, ifTestId=ifTestId, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackStatus=ifStackStatus, interfaces=interfaces, ifRcvAddressTable=ifRcvAddressTable, ifTestOwner=ifTestOwner, ifOutUcastPkts=ifOutUcastPkts, ifMIB=ifMIB, ifPromiscuousMode=ifPromiscuousMode, ifOutOctets=ifOutOctets, ifHCInUcastPkts=ifHCInUcastPkts, ifTestResult=ifTestResult, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifStackLastChange=ifStackLastChange, ifGeneralGroup=ifGeneralGroup, ifRcvAddressGroup=ifRcvAddressGroup, ifStackGroup=ifStackGroup, ifGroups=ifGroups, ifType=ifType)
