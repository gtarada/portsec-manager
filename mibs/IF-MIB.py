...
Gauge32, ObjectIdentity, Unsigned32, Counter32, NotificationType, TimeTicks, MibIdentifier, ModuleIdentity, Counter64, Bits, Integer32, IpAddress, mib_2, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Unsigned32", "Counter32", "NotificationType", "TimeTicks", "MibIdentifier", "ModuleIdentity", "Counter64", "Bits", "Integer32", "IpAddress", "mib-2", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
DisplayString, RowStatus, TextualConvention, PhysAddress, TimeStamp, AutonomousType, TruthValue, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "TextualConvention", "PhysAddress", "TimeStamp", "AutonomousType", "TruthValue", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifOutDiscards=ifOutDiscards, ifStackGroup2=ifStackGroup2, ifOutErrors=ifOutErrors, ifOldObjectsGroup=ifOldObjectsGroup, ifConnectorPresent=ifConnectorPresent, ifHCOutUcastPkts=ifHCOutUcastPkts, OwnerString=OwnerString, ifType=ifType, ifInDiscards=ifInDiscards, ifTable=ifTable, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifPhysAddress=ifPhysAddress, ifRcvAddressAddress=ifRcvAddressAddress, ifGroups=ifGroups, ifHCPacketGroup=ifHCPacketGroup, ifXTable=ifXTable, ifCompliance3=ifCompliance3, ifTestEntry=ifTestEntry, ifNumber=ifNumber, ifOperStatus=ifOperStatus, ifRcvAddressStatus=ifRcvAddressStatus, ifTestId=ifTestId, ifAdminStatus=ifAdminStatus, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestGroup=ifTestGroup, ifOutUcastPkts=ifOutUcastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifInBroadcastPkts=ifInBroadcastPkts, ifMIBObjects=ifMIBObjects, ifHCInUcastPkts=ifHCInUcastPkts, ifStackStatus=ifStackStatus, ifOutMulticastPkts=ifOutMulticastPkts, ifHCOutOctets=ifHCOutOctets, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackHigherLayer=ifStackHigherLayer, ifCompliance=ifCompliance, ifRcvAddressTable=ifRcvAddressTable, ifRcvAddressGroup=ifRcvAddressGroup, ifName=ifName, ifOutNUcastPkts=ifOutNUcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifInUnknownProtos=ifInUnknownProtos, ifXEntry=ifXEntry, ifStackTable=ifStackTable, ifRcvAddressEntry=ifRcvAddressEntry, ifFixedLengthGroup=ifFixedLengthGroup, linkUp=linkUp, ifStackGroup=ifStackGroup, ifTableLastChange=ifTableLastChange, ifPacketGroup=ifPacketGroup, ifStackLowerLayer=ifStackLowerLayer, ifInMulticastPkts=ifInMulticastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifCompliance2=ifCompliance2, ifRcvAddressType=ifRcvAddressType, ifDescr=ifDescr, ifPromiscuousMode=ifPromiscuousMode, ifIndex=ifIndex, ifGeneralGroup=ifGeneralGroup, ifInOctets=ifInOctets, ifVHCPacketGroup=ifVHCPacketGroup, ifInUcastPkts=ifInUcastPkts, ifInErrors=ifInErrors, ifStackEntry=ifStackEntry, ifConformance=ifConformance, ifLastChange=ifLastChange, ifTestCode=ifTestCode, ifAlias=ifAlias, ifInNUcastPkts=ifInNUcastPkts, ifStackLastChange=ifStackLastChange, ifOutOctets=ifOutOctets, ifTestOwner=ifTestOwner, PYSNMP_MODULE_ID=ifMIB, ifOutQLen=ifOutQLen, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifSpecific=ifSpecific, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifEntry=ifEntry, linkDown=linkDown, ifTestStatus=ifTestStatus, ifMIB=ifMIB, ifHCInOctets=ifHCInOctets, ifCompliances=ifCompliances, ifMtu=ifMtu, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, InterfaceIndex=InterfaceIndex, ifTestTable=ifTestTable, ifSpeed=ifSpeed, ifTestResult=ifTestResult, interfaces=interfaces, ifTestType=ifTestType, ifHighSpeed=ifHighSpeed)
