...
# ASN.1 source http://raw.githubusercontent.com:80/simonjj/SnmpMibs/master/TOKEN-RING-RMON-MIB.mib
...
EntryStatus, statistics, OwnerString, history, rmon = mibBuilder.importSymbols("RMON-MIB", "EntryStatus", "statistics", "OwnerString", "history", "rmon")
NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance")
Counter32, NotificationType, ObjectIdentity, IpAddress, MibIdentifier, Integer32, iso, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "ObjectIdentity", "IpAddress", "MibIdentifier", "Integer32", "iso", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("TOKEN-RING-RMON-MIB", ringStationFrameCopiedErrors=ringStationFrameCopiedErrors, tokenRingMLStatsDropEvents=tokenRingMLStatsDropEvents, tokenRingPHistoryDataBroadcastPkts=tokenRingPHistoryDataBroadcastPkts, sourceRoutingStats8HopsFrames=sourceRoutingStats8HopsFrames, ringStationControlEntry=ringStationControlEntry, ringStationOutLineErrors=ringStationOutLineErrors, ringStationInBurstErrors=ringStationInBurstErrors, ringStationConfigIfIndex=ringStationConfigIfIndex, tokenRingPStatsDataSource=tokenRingPStatsDataSource, tokenRingPStatsStatus=tokenRingPStatsStatus, tokenRingPStatsDataPkts2048to4095Octets=tokenRingPStatsDataPkts2048to4095Octets, ringStationLastExitTime=ringStationLastExitTime, sourceRoutingStatsInFrames=sourceRoutingStatsInFrames, sourceRoutingStats3HopsFrames=sourceRoutingStats3HopsFrames, tokenRingPHistoryTable=tokenRingPHistoryTable, sourceRoutingStats7HopsFrames=sourceRoutingStats7HopsFrames, tokenRingPHistoryDataPkts=tokenRingPHistoryDataPkts, sourceRoutingStats6HopsFrames=sourceRoutingStats6HopsFrames, tokenRingMLStatsNAUNChanges=tokenRingMLStatsNAUNChanges, ringStationConfigControlEntry=ringStationConfigControlEntry, sourceRoutingStatsMoreThan8HopsFrames=sourceRoutingStatsMoreThan8HopsFrames, tokenRingPHistoryDataPkts1024to2047Octets=tokenRingPHistoryDataPkts1024to2047Octets, sourceRoutingStatsTable=sourceRoutingStatsTable, tokenRingPStatsDataPkts8192to18000Octets=tokenRingPStatsDataPkts8192to18000Octets, tokenRingMLHistorySoftErrorReports=tokenRingMLHistorySoftErrorReports, ringStationConfigFunctionalAddress=ringStationConfigFunctionalAddress, tokenRingMLHistoryAbortErrors=tokenRingMLHistoryAbortErrors, ringStationOrderIfIndex=ringStationOrderIfIndex, sourceRoutingStats5HopsFrames=sourceRoutingStats5HopsFrames, tokenRingMLStatsRingPurgePkts=tokenRingMLStatsRingPurgePkts, tokenRingPHistoryDataPkts2048to4095Octets=tokenRingPHistoryDataPkts2048to4095Octets, sourceRoutingStatsStatus=sourceRoutingStatsStatus, ringStationIfIndex=ringStationIfIndex, tokenRingPHistoryIntervalStart=tokenRingPHistoryIntervalStart, tokenRingPHistoryIndex=tokenRingPHistoryIndex, tokenRingMLHistoryTable=tokenRingMLHistoryTable, tokenRingPHistoryDataPkts18to63Octets=tokenRingPHistoryDataPkts18to63Octets, ringStationConfigGroupAddress=ringStationConfigGroupAddress, sourceRoutingStats1HopFrames=sourceRoutingStats1HopFrames, tokenRingMLHistoryACErrors=tokenRingMLHistoryACErrors, tokenRingPHistoryDataPktsGreaterThan18000Octets=tokenRingPHistoryDataPktsGreaterThan18000Octets, sourceRoutingStatsSingleRouteBroadcastFrames=sourceRoutingStatsSingleRouteBroadcastFrames, tokenRingPStatsDataPktsGreaterThan18000Octets=tokenRingPStatsDataPktsGreaterThan18000Octets, tokenRingMLHistoryRingPollEvents=tokenRingMLHistoryRingPollEvents, sourceRoutingStatsEntry=sourceRoutingStatsEntry, sourceRoutingStatsInOctets=sourceRoutingStatsInOctets, tokenRingPStatsDataPkts=tokenRingPStatsDataPkts, ringStationControlStatus=ringStationControlStatus, tokenRingMLStatsMacOctets=tokenRingMLStatsMacOctets, tokenRingMLStatsStatus=tokenRingMLStatsStatus, tokenRingMLHistoryTokenErrors=tokenRingMLHistoryTokenErrors, tokenRingPStatsDropEvents=tokenRingPStatsDropEvents, sourceRoutingStatsThroughFrames=sourceRoutingStatsThroughFrames, tokenRingMLStatsInternalErrors=tokenRingMLStatsInternalErrors, ringStationTokenErrors=ringStationTokenErrors, ringStationInBeaconErrors=ringStationInBeaconErrors, tokenRingMLHistoryClaimTokenPkts=tokenRingMLHistoryClaimTokenPkts, tokenRingMLStatsEntry=tokenRingMLStatsEntry, ringStationControlOwner=ringStationControlOwner, ringStationStationStatus=ringStationStationStatus, tokenRingMLHistoryLostFrameErrors=tokenRingMLHistoryLostFrameErrors, tokenRingPHistoryDataPkts128to255Octets=tokenRingPHistoryDataPkts128to255Octets, sourceRoutingStatsAllRoutesBroadcastOctets=sourceRoutingStatsAllRoutesBroadcastOctets, ringStationInternalErrors=ringStationInternalErrors, ringStationOutBeaconErrors=ringStationOutBeaconErrors, ringStationConfigControlIfIndex=ringStationConfigControlIfIndex, tokenRingMLHistoryDropEvents=tokenRingMLHistoryDropEvents, tokenRingMLHistoryBeaconTime=tokenRingMLHistoryBeaconTime, sourceRoutingStatsLocalLLCFrames=sourceRoutingStatsLocalLLCFrames, tokenRingMLStatsBeaconPkts=tokenRingMLStatsBeaconPkts, tokenRingMLHistoryNAUNChanges=tokenRingMLHistoryNAUNChanges, sourceRoutingStats2HopsFrames=sourceRoutingStats2HopsFrames, tokenRingMLStatsClaimTokenEvents=tokenRingMLStatsClaimTokenEvents, sourceRoutingStatsSingleRoutesBroadcastOctets=sourceRoutingStatsSingleRoutesBroadcastOctets, ringStationConfigTable=ringStationConfigTable, tokenRingMLStatsBeaconTime=tokenRingMLStatsBeaconTime, tokenRingPStatsDataMulticastPkts=tokenRingPStatsDataMulticastPkts, sourceRoutingStatsIfIndex=sourceRoutingStatsIfIndex, ringStationAbortErrors=ringStationAbortErrors, tokenRingPHistoryEntry=tokenRingPHistoryEntry, ringStationControlIfIndex=ringStationControlIfIndex, ringStationControlBeaconNAUN=ringStationControlBeaconNAUN, tokenRingMLStatsIndex=tokenRingMLStatsIndex, tokenRingMLStatsFrameCopiedErrors=tokenRingMLStatsFrameCopiedErrors, tokenRingMLHistoryBeaconPkts=tokenRingMLHistoryBeaconPkts, tokenRingMLStatsBurstErrors=tokenRingMLStatsBurstErrors, ringStationControlBeaconSender=ringStationControlBeaconSender, tokenRingPHistoryDataMulticastPkts=tokenRingPHistoryDataMulticastPkts, tokenRingPHistoryDataPkts64to127Octets=tokenRingPHistoryDataPkts64to127Octets, tokenRingMLStatsCongestionErrors=tokenRingMLStatsCongestionErrors, tokenRingMLStatsDataSource=tokenRingMLStatsDataSource, ringStationControlRingState=ringStationControlRingState, tokenRingMLStatsRingPollEvents=tokenRingMLStatsRingPollEvents, ringStationControlActiveMonitor=ringStationControlActiveMonitor, tokenRingMLHistoryBeaconEvents=tokenRingMLHistoryBeaconEvents, tokenRingPStatsDataPkts4096to8191Octets=tokenRingPStatsDataPkts4096to8191Octets, ringStationDuplicateAddresses=ringStationDuplicateAddresses, ringStationControlTableSize=ringStationControlTableSize, ringStationLastNAUN=ringStationLastNAUN, tokenRingMLStatsLineErrors=tokenRingMLStatsLineErrors, tokenRingMLHistoryMacOctets=tokenRingMLHistoryMacOctets, ringStationMacAddress=ringStationMacAddress, tokenRingPHistoryDataPkts512to1023Octets=tokenRingPHistoryDataPkts512to1023Octets, tokenRingMLHistoryIntervalStart=tokenRingMLHistoryIntervalStart, tokenRingMLHistoryInternalErrors=tokenRingMLHistoryInternalErrors, ringStationFrequencyErrors=ringStationFrequencyErrors, tokenRingPStatsIndex=tokenRingPStatsIndex, ringStationConfigControlMacAddress=ringStationConfigControlMacAddress, sourceRoutingStatsRingNumber=sourceRoutingStatsRingNumber, tokenRingMLHistoryBurstErrors=tokenRingMLHistoryBurstErrors, ringStationACErrors=ringStationACErrors, tokenRingMLStatsTokenErrors=tokenRingMLStatsTokenErrors, ringStationControlOrderChanges=ringStationControlOrderChanges, tokenRingPStatsOwner=tokenRingPStatsOwner, ringStationConfigMacAddress=ringStationConfigMacAddress, ringStationConfigUpdateTime=ringStationConfigUpdateTime, tokenRingMLHistoryRingPurgeEvents=tokenRingMLHistoryRingPurgeEvents, tokenRingPStatsDataPkts256to511Octets=tokenRingPStatsDataPkts256to511Octets, tokenRingPStatsDataPkts64to127Octets=tokenRingPStatsDataPkts64to127Octets, tokenRingMLStatsMacPkts=tokenRingMLStatsMacPkts, ringStationConfigMicrocode=ringStationConfigMicrocode, tokenRingMLHistorySampleIndex=tokenRingMLHistorySampleIndex, tokenRingPStatsDataPkts1024to2047Octets=tokenRingPStatsDataPkts1024to2047Octets, sourceRoutingStatsOutFrames=sourceRoutingStatsOutFrames, tokenRingMLHistoryCongestionErrors=tokenRingMLHistoryCongestionErrors, tokenRingMLHistoryClaimTokenEvents=tokenRingMLHistoryClaimTokenEvents, tokenRingMLHistoryMacPkts=tokenRingMLHistoryMacPkts, tokenRingMLHistoryLineErrors=tokenRingMLHistoryLineErrors, tokenRingPStatsTable=tokenRingPStatsTable, tokenRingPHistoryDataPkts256to511Octets=tokenRingPHistoryDataPkts256to511Octets, tokenRingMLStatsSoftErrorReports=tokenRingMLStatsSoftErrorReports, tokenRingPHistoryDataPkts8192to18000Octets=tokenRingPHistoryDataPkts8192to18000Octets, tokenRingMLStatsTable=tokenRingMLStatsTable, tokenRingMLStatsRingPurgeEvents=tokenRingMLStatsRingPurgeEvents, tokenRingPStatsDataPkts512to1023Octets=tokenRingPStatsDataPkts512to1023Octets, MacAddress=MacAddress, tokenRingMLHistoryFrameCopiedErrors=tokenRingMLHistoryFrameCopiedErrors, tokenRingPStatsEntry=tokenRingPStatsEntry, TimeInterval=TimeInterval, tokenRingMLStatsOwner=tokenRingMLStatsOwner, tokenRingMLStatsAbortErrors=tokenRingMLStatsAbortErrors, ringStationOrderMacAddress=ringStationOrderMacAddress, ringStationLastEnterTime=ringStationLastEnterTime, tokenRingMLStatsClaimTokenPkts=tokenRingMLStatsClaimTokenPkts, ringStationConfigLocation=ringStationConfigLocation, tokenRingMLHistoryEntry=tokenRingMLHistoryEntry, tokenRingMLStatsBeaconEvents=tokenRingMLStatsBeaconEvents, ringStationConfigEntry=ringStationConfigEntry, ringStationEntry=ringStationEntry, tokenRingMLStatsLostFrameErrors=tokenRingMLStatsLostFrameErrors, sourceRoutingStatsOwner=sourceRoutingStatsOwner, tokenRingPHistorySampleIndex=tokenRingPHistorySampleIndex, tokenRingPHistoryDropEvents=tokenRingPHistoryDropEvents, ringStationConfigControlUpdateStats=ringStationConfigControlUpdateStats, ringStationOrderOrderIndex=ringStationOrderOrderIndex, tokenRingMLHistoryFrequencyErrors=tokenRingMLHistoryFrequencyErrors, ringStationCongestionErrors=ringStationCongestionErrors, tokenRingPStatsDataOctets=tokenRingPStatsDataOctets, tokenRingPStatsDataBroadcastPkts=tokenRingPStatsDataBroadcastPkts, tokenRingPStatsDataPkts18to63Octets=tokenRingPStatsDataPkts18to63Octets, tokenRingMLHistoryIndex=tokenRingMLHistoryIndex, tokenRing=tokenRing, tokenRingPStatsDataPkts128to255Octets=tokenRingPStatsDataPkts128to255Octets, ringStationInLineErrors=ringStationInLineErrors, tokenRingMLHistoryRingPurgePkts=tokenRingMLHistoryRingPurgePkts, ringStationOutBurstErrors=ringStationOutBurstErrors, tokenRingMLStatsACErrors=tokenRingMLStatsACErrors, tokenRingPHistoryDataPkts4096to8191Octets=tokenRingPHistoryDataPkts4096to8191Octets, tokenRingMLStatsFrequencyErrors=tokenRingMLStatsFrequencyErrors, ringStationLostFrameErrors=ringStationLostFrameErrors, ringStationConfigControlTable=ringStationConfigControlTable, ringStationOrderTable=ringStationOrderTable, tokenRingMLHistoryActiveStations=tokenRingMLHistoryActiveStations, ringStationOrderEntry=ringStationOrderEntry, sourceRoutingStatsThroughOctets=sourceRoutingStatsThroughOctets, ringStationInsertions=ringStationInsertions, ringStationConfigControlRemove=ringStationConfigControlRemove, sourceRoutingStatsAllRoutesBroadcastFrames=sourceRoutingStatsAllRoutesBroadcastFrames, ringStationControlActiveStations=ringStationControlActiveStations, sourceRoutingStats4HopsFrames=sourceRoutingStats4HopsFrames, tokenRingPHistoryDataOctets=tokenRingPHistoryDataOctets, ringStationControlTable=ringStationControlTable, ringStationTable=ringStationTable, sourceRoutingStatsOutOctets=sourceRoutingStatsOutOctets)
