...
statistics, EntryStatus, OwnerString, history, rmon = mibBuilder.importSymbols("RMON-MIB", "statistics", "EntryStatus", "OwnerString", "history", "rmon")
NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance")
Counter32, ModuleIdentity, ObjectIdentity, TimeTicks, Integer32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, Bits, Unsigned32, Gauge32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "Integer32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "Bits", "Unsigned32", "Gauge32", "iso", "NotificationType")
...
mibBuilder.exportSymbols("TOKEN-RING-RMON-MIB", tokenRingPStatsStatus=tokenRingPStatsStatus, tokenRingMLStatsBeaconPkts=tokenRingMLStatsBeaconPkts, tokenRingPHistoryDataBroadcastPkts=tokenRingPHistoryDataBroadcastPkts, ringStationConfigMicrocode=ringStationConfigMicrocode, tokenRingPStatsDataPkts512to1023Octets=tokenRingPStatsDataPkts512to1023Octets, tokenRingMLHistoryIndex=tokenRingMLHistoryIndex, tokenRingMLStatsOwner=tokenRingMLStatsOwner, tokenRingPStatsDataPkts4096to8191Octets=tokenRingPStatsDataPkts4096to8191Octets, ringStationControlBeaconNAUN=ringStationControlBeaconNAUN, ringStationAbortErrors=ringStationAbortErrors, tokenRing=tokenRing, ringStationConfigControlTable=ringStationConfigControlTable, tokenRingMLStatsMacOctets=tokenRingMLStatsMacOctets, sourceRoutingStats6HopsFrames=sourceRoutingStats6HopsFrames, ringStationControlActiveMonitor=ringStationControlActiveMonitor, tokenRingMLStatsRingPurgePkts=tokenRingMLStatsRingPurgePkts, tokenRingPHistoryDataPkts256to511Octets=tokenRingPHistoryDataPkts256to511Octets, tokenRingPHistoryDataPkts1024to2047Octets=tokenRingPHistoryDataPkts1024to2047Octets, ringStationLastExitTime=ringStationLastExitTime, tokenRingMLStatsRingPurgeEvents=tokenRingMLStatsRingPurgeEvents, ringStationControlOwner=ringStationControlOwner, ringStationInsertions=ringStationInsertions, sourceRoutingStatsTable=sourceRoutingStatsTable, sourceRoutingStats5HopsFrames=sourceRoutingStats5HopsFrames, ringStationEntry=ringStationEntry, ringStationOrderMacAddress=ringStationOrderMacAddress, ringStationDuplicateAddresses=ringStationDuplicateAddresses, sourceRoutingStatsSingleRouteBroadcastFrames=sourceRoutingStatsSingleRouteBroadcastFrames, tokenRingMLHistoryRingPurgePkts=tokenRingMLHistoryRingPurgePkts, ringStationInLineErrors=ringStationInLineErrors, MacAddress=MacAddress, tokenRingPStatsDataPkts128to255Octets=tokenRingPStatsDataPkts128to255Octets, tokenRingMLHistoryEntry=tokenRingMLHistoryEntry, tokenRingPHistoryDataPkts=tokenRingPHistoryDataPkts, ringStationControlEntry=ringStationControlEntry, tokenRingMLHistoryRingPollEvents=tokenRingMLHistoryRingPollEvents, sourceRoutingStats7HopsFrames=sourceRoutingStats7HopsFrames, tokenRingMLHistorySampleIndex=tokenRingMLHistorySampleIndex, ringStationConfigIfIndex=ringStationConfigIfIndex, tokenRingMLHistoryMacPkts=tokenRingMLHistoryMacPkts, ringStationOrderTable=ringStationOrderTable, tokenRingMLHistoryACErrors=tokenRingMLHistoryACErrors, sourceRoutingStats1HopFrames=sourceRoutingStats1HopFrames, tokenRingMLStatsLineErrors=tokenRingMLStatsLineErrors, ringStationInBurstErrors=ringStationInBurstErrors, sourceRoutingStatsInFrames=sourceRoutingStatsInFrames, tokenRingMLHistoryIntervalStart=tokenRingMLHistoryIntervalStart, ringStationInternalErrors=ringStationInternalErrors, tokenRingPHistoryDataPkts512to1023Octets=tokenRingPHistoryDataPkts512to1023Octets, sourceRoutingStatsStatus=sourceRoutingStatsStatus, ringStationCongestionErrors=ringStationCongestionErrors, tokenRingPStatsDropEvents=tokenRingPStatsDropEvents, sourceRoutingStatsAllRoutesBroadcastOctets=sourceRoutingStatsAllRoutesBroadcastOctets, tokenRingMLStatsDataSource=tokenRingMLStatsDataSource, tokenRingMLStatsLostFrameErrors=tokenRingMLStatsLostFrameErrors, tokenRingMLStatsAbortErrors=tokenRingMLStatsAbortErrors, tokenRingMLHistoryTable=tokenRingMLHistoryTable, sourceRoutingStats2HopsFrames=sourceRoutingStats2HopsFrames, sourceRoutingStatsMoreThan8HopsFrames=sourceRoutingStatsMoreThan8HopsFrames, ringStationControlTable=ringStationControlTable, ringStationStationStatus=ringStationStationStatus, tokenRingPStatsDataOctets=tokenRingPStatsDataOctets, ringStationLastNAUN=ringStationLastNAUN, tokenRingMLHistoryRingPurgeEvents=tokenRingMLHistoryRingPurgeEvents, tokenRingMLStatsNAUNChanges=tokenRingMLStatsNAUNChanges, sourceRoutingStatsOutOctets=sourceRoutingStatsOutOctets, tokenRingMLHistoryLineErrors=tokenRingMLHistoryLineErrors, tokenRingMLHistoryBurstErrors=tokenRingMLHistoryBurstErrors, tokenRingMLStatsACErrors=tokenRingMLStatsACErrors, ringStationConfigMacAddress=ringStationConfigMacAddress, sourceRoutingStats8HopsFrames=sourceRoutingStats8HopsFrames, tokenRingMLStatsDropEvents=tokenRingMLStatsDropEvents, tokenRingMLStatsStatus=tokenRingMLStatsStatus, tokenRingMLStatsFrequencyErrors=tokenRingMLStatsFrequencyErrors, tokenRingMLHistoryClaimTokenEvents=tokenRingMLHistoryClaimTokenEvents, sourceRoutingStatsRingNumber=sourceRoutingStatsRingNumber, ringStationControlIfIndex=ringStationControlIfIndex, TimeInterval=TimeInterval, tokenRingMLStatsBeaconEvents=tokenRingMLStatsBeaconEvents, tokenRingPStatsOwner=tokenRingPStatsOwner, tokenRingPStatsDataSource=tokenRingPStatsDataSource, tokenRingMLHistoryBeaconTime=tokenRingMLHistoryBeaconTime, sourceRoutingStatsInOctets=sourceRoutingStatsInOctets, ringStationLastEnterTime=ringStationLastEnterTime, tokenRingPStatsDataPkts8192to18000Octets=tokenRingPStatsDataPkts8192to18000Octets, ringStationConfigControlMacAddress=ringStationConfigControlMacAddress, tokenRingMLStatsTable=tokenRingMLStatsTable, tokenRingPHistoryDataPkts64to127Octets=tokenRingPHistoryDataPkts64to127Octets, tokenRingMLHistoryLostFrameErrors=tokenRingMLHistoryLostFrameErrors, ringStationOutBeaconErrors=ringStationOutBeaconErrors, tokenRingMLStatsInternalErrors=tokenRingMLStatsInternalErrors, ringStationOrderEntry=ringStationOrderEntry, ringStationConfigGroupAddress=ringStationConfigGroupAddress, ringStationLostFrameErrors=ringStationLostFrameErrors, tokenRingPStatsDataPkts2048to4095Octets=tokenRingPStatsDataPkts2048to4095Octets, tokenRingMLHistoryTokenErrors=tokenRingMLHistoryTokenErrors, ringStationACErrors=ringStationACErrors, tokenRingMLHistoryCongestionErrors=tokenRingMLHistoryCongestionErrors, tokenRingPStatsDataMulticastPkts=tokenRingPStatsDataMulticastPkts, tokenRingMLHistoryBeaconPkts=tokenRingMLHistoryBeaconPkts, ringStationConfigControlUpdateStats=ringStationConfigControlUpdateStats, tokenRingMLStatsIndex=tokenRingMLStatsIndex, tokenRingMLStatsClaimTokenEvents=tokenRingMLStatsClaimTokenEvents, ringStationControlStatus=ringStationControlStatus, ringStationConfigControlRemove=ringStationConfigControlRemove, tokenRingMLHistoryAbortErrors=tokenRingMLHistoryAbortErrors, ringStationTokenErrors=ringStationTokenErrors, tokenRingMLHistoryMacOctets=tokenRingMLHistoryMacOctets, tokenRingPHistoryDataPkts4096to8191Octets=tokenRingPHistoryDataPkts4096to8191Octets, ringStationControlRingState=ringStationControlRingState, ringStationControlOrderChanges=ringStationControlOrderChanges, ringStationConfigUpdateTime=ringStationConfigUpdateTime, tokenRingMLHistoryFrequencyErrors=tokenRingMLHistoryFrequencyErrors, tokenRingMLHistoryClaimTokenPkts=tokenRingMLHistoryClaimTokenPkts, tokenRingMLStatsEntry=tokenRingMLStatsEntry, sourceRoutingStatsThroughFrames=sourceRoutingStatsThroughFrames, ringStationMacAddress=ringStationMacAddress, tokenRingMLHistoryFrameCopiedErrors=tokenRingMLHistoryFrameCopiedErrors, tokenRingPHistoryTable=tokenRingPHistoryTable, ringStationConfigControlIfIndex=ringStationConfigControlIfIndex, tokenRingMLHistoryInternalErrors=tokenRingMLHistoryInternalErrors, tokenRingPStatsIndex=tokenRingPStatsIndex, tokenRingMLStatsCongestionErrors=tokenRingMLStatsCongestionErrors, ringStationFrameCopiedErrors=ringStationFrameCopiedErrors, ringStationInBeaconErrors=ringStationInBeaconErrors, tokenRingPStatsDataPkts=tokenRingPStatsDataPkts, tokenRingMLStatsTokenErrors=tokenRingMLStatsTokenErrors, tokenRingMLStatsBeaconTime=tokenRingMLStatsBeaconTime, ringStationIfIndex=ringStationIfIndex, ringStationConfigControlEntry=ringStationConfigControlEntry, tokenRingPStatsDataBroadcastPkts=tokenRingPStatsDataBroadcastPkts, sourceRoutingStatsOutFrames=sourceRoutingStatsOutFrames, tokenRingMLStatsFrameCopiedErrors=tokenRingMLStatsFrameCopiedErrors, sourceRoutingStatsAllRoutesBroadcastFrames=sourceRoutingStatsAllRoutesBroadcastFrames, tokenRingPHistoryDataMulticastPkts=tokenRingPHistoryDataMulticastPkts, tokenRingMLHistorySoftErrorReports=tokenRingMLHistorySoftErrorReports, ringStationTable=ringStationTable, ringStationOrderOrderIndex=ringStationOrderOrderIndex, ringStationConfigTable=ringStationConfigTable, tokenRingMLHistoryNAUNChanges=tokenRingMLHistoryNAUNChanges, ringStationOutLineErrors=ringStationOutLineErrors, tokenRingPHistoryDataPktsGreaterThan18000Octets=tokenRingPHistoryDataPktsGreaterThan18000Octets, sourceRoutingStatsThroughOctets=sourceRoutingStatsThroughOctets, tokenRingPHistoryIndex=tokenRingPHistoryIndex, ringStationConfigEntry=ringStationConfigEntry, tokenRingPStatsTable=tokenRingPStatsTable, ringStationControlActiveStations=ringStationControlActiveStations, ringStationOrderIfIndex=ringStationOrderIfIndex, sourceRoutingStatsSingleRoutesBroadcastOctets=sourceRoutingStatsSingleRoutesBroadcastOctets, tokenRingPStatsDataPkts18to63Octets=tokenRingPStatsDataPkts18to63Octets, ringStationOutBurstErrors=ringStationOutBurstErrors, tokenRingPHistoryIntervalStart=tokenRingPHistoryIntervalStart, tokenRingMLStatsClaimTokenPkts=tokenRingMLStatsClaimTokenPkts, sourceRoutingStats3HopsFrames=sourceRoutingStats3HopsFrames, sourceRoutingStatsOwner=sourceRoutingStatsOwner, sourceRoutingStatsIfIndex=sourceRoutingStatsIfIndex, tokenRingMLStatsBurstErrors=tokenRingMLStatsBurstErrors, tokenRingPStatsDataPkts1024to2047Octets=tokenRingPStatsDataPkts1024to2047Octets, tokenRingPHistoryDataPkts8192to18000Octets=tokenRingPHistoryDataPkts8192to18000Octets, ringStationControlTableSize=ringStationControlTableSize, tokenRingMLStatsSoftErrorReports=tokenRingMLStatsSoftErrorReports, tokenRingPStatsDataPkts256to511Octets=tokenRingPStatsDataPkts256to511Octets, tokenRingPHistoryDataOctets=tokenRingPHistoryDataOctets, sourceRoutingStatsLocalLLCFrames=sourceRoutingStatsLocalLLCFrames, ringStationControlBeaconSender=ringStationControlBeaconSender, sourceRoutingStatsEntry=sourceRoutingStatsEntry, tokenRingMLHistoryBeaconEvents=tokenRingMLHistoryBeaconEvents, tokenRingPStatsEntry=tokenRingPStatsEntry, tokenRingPHistorySampleIndex=tokenRingPHistorySampleIndex, tokenRingPHistoryDataPkts2048to4095Octets=tokenRingPHistoryDataPkts2048to4095Octets, ringStationConfigFunctionalAddress=ringStationConfigFunctionalAddress, tokenRingPHistoryDataPkts18to63Octets=tokenRingPHistoryDataPkts18to63Octets, tokenRingMLStatsMacPkts=tokenRingMLStatsMacPkts, tokenRingPHistoryDropEvents=tokenRingPHistoryDropEvents, sourceRoutingStats4HopsFrames=sourceRoutingStats4HopsFrames, tokenRingPHistoryDataPkts128to255Octets=tokenRingPHistoryDataPkts128to255Octets, tokenRingMLHistoryActiveStations=tokenRingMLHistoryActiveStations, tokenRingMLHistoryDropEvents=tokenRingMLHistoryDropEvents, ringStationConfigLocation=ringStationConfigLocation, tokenRingMLStatsRingPollEvents=tokenRingMLStatsRingPollEvents, tokenRingPStatsDataPktsGreaterThan18000Octets=tokenRingPStatsDataPktsGreaterThan18000Octets, tokenRingPHistoryEntry=tokenRingPHistoryEntry, tokenRingPStatsDataPkts64to127Octets=tokenRingPStatsDataPkts64to127Octets, ringStationFrequencyErrors=ringStationFrequencyErrors)
