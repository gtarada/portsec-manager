...
mibBuilder.exportSymbols("EtherLike-MIB", dot3Compliance=dot3Compliance, dot3PauseAdminMode=dot3PauseAdminMode, dot3ErrorInitError=dot3ErrorInitError, dot3CollCount=dot3CollCount, dot3CollEntry=dot3CollEntry, dot3ControlEntry=dot3ControlEntry, dot3OutPauseFrames=dot3OutPauseFrames, dot3StatsDeferredTransmissions=dot3StatsDeferredTransmissions, dot3ControlFunctionsSupported=dot3ControlFunctionsSupported, etherCollisionTableGroup=etherCollisionTableGroup, dot3Tests=dot3Tests, dot3StatsFCSErrors=dot3StatsFCSErrors, dot3TestTdr=dot3TestTdr, dot3StatsInternalMacReceiveErrors=dot3StatsInternalMacReceiveErrors, dot3StatsDuplexStatus=dot3StatsDuplexStatus, dot3PauseOperMode=dot3PauseOperMode, etherCompliances=etherCompliances, PYSNMP_MODULE_ID=etherMIB, etherStatsBaseGroup=etherStatsBaseGroup, dot3StatsSQETestErrors=dot3StatsSQETestErrors, dot3InPauseFrames=dot3InPauseFrames, dot3StatsSymbolErrors=dot3StatsSymbolErrors, etherMIB=etherMIB, dot3CollTable=dot3CollTable, dot3StatsAlignmentErrors=dot3StatsAlignmentErrors, etherConformance=etherConformance, etherStats100MbsGroup=etherStats100MbsGroup, etherStatsLowSpeedGroup=etherStatsLowSpeedGroup, dot3=dot3, ether100MbsCompliance=ether100MbsCompliance, etherCompliance=etherCompliance, dot3StatsMultipleCollisionFrames=dot3StatsMultipleCollisionFrames, dot3StatsInternalMacTransmitErrors=dot3StatsInternalMacTransmitErrors, etherControlGroup=etherControlGroup, dot3StatsIndex=dot3StatsIndex, dot3ErrorLoopbackError=dot3ErrorLoopbackError, dot3Errors=dot3Errors, etherControlPauseGroup=etherControlPauseGroup, dot3StatsExcessiveCollisions=dot3StatsExcessiveCollisions, etherMIBObjects=etherMIBObjects, dot3StatsFrameTooLongs=dot3StatsFrameTooLongs, dot3StatsEtherChipSet=dot3StatsEtherChipSet, dot3CollFrequencies=dot3CollFrequencies, etherDuplexGroup=etherDuplexGroup, dot3TestLoopBack=dot3TestLoopBack, etherStatsGroup=etherStatsGroup, dot3StatsTable=dot3StatsTable, dot3StatsSingleCollisionFrames=dot3StatsSingleCollisionFrames, dot3StatsCarrierSenseErrors=dot3StatsCarrierSenseErrors, dot3StatsLateCollisions=dot3StatsLateCollisions, dot3ControlInUnknownOpcodes=dot3ControlInUnknownOpcodes, etherStatsHighSpeedGroup=etherStatsHighSpeedGroup, dot3PauseTable=dot3PauseTable, dot3StatsEntry=dot3StatsEntry, etherGroups=etherGroups, dot3PauseEntry=dot3PauseEntry, dot3ControlTable=dot3ControlTable)
