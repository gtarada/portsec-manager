...
Gauge32, ObjectIdentity, Unsigned32, Counter32, transmission, NotificationType, TimeTicks, MibIdentifier, ModuleIdentity, Bits, Counter64, Integer32, IpAddress, mib_2, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Unsigned32", "Counter32", "transmission", "NotificationType", "TimeTicks", "MibIdentifier", "ModuleIdentity", "Bits", "Counter64", "Integer32", "IpAddress", "mib-2", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("EtherLike-MIB", dot3StatsSQETestErrors=dot3StatsSQETestErrors, dot3PauseAdminMode=dot3PauseAdminMode, dot3PauseEntry=dot3PauseEntry, dot3Errors=dot3Errors, dot3StatsTable=dot3StatsTable, dot3InPauseFrames=dot3InPauseFrames, dot3OutPauseFrames=dot3OutPauseFrames, dot3ControlInUnknownOpcodes=dot3ControlInUnknownOpcodes, etherGroups=etherGroups, etherStatsHighSpeedGroup=etherStatsHighSpeedGroup, dot3StatsEtherChipSet=dot3StatsEtherChipSet, dot3TestLoopBack=dot3TestLoopBack, etherMIBObjects=etherMIBObjects, etherControlPauseGroup=etherControlPauseGroup, dot3Tests=dot3Tests, etherStatsGroup=etherStatsGroup, dot3StatsExcessiveCollisions=dot3StatsExcessiveCollisions, dot3CollCount=dot3CollCount, PYSNMP_MODULE_ID=etherMIB, etherStatsBaseGroup=etherStatsBaseGroup, dot3StatsCarrierSenseErrors=dot3StatsCarrierSenseErrors, dot3CollEntry=dot3CollEntry, dot3PauseTable=dot3PauseTable, dot3StatsFrameTooLongs=dot3StatsFrameTooLongs, dot3StatsDeferredTransmissions=dot3StatsDeferredTransmissions, etherMIB=etherMIB, dot3StatsInternalMacTransmitErrors=dot3StatsInternalMacTransmitErrors, dot3StatsLateCollisions=dot3StatsLateCollisions, dot3ErrorInitError=dot3ErrorInitError, dot3StatsDuplexStatus=dot3StatsDuplexStatus, dot3ErrorLoopbackError=dot3ErrorLoopbackError, etherCompliance=etherCompliance, dot3StatsSymbolErrors=dot3StatsSymbolErrors, dot3ControlFunctionsSupported=dot3ControlFunctionsSupported, dot3StatsEntry=dot3StatsEntry, etherStatsLowSpeedGroup=etherStatsLowSpeedGroup, etherControlGroup=etherControlGroup, dot3ControlTable=dot3ControlTable, etherConformance=etherConformance, dot3CollTable=dot3CollTable, dot3CollFrequencies=dot3CollFrequencies, dot3StatsAlignmentErrors=dot3StatsAlignmentErrors, dot3StatsSingleCollisionFrames=dot3StatsSingleCollisionFrames, dot3StatsFCSErrors=dot3StatsFCSErrors, dot3=dot3, dot3TestTdr=dot3TestTdr, etherStats100MbsGroup=etherStats100MbsGroup, etherDuplexGroup=etherDuplexGroup, dot3ControlEntry=dot3ControlEntry, dot3Compliance=dot3Compliance, etherCollisionTableGroup=etherCollisionTableGroup, dot3StatsMultipleCollisionFrames=dot3StatsMultipleCollisionFrames, etherCompliances=etherCompliances, ether100MbsCompliance=ether100MbsCompliance, dot3StatsIndex=dot3StatsIndex, dot3StatsInternalMacReceiveErrors=dot3StatsInternalMacReceiveErrors, dot3PauseOperMode=dot3PauseOperMode)
