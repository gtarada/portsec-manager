...
TimeTicks, Counter32, IpAddress, MibIdentifier, Integer32, ModuleIdentity, iso, ObjectIdentity, Unsigned32, mib_2, NotificationType, Gauge32, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "IpAddress", "MibIdentifier", "Integer32", "ModuleIdentity", "iso", "ObjectIdentity", "Unsigned32", "mib-2", "NotificationType", "Gauge32", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TruthValue, TimeStamp, TextualConvention, AutonomousType, PhysAddress, TestAndIncr, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "TextualConvention", "AutonomousType", "PhysAddress", "TestAndIncr", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifInOctets=ifInOctets, OwnerString=OwnerString, ifFixedLengthGroup=ifFixedLengthGroup, InterfaceIndex=InterfaceIndex, ifHCFixedLengthGroup=ifHCFixedLengthGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHighSpeed=ifHighSpeed, ifMIBObjects=ifMIBObjects, ifOutNUcastPkts=ifOutNUcastPkts, ifStackGroup2=ifStackGroup2, ifHCInOctets=ifHCInOctets, ifLastChange=ifLastChange, ifOutUcastPkts=ifOutUcastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifTestGroup=ifTestGroup, ifSpeed=ifSpeed, ifInMulticastPkts=ifInMulticastPkts, ifTestTable=ifTestTable, ifGeneralGroup=ifGeneralGroup, ifTable=ifTable, linkDown=linkDown, ifOutMulticastPkts=ifOutMulticastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifXEntry=ifXEntry, ifPromiscuousMode=ifPromiscuousMode, ifXTable=ifXTable, ifHCInUcastPkts=ifHCInUcastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, linkUp=linkUp, ifType=ifType, ifAdminStatus=ifAdminStatus, ifHCOutUcastPkts=ifHCOutUcastPkts, interfaces=interfaces, ifTestType=ifTestType, ifOldObjectsGroup=ifOldObjectsGroup, ifOutDiscards=ifOutDiscards, ifConformance=ifConformance, ifStackLastChange=ifStackLastChange, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackStatus=ifStackStatus, ifMIB=ifMIB, ifAlias=ifAlias, ifTableLastChange=ifTableLastChange, ifInErrors=ifInErrors, ifOutQLen=ifOutQLen, ifRcvAddressTable=ifRcvAddressTable, ifStackEntry=ifStackEntry, ifEntry=ifEntry, ifDescr=ifDescr, ifRcvAddressStatus=ifRcvAddressStatus, ifVHCPacketGroup=ifVHCPacketGroup, ifCompliance3=ifCompliance3, ifHCInMulticastPkts=ifHCInMulticastPkts, ifHCPacketGroup=ifHCPacketGroup, ifTestStatus=ifTestStatus, ifTestId=ifTestId, ifNumber=ifNumber, ifOperStatus=ifOperStatus, ifStackHigherLayer=ifStackHigherLayer, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifCompliance=ifCompliance, ifInNUcastPkts=ifInNUcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifCompliance2=ifCompliance2, ifOutOctets=ifOutOctets, ifTestCode=ifTestCode, ifStackTable=ifStackTable, ifStackGroup=ifStackGroup, ifGroups=ifGroups, ifInUnknownProtos=ifInUnknownProtos, ifOutErrors=ifOutErrors, ifSpecific=ifSpecific, ifRcvAddressType=ifRcvAddressType, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifInDiscards=ifInDiscards, ifInUcastPkts=ifInUcastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifPacketGroup=ifPacketGroup, ifConnectorPresent=ifConnectorPresent, ifCompliances=ifCompliances, ifStackLowerLayer=ifStackLowerLayer, ifName=ifName, ifHCOutMulticastPkts=ifHCOutMulticastPkts, PYSNMP_MODULE_ID=ifMIB, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHCOutOctets=ifHCOutOctets, ifRcvAddressAddress=ifRcvAddressAddress, ifIndex=ifIndex, ifMtu=ifMtu, ifTestOwner=ifTestOwner, ifPhysAddress=ifPhysAddress, ifTestEntry=ifTestEntry, ifTestResult=ifTestResult, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable)
