...
# Produced by pysmi-0.3.4 at Fri Aug 27 22:55:28 2021
...
TimeTicks, IpAddress, Counter32, MibIdentifier, Integer32, ModuleIdentity, iso, ObjectIdentity, Unsigned32, NotificationType, Gauge32, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "Counter32", "MibIdentifier", "Integer32", "ModuleIdentity", "iso", "ObjectIdentity", "Unsigned32", "NotificationType", "Gauge32", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CISCO-STACK-MIB", traceRouteQueryTable=traceRouteQueryTable, vlanGroup1=vlanGroup1, sysTrafficMeterPeakTime=sysTrafficMeterPeakTime, sysBroadcast=sysBroadcast, chassisPEMInstalled=chassisPEMInstalled, vlanPortSwitchLevel=vlanPortSwitchLevel, dnsServerType=dnsServerType, filterGroup3=filterGroup3, filterTestValue=filterTestValue, tokenRingPortSoftErrReportInterval=tokenRingPortSoftErrReportInterval, portTopNGrp=portTopNGrp, moduleUp=moduleUp, dnsGrp=dnsGrp, sysAttachType=sysAttachType, wsc2948ggetxsysID=wsc2948ggetxsysID, wsc4506sysID=wsc4506sysID, ntpBcastClient=ntpBcastClient, cpw1600sysID=cpw1600sysID, wsc3920sysID=wsc3920sysID, voicePortIfIpAddress=voicePortIfIpAddress, portAdminTxFlowControl=portAdminTxFlowControl, cpw2200sysID=cpw2200sysID, moduleIndex=moduleIndex, brouterIpx8022ToEther=brouterIpx8022ToEther, filterTestEntry=filterTestEntry, fileCopyResult=fileCopyResult, filterProtocolEntry=filterProtocolEntry, mdgGatewayTable=mdgGatewayTable, tacacsServerEntry=tacacsServerEntry, traceRouteQueryUDPPort=traceRouteQueryUDPPort, moduleStatus=moduleStatus, filterTestPort=filterTestPort, ntpServerTable=ntpServerTable, portCpbEntry=portCpbEntry, portTopNStartTime=portTopNStartTime, portIndex=portIndex, sysCommunityRwa=sysCommunityRwa, fileCopyDstFileName=fileCopyDstFileName, vlanPortEntry=vlanPortEntry, voicePortOperDnsServerSource=voicePortOperDnsServerSource, moduleFwVersion=moduleFwVersion, dcd=dcd, sysFddiRingEntry=sysFddiRingEntry, sysConsolePrimaryEnableAuthentication=sysConsolePrimaryEnableAuthentication, fileCopySrcFileName=fileCopySrcFileName, switchAccelerationModuleTable=switchAccelerationModuleTable, wsc5500sysID=wsc5500sysID, vlanPort=vlanPort, configGrp=configGrp, optionalChassisGroup=optionalChassisGroup, sysTrapReceiverType=sysTrapReceiverType, sysStatus=sysStatus, ipPermitDeniedTrap=ipPermitDeniedTrap, voicePortModuleIndex=voicePortModuleIndex, wsc1200sysID=wsc1200sysID, portMacControlReceiveFrames=portMacControlReceiveFrames, portGroup=portGroup, mcastEnableRgmp=mcastEnableRgmp, brouterGrp=brouterGrp, portTopNIndex=portTopNIndex, tokenRingDripAdvertsProcessed=tokenRingDripAdvertsProcessed, ipPermitDeniedAccess=ipPermitDeniedAccess, voicePortCallManagerTable=voicePortCallManagerTable, optionalSystemMiscGroup4=optionalSystemMiscGroup4, portTopNPortNumber=portTopNPortNumber, tsStack=tsStack, systemTrafficGroup=systemTrafficGroup, portSecurityExtSecureSrcAddr=portSecurityExtSecureSrcAddr, portCpbChannel=portCpbChannel, moduleSwHiVersion=moduleSwHiVersion, portSecurityPortIndex=portSecurityPortIndex, chassisNumSlots=chassisNumSlots, fileCopyGrp=fileCopyGrp, ciscoStackgMIBCompliance6=ciscoStackgMIBCompliance6, chassisSerialNumberString=chassisSerialNumberString, portTopNControlIndex=portTopNControlIndex, filterTestType=filterTestType, radiusDeadtime=radiusDeadtime, wsc2948gsysID=wsc2948gsysID, tokenRingDripLocalNodeID=tokenRingDripLocalNodeID, filterPortComplex=filterPortComplex, brouteEnableGroup=brouteEnableGroup, sysClearMacTime=sysClearMacTime, fileCopyUserName=fileCopyUserName, wsc6513sysID=wsc6513sysID, dnsServerAddr=dnsServerAddr, vmpsGroup=vmpsGroup, sysCommunityAccess=sysCommunityAccess, portTopNInErrors=portTopNInErrors, brouterEnableUnreachables=brouterEnableUnreachables, vlanTrunkMappingOper=vlanTrunkMappingOper, syslogGroup2=syslogGroup2, traceRouteMaxQueries=traceRouteMaxQueries, portGrp=portGrp, portCpbSecurity=portCpbSecurity, sysStartupConfigSourceFile=sysStartupConfigSourceFile, tokenRingDripLastChangedRevision=tokenRingDripLastChangedRevision, vlanGroup=vlanGroup, portName=portName, syslogMessageSeverity=syslogMessageSeverity, moduleName=moduleName, moduleNumPorts=moduleNumPorts, systemStatusGroup=systemStatusGroup, portModuleIndex=portModuleIndex, moduleEntPhysicalIndex=moduleEntPhysicalIndex, filterTestTable=filterTestTable, portTopNReportStatus=portTopNReportStatus, ciscoStackNotificationsPrefix=ciscoStackNotificationsPrefix, vlanTrunkMappingGroup=vlanTrunkMappingGroup, sysEnableIpPermitTraps=sysEnableIpPermitTraps, vlanTrunkMappingFromVlan=vlanTrunkMappingFromVlan, ntpAuthenticationTrustedMode=ntpAuthenticationTrustedMode, portOperRxFlowControl=portOperRxFlowControl, vlanSpantreeEnable=vlanSpantreeEnable, sysPortFastBpduGuard=sysPortFastBpduGuard, chassisFanTestResult=chassisFanTestResult, filterPortTable=filterPortTable, optionalChassisGroup1=optionalChassisGroup1, chassisPs3Type=chassisPs3Type, wsc3200sysID=wsc3200sysID, portChannelNeighbourPortId=portChannelNeighbourPortId, chassisSlotConfig=chassisSlotConfig, voicePortIndex=voicePortIndex, wsc1100sysID=wsc1100sysID, portCpbGroup5=portCpbGroup5, syslogGroup=syslogGroup, portSecurityExtModuleIndex=portSecurityExtModuleIndex, vlanEntry=vlanEntry, tftpFile=tftpFile, portSecurityGroup1=portSecurityGroup1, wsc5509sysID=wsc5509sysID, vlanIfIndex=vlanIfIndex, cisco7613sysID=cisco7613sysID, ciscoStackMIBConformance=ciscoStackMIBConformance, brouterEnableGiantCheck=brouterEnableGiantCheck, portCpbDuplex=portCpbDuplex, voicePortDnsModuleIndex=voicePortDnsModuleIndex, sysFddiRingNext=sysFddiRingNext, ntpAuthenticationTable=ntpAuthenticationTable, wsc6503sysID=wsc6503sysID, moduleSerialNumber=moduleSerialNumber, portCpbGroup4=portCpbGroup4, portCpbGrp=portCpbGrp, optionalSystemMiscGroup5=optionalSystemMiscGroup5, radiusEnableAuthentication=radiusEnableAuthentication, wsc6006sysID=wsc6006sysID, sysReset=sysReset, brouterPortBroadcast=brouterPortBroadcast, filterPortBroadcastThrottle=filterPortBroadcastThrottle, vlanPortIslPriorityVlans=vlanPortIslPriorityVlans, ntpSummerTimezoneName=ntpSummerTimezoneName, portCpbSpeed=portCpbSpeed, tacacsGrp=tacacsGrp, mcastRouterAdminStatus=mcastRouterAdminStatus, ntpBcastDelay=ntpBcastDelay, tokenRingPortSoftErrEnable=tokenRingPortSoftErrEnable, systemMiscGroup1=systemMiscGroup1, portIfIndex=portIfIndex, portCpbGroup3=portCpbGroup3, cpw1220isysID=cpw1220isysID, cisco7604sysID=cisco7604sysID, portCpbBroadcastSuppression=portCpbBroadcastSuppression, vlanPortModule=vlanPortModule, brouterEnableFddiCheck=brouterEnableFddiCheck, filterPortEntry=filterPortEntry, portCpbCopsGrouping=portCpbCopsGrouping, portTopNModuleNumber=portTopNModuleNumber, tokenRingPortPriorityThresh=tokenRingPortPriorityThresh, systemFddiGroup=systemFddiGroup, ciscoStackgMIBCompliance2=ciscoStackgMIBCompliance2, brouterFddiTransmitMax=brouterFddiTransmitMax, chassisComponentEntry=chassisComponentEntry, sysExtendedRmonNetflowPassword=sysExtendedRmonNetflowPassword, ipPermitGroup2=ipPermitGroup2, wsc3001sysID=wsc3001sysID, sysExtendedRmonVlanAgentEnable=sysExtendedRmonVlanAgentEnable, mcastGroup1=mcastGroup1, sysCommunityRo=sysCommunityRo, wsc6009sysID=wsc6009sysID, brouterIpx8023RawToFddi=brouterIpx8023RawToFddi, vlanIndex=vlanIndex, portSecurityExtTable=portSecurityExtTable, tokenRingDripLocalVlanStatusTable=tokenRingDripLocalVlanStatusTable, sysEnableEntityTrap=sysEnableEntityTrap, sysClearPortTime=sysClearPortTime, vlanTrunkMappingToVlan=vlanTrunkMappingToVlan, cpw1800sysID=cpw1800sysID, voicePortCallManagerEntry=voicePortCallManagerEntry, tokenRingPortTable=tokenRingPortTable, ciscoStackgMIBCompliance3=ciscoStackgMIBCompliance3, filterVendorEntry=filterVendorEntry, cpw1220csysID=cpw1220csysID, configWriteMemStatus=configWriteMemStatus, chassisPs2Type=chassisPs2Type, syslogGrp=syslogGrp, portSecurityTable=portSecurityTable, traceRouteQueryTOS=traceRouteQueryTOS, cpw1601sysID=cpw1601sysID, portCpbPortIndex=portCpbPortIndex, ntpAuthenticationEnable=ntpAuthenticationEnable, portJumboFrameGrp=portJumboFrameGrp, tacacsLoginAuthentication=tacacsLoginAuthentication, moduleSubType2=moduleSubType2, filterMacTable=filterMacTable, tokenRingDripRemotePortStatus=tokenRingDripRemotePortStatus, syslogServerEntry=syslogServerEntry, wsc6509sysID=wsc6509sysID, brouterFddiReceiveMax=brouterFddiReceiveMax, moduleEntry=moduleEntry, vlanTable=vlanTable, optionalSystemMiscGroup2=optionalSystemMiscGroup2, fileCopyModuleNumber=fileCopyModuleNumber, sysTrapReceiverEntry=sysTrapReceiverEntry, radiusServerTable=radiusServerTable, brouterCamAgingTime=brouterCamAgingTime, syslogServerAddr=syslogServerAddr, portCpbUdld=portCpbUdld, portCpbGroup1=portCpbGroup1, ntpAuthenticationPublicKey=ntpAuthenticationPublicKey, sysEnableModem=sysEnableModem, chassisSysType=chassisSysType, notificationGroup=notificationGroup, traceRouteQueryStatus=traceRouteQueryStatus, portTopNOwner=portTopNOwner, sysCommunityTable=sysCommunityTable, portCpbDot1x=portCpbDot1x, portEntPhysicalIndex=portEntPhysicalIndex, cisco7606sysID=cisco7606sysID, tokenRingPortPriorityMinXmit=tokenRingPortPriorityMinXmit, portJumboFrameTable=portJumboFrameTable, filterTestModule=filterTestModule, sysConsolePrimaryLoginAuthentication=sysConsolePrimaryLoginAuthentication, monitorSourcePort=monitorSourcePort, voiceGroup=voiceGroup, sysTrafficPeak=sysTrafficPeak, portTopNType=portTopNType, sysNetMask=sysNetMask, sysHighAvailabilityNotRunningReason=sysHighAvailabilityNotRunningReason, tokenRingPortSoftErrThresh=tokenRingPortSoftErrThresh, moduleFwLoVersion=moduleFwLoVersion, brouterPortIpAddr=brouterPortIpAddr, tokenRingDripRemotePortConfigured=tokenRingDripRemotePortConfigured, sysConfigChangeInfo=sysConfigChangeInfo, portSecurityEntry=portSecurityEntry, authenticationGroup1=authenticationGroup1, wsc1000sysID=wsc1000sysID, moduleHwLoVersion=moduleHwLoVersion, portCrossIndex=portCrossIndex, voicePortDnsPortIndex=voicePortDnsPortIndex, filterPortSuppressionViolation=filterPortSuppressionViolation, ntpServerAddress=ntpServerAddress, configMode=configMode, vlanPortOperStatus=vlanPortOperStatus, wsc4912gsysID=wsc4912gsysID)
mibBuilder.exportSymbols("CISCO-STACK-MIB", wsc2980gasysID=wsc2980gasysID, tokenRingDripBackupCrf=tokenRingDripBackupCrf, voicePortIfConfigPortIndex=voicePortIfConfigPortIndex, ipPermitAddress=ipPermitAddress, syslogTelnetEnable=syslogTelnetEnable, portTopNIOBroadcast=portTopNIOBroadcast, moduleSwLoVersion=moduleSwLoVersion, vlanPortIslAdminStatus=vlanPortIslAdminStatus, portGroup3=portGroup3, mdgGatewayEntry=mdgGatewayEntry, wsc3900sysID=wsc3900sysID, portChannelTable=portChannelTable, tacacsLocalLoginAuthentication=tacacsLocalLoginAuthentication, ciscoStackMIBCompliances=ciscoStackMIBCompliances, ciscoStackgMIBCompliance5=ciscoStackgMIBCompliance5, monitorGroup=monitorGroup, portAdminSpeed=portAdminSpeed, monitorDirection=monitorDirection, ipPermitType=ipPermitType, sysTrafficPeakTime=sysTrafficPeakTime, radiusServerType=radiusServerType, tftpModule=tftpModule, syslogMessageControlTable=syslogMessageControlTable, portSecurityViolationPolicy=portSecurityViolationPolicy, sysEnableRedirects=sysEnableRedirects, filterGroup2=filterGroup2, portTopNIOOctets=portTopNIOOctets, voicePortIfConfigModuleIndex=voicePortIfConfigModuleIndex, filterPortModule=filterPortModule, brouterEnableAPaRT=brouterEnableAPaRT, traceRouteQueryResult=traceRouteQueryResult, wsc4006sysID=wsc4006sysID, wsc1600sysID=wsc1600sysID, tokenRingDripLastRevision=tokenRingDripLastRevision, chassisMinorAlarm=chassisMinorAlarm, systemMiscGroup=systemMiscGroup, voicePortIfIpNetMask=voicePortIfIpNetMask, filterPort=filterPort, sysEnableModuleTraps=sysEnableModuleTraps, portLinkFaultStatus=portLinkFaultStatus, sysConfigChangeTime=sysConfigChangeTime, systemTrapGroup2=systemTrapGroup2, brouterPortTable=brouterPortTable, tokenRingPortMode=tokenRingPortMode, portMacControlPauseReceiveFrames=portMacControlPauseReceiveFrames, syslogHostEnable=syslogHostEnable, tacacsNumLoginAttempts=tacacsNumLoginAttempts, voicePortOperDnsServerIndex=voicePortOperDnsServerIndex, sysIpAddr=sysIpAddr, portSecurityAdminStatus=portSecurityAdminStatus, wsc3100sysID=wsc3100sysID, mdgGrp=mdgGrp, chassisComponentTable=chassisComponentTable, brouterCamMode=brouterCamMode, tokenRingDripAdvertsTransmitted=tokenRingDripAdvertsTransmitted, ipPermitDeniedAddress=ipPermitDeniedAddress, wsc4503sysID=wsc4503sysID, portChannelProtInPackets=portChannelProtInPackets, traceRouteQueryPacketSize=traceRouteQueryPacketSize, vlanGroup2=vlanGroup2, tftpResult=tftpResult, mcastRouterTable=mcastRouterTable, filterVendorId=filterVendorId, sysEnableBridgeTraps=sysEnableBridgeTraps, tftpGroup=tftpGroup, cpw1420sysID=cpw1420sysID, portJumboFrameModuleIndex=portJumboFrameModuleIndex, moduleType=moduleType, monitorGrp=monitorGrp, sysBaudRate=sysBaudRate, sysTrapReceiverTable=sysTrapReceiverTable, voicePortIfConfigEntry=voicePortIfConfigEntry, portGroup4=portGroup4, wsc2980gsysID=wsc2980gsysID, sysTrafficMonitorHighWaterMark=sysTrafficMonitorHighWaterMark, voicePortIfDnsDomain=voicePortIfDnsDomain, vlanPortVlan=vlanPortVlan, chassisPs1TestResult=chassisPs1TestResult, portChannelModuleIndex=portChannelModuleIndex, ipPermitAccessTypeEnable=ipPermitAccessTypeEnable, portTable=portTable, sysStartupConfigSource=sysStartupConfigSource, portChannelEntry=portChannelEntry, traceRouteDataGatewayName=traceRouteDataGatewayName, ipPermitGroup1=ipPermitGroup1, authenticationGroup2=authenticationGroup2, syslogServerType=syslogServerType, vmpsAccessed=vmpsAccessed, radiusGrp=radiusGrp, sysFddiRingSMTIndex=sysFddiRingSMTIndex, traceRouteDataGatewayIp=traceRouteDataGatewayIp, portMacControlPauseTransmitFrames=portMacControlPauseTransmitFrames, tokenRingGroup=tokenRingGroup, voicePortIfGatewayAddress=voicePortIfGatewayAddress, sysExtendedRmonVlanModeEnable=sysExtendedRmonVlanModeEnable, portTopNStatus=portTopNStatus, moduleDown=moduleDown, filterTestMask=filterTestMask, sysTrapReceiverAddr=sysTrapReceiverAddr, vlanPortAuxiliaryVlan=vlanPortAuxiliaryVlan, radiusLoginAuthentication=radiusLoginAuthentication, chassisGrp=chassisGrp, vlanPortTable=vlanPortTable, ntpServerType=ntpServerType, chassisModel=chassisModel, tokenRingDripDistributedCrf=tokenRingDripDistributedCrf, voicePortIfDnsServerAddress=voicePortIfDnsServerAddress, esStack=esStack, portMacControlTransmitFrames=portMacControlTransmitFrames, moduleSwVersion=moduleSwVersion, vlanGrp=vlanGrp, sysCommunityEntry=sysCommunityEntry, sysStandbyPortEnable=sysStandbyPortEnable, syslogConsoleEnable=syslogConsoleEnable, tokenRingPortSoftErrLastCounterReset=tokenRingPortSoftErrLastCounterReset, chassisPs1Type=chassisPs1Type, vlanPortAdminStatus=vlanPortAdminStatus, wsc6506sysID=wsc6506sysID, tokenRingModuleIndex=tokenRingModuleIndex, sysFddiRingAddress=sysFddiRingAddress, radiusServerAddr=radiusServerAddr, wsc1900sysID=wsc1900sysID, adapterCard=adapterCard, portCpbSpan=portCpbSpan, sysHighAvailabilityEnable=sysHighAvailabilityEnable, sysErrDisableTimeoutEnable=sysErrDisableTimeoutEnable, portCpbFlowControl=portCpbFlowControl, brouterEnableTransitEncapsulation=brouterEnableTransitEncapsulation, portTopNIOMulticast=portTopNIOMulticast, wsc2926sysID=wsc2926sysID, chassisSerialNumber=chassisSerialNumber, portAdditionalStatus=portAdditionalStatus, ipPermitListTable=ipPermitListTable, traceRouteQueryTime=traceRouteQueryTime, traceRouteDataEntry=traceRouteDataEntry, mdgGatewayGroup=mdgGatewayGroup, switchAccelerationModuleEnable=switchAccelerationModuleEnable, filterProtocolValue=filterProtocolValue, ntpGroup=ntpGroup, filterProtocolTable=filterProtocolTable, sysTelnetPrimaryLoginAuthentication=sysTelnetPrimaryLoginAuthentication, traceRouteGrp=traceRouteGrp, mcastRouterEntry=mcastRouterEntry, brouterPortBridgeVlan=brouterPortBridgeVlan, voicePortOperDnsServerEntry=voicePortOperDnsServerEntry, wsc4003sysID=wsc4003sysID, filterTestIndex=filterTestIndex, portSecurityLastSrcAddr=portSecurityLastSrcAddr, brouterPortModule=brouterPortModule, portMacControlUnknownProtocolFrames=portMacControlUnknownProtocolFrames, filterGrp=filterGrp, sysTrafficMeter=sysTrafficMeter, mcastEnableCgmp=mcastEnableCgmp, sysEnableChassisTraps=sysEnableChassisTraps, portTopNDuration=portTopNDuration, chassisFanStatus=chassisFanStatus, monitorOperSourcePorts=monitorOperSourcePorts, filterTestOffset=filterTestOffset, vlanTrunkMappingEntry=vlanTrunkMappingEntry, switchAccelerationModuleGroup=switchAccelerationModuleGroup, lerAlarmOn=lerAlarmOn, ntpAuthenticationEntry=ntpAuthenticationEntry, modulePortStatus=modulePortStatus, sysTrafficMeterPeak=sysTrafficMeterPeak, cpw1900sysID=cpw1900sysID, ntpAuthenticationSecretKey=ntpAuthenticationSecretKey, sysCommunityRw=sysCommunityRw, wsc6504esysID=wsc6504esysID, tacacsAuthKey=tacacsAuthKey, mcastRouterOperStatus=mcastRouterOperStatus, tacacsServerType=tacacsServerType, portChannelOperStatus=portChannelOperStatus, tokenRingPortEntry=tokenRingPortEntry, tacacsDirectedRequest=tacacsDirectedRequest, portAdminRxFlowControl=portAdminRxFlowControl, tokenRingDripLocalVlanStatusEntry=tokenRingDripLocalVlanStatusEntry, mcastGroup=mcastGroup, sysMacReductionOperEnable=sysMacReductionOperEnable, tacacsEnableAuthentication=tacacsEnableAuthentication, ipPermitListEntry=ipPermitListEntry, tokenRingDripInputQueueDrops=tokenRingDripInputQueueDrops, portCpbIgmpFilter=portCpbIgmpFilter, chassisPs3TestResult=chassisPs3TestResult, ntpTimezoneOffsetHour=ntpTimezoneOffsetHour, filterVendorModule=filterVendorModule, ciscoStackgMIBCompliance=ciscoStackgMIBCompliance, sysEnableRepeaterTraps=sysEnableRepeaterTraps, brouterPortIpVlan=brouterPortIpVlan, wsc1900LiteFxsysID=wsc1900LiteFxsysID, fileCopyAction=fileCopyAction, traceRouteDataIndex=traceRouteDataIndex, ntpAuthenticationGroup=ntpAuthenticationGroup, tokenRingDripOwnerNodeID=tokenRingDripOwnerNodeID, wsc6knamsysID=wsc6knamsysID, portJumboFrameGroup=portJumboFrameGroup, chassisGroup1=chassisGroup1, portCpbCosRewrite=portCpbCosRewrite, systemRmonGroup=systemRmonGroup, chassisComponentHwVersion=chassisComponentHwVersion, portSecurityExtControlStatus=portSecurityExtControlStatus, portJumboFrameEntry=portJumboFrameEntry, portGroup1=portGroup1, tftpAction=tftpAction, portCpbInlinePower=portCpbInlinePower, VendorIdType=VendorIdType, portCpbTosRewrite=portCpbTosRewrite, tacacsServerTable=tacacsServerTable, sysConfigSupervisorModuleNo=sysConfigSupervisorModuleNo, sysTrafficMeterType=sysTrafficMeterType, wsc1400sysID=wsc1400sysID, ipPermitGroup=ipPermitGroup, sysEnableVmpsTraps=sysEnableVmpsTraps, tacacsLocalEnableAuthentication=tacacsLocalEnableAuthentication, optionalSystemTrapGroup=optionalSystemTrapGroup, traceRouteQueryInitTTL=traceRouteQueryInitTTL, portChannelIfIndex=portChannelIfIndex, moduleAction=moduleAction, syslogMessageControlEntry=syslogMessageControlEntry, portCpbAuxiliaryVlan=portCpbAuxiliaryVlan, voicePortIfConfigTable=voicePortIfConfigTable, fileCopyRuntimeConfigPart=fileCopyRuntimeConfigPart, syslogServerTable=syslogServerTable, sysEnableStpxTrap=sysEnableStpxTrap, lerAlarmOff=lerAlarmOff, moduleIPAddress=moduleIPAddress, traceRouteQueryMaxTTL=traceRouteQueryMaxTTL, sysBootedImage=sysBootedImage, ipPermitAccessType=ipPermitAccessType, chassisAlarmOn=chassisAlarmOn, brouterPortEntry=brouterPortEntry, wsc6509nebasysID=wsc6509nebasysID, moduleAdditionalStatus=moduleAdditionalStatus, wsc2820sysID=wsc2820sysID, tokenRingPortSoftErrResetCounters=tokenRingPortSoftErrResetCounters, portCpbVlanMembership=portCpbVlanMembership, mdgGatewayAddr=mdgGatewayAddr, traceRouteHost=traceRouteHost, portGroup2=portGroup2, ciscoStackMIB=ciscoStackMIB, tacacsServerAddr=tacacsServerAddr, sysEnableRmon=sysEnableRmon, voicePortIfDHCPEnabled=voicePortIfDHCPEnabled, systemTrapGroup=systemTrapGroup, tokenRingPortSetACbits=tokenRingPortSetACbits, sysExtendedRmonNetflowModuleMask=sysExtendedRmonNetflowModuleMask, voicePortOperDnsServerIpAddr=voicePortOperDnsServerIpAddr, portCpbGroup2=portCpbGroup2, configurationGroup=configurationGroup, traceRouteDataErrors=traceRouteDataErrors, chassisPs1Status=chassisPs1Status, portChannelGrp=portChannelGrp, sysMaxRmonMemory=sysMaxRmonMemory, portTopNUtilization=portTopNUtilization, chassisTempAlarm=chassisTempAlarm)
mibBuilder.exportSymbols("CISCO-STACK-MIB", fileCopyProtocol=fileCopyProtocol, portChannelAdminStatus=portChannelAdminStatus, optionalSystemMiscGroup6=optionalSystemMiscGroup6, tokenRingPortCfgLossThresh=tokenRingPortCfgLossThresh, moduleTable=moduleTable, portTopNTimeRemaining=portTopNTimeRemaining, authenticationGroup=authenticationGroup, monitorAdminSourcePorts=monitorAdminSourcePorts, filterGroup1=filterGroup1, ntpAuthenticationType=ntpAuthenticationType, portSecurityExtEntry=portSecurityExtEntry, ipPermitListGrp=ipPermitListGrp, sysIpVlan=sysIpVlan, portTopNRequestedSize=portTopNRequestedSize, tokenRingSoftErrExceededTrap=tokenRingSoftErrExceededTrap, wsc1900csysID=wsc1900csysID, switchAccelerationGrp=switchAccelerationGrp, dnsServerEntry=dnsServerEntry, moduleSerialNumberString=moduleSerialNumberString, portCpbTrunkMode=portCpbTrunkMode, filterMacEntry=filterMacEntry, mcastRouterModuleIndex=mcastRouterModuleIndex, filterVendorType=filterVendorType, moduleHwVersion=moduleHwVersion, moduleHwHiVersion=moduleHwHiVersion, deprecatedObjectGroup=deprecatedObjectGroup, sysMacReductionAdminEnable=sysMacReductionAdminEnable, voicePortCallManagerIndex=voicePortCallManagerIndex, sysTrapReceiverComm=sysTrapReceiverComm, filterPortBroadcastThresholdFraction=filterPortBroadcastThresholdFraction, portEntry=portEntry, portInlinePowerDetect=portInlinePowerDetect, wsc6509nebsysID=wsc6509nebsysID, brouterPortNetMask=brouterPortNetMask, syslogMessageFacility=syslogMessageFacility, voicePortCallManagerIpAddr=voicePortCallManagerIpAddr, ciscoStackMIBGroups=ciscoStackMIBGroups, wsc2900sysID=wsc2900sysID, radiusAuthKey=radiusAuthKey, dnsGroup=dnsGroup, ntpServerEntry=ntpServerEntry, brouterEnableIpFragmentation=brouterEnableIpFragmentation, portJumboFramePortIndex=portJumboFramePortIndex, tokenRingDripAdvertsReceived=tokenRingDripAdvertsReceived, switchAccelerationModuleIndex=switchAccelerationModuleIndex, tokenRingDripVlan=tokenRingDripVlan, mcastEnableIgmp=mcastEnableIgmp, syslogTimeStampOption=syslogTimeStampOption, optionalSystemMiscGroup1=optionalSystemMiscGroup1, filterProtocolPort=filterProtocolPort, chassisComponentModel=chassisComponentModel, monitorSourceModule=monitorSourceModule, portTopNEntry=portTopNEntry, optionalSystemTrapGroup1=optionalSystemTrapGroup1, radiusServerAuthPort=radiusServerAuthPort, moduleIPAddressVlan=moduleIPAddressVlan, moduleGroup=moduleGroup, sysErrDisableTimeoutInterval=sysErrDisableTimeoutInterval, wsc5000sysID=wsc5000sysID, ipPermitMask=ipPermitMask, ipPermitDeniedListTable=ipPermitDeniedListTable, portChannelProtOutPackets=portChannelProtOutPackets, sysHighAvailabilityVersioningEnable=sysHighAvailabilityVersioningEnable, dnsEnable=dnsEnable, systemGrp=systemGrp, chassisBkplType=chassisBkplType, systemRmonGroup2=systemRmonGroup2, monitorEnable=monitorEnable, portTopNGrantedSize=portTopNGrantedSize, switchAccelerationModuleEntry=switchAccelerationModuleEntry, moduleModel=moduleModel, brouterPortIpHelpers=brouterPortIpHelpers, wsc5002sysID=wsc5002sysID, portTopNMode=portTopNMode, sysHighAvailabilityOperStatus=sysHighAvailabilityOperStatus, filterMacAddress=filterMacAddress, moduleGrp=moduleGrp, sysBannerMotd=sysBannerMotd, chassisPs2Status=chassisPs2Status, wsc5505sysID=wsc5505sysID, vlanTrunkMappingMax=vlanTrunkMappingMax, cisco7603sysID=cisco7603sysID, portOperTxFlowControl=portOperTxFlowControl, ipPermitEnable=ipPermitEnable, configWriteMem=configWriteMem, monitorDestinationPort=monitorDestinationPort, tokenRingPortSoftErrEntry=tokenRingPortSoftErrEntry, cisco7609sysID=cisco7609sysID, portSecurityModuleIndex=portSecurityModuleIndex, configTextFileLocation=configTextFileLocation, portAdditionalOperStatus=portAdditionalOperStatus, sysEnableConfigTraps=sysEnableConfigTraps, portSecurityOperStatus=portSecurityOperStatus, portTopNIOPkts=portTopNIOPkts, sysTraffic=sysTraffic, portTopNControlTable=portTopNControlTable, vmpsEntry=vmpsEntry, portSecurityMaxSrcAddr=portSecurityMaxSrcAddr, brouterEnableSpantree=brouterEnableSpantree, ciscoStackgMIBCompliance7=ciscoStackgMIBCompliance7, portJumboFrameEnable=portJumboFrameEnable, fileCopyGroup2=fileCopyGroup2, tacacsTimeout=tacacsTimeout, moduleTestResult=moduleTestResult, sysCommunityString=sysCommunityString, wsc1900isysID=wsc1900isysID, tokenRingDripLocalPortStatus=tokenRingDripLocalPortStatus, traceRouteDataTable=traceRouteDataTable, filterMacType=filterMacType, portSecuritySecureSrcAddr=portSecuritySecureSrcAddr, sysFddiRingTable=sysFddiRingTable, chassisComponentSerialNumber=chassisComponentSerialNumber, traceRouteQueryEntry=traceRouteQueryEntry, ntpClient=ntpClient, voiceGrp=voiceGrp, brouterEthernetTransmitMax=brouterEthernetTransmitMax, ntpServerPublicKey=ntpServerPublicKey, systemTrapGroup1=systemTrapGroup1, ipPermitDeniedTime=ipPermitDeniedTime, sysExtendedRmonEnable=sysExtendedRmonEnable, traceRouteQueryPacketCount=traceRouteQueryPacketCount, tokenRingPortIndex=tokenRingPortIndex, traceRouteGroup=traceRouteGroup, portCpbTable=portCpbTable, portOperStatus=portOperStatus, optionalSystemMiscGroup=optionalSystemMiscGroup, filterPortBroadcastThreshold=filterPortBroadcastThreshold, filterProtocolModule=filterProtocolModule, brouterEnableRip=brouterEnableRip, tokenRingDripOutputQueueDrops=tokenRingDripOutputQueueDrops, chassisGroup=chassisGroup, monitorDestinationModule=monitorDestinationModule, ntpGrp=ntpGrp, sysTrafficMeterEntry=sysTrafficMeterEntry, ntpTimezoneOffsetMinute=ntpTimezoneOffsetMinute, portSecurityShutdownTimeOut=portSecurityShutdownTimeOut, optionalPortGroup1=optionalPortGroup1, portDuplex=portDuplex, tftpHost=tftpHost, tftpGrp=tftpGrp, filterVendorTable=filterVendorTable, chassisComponentIndex=chassisComponentIndex, sysArpAgingTime=sysArpAgingTime, portSecurityAgingTime=portSecurityAgingTime, moduleSlotNum=moduleSlotNum, portSecurityExtPortIndex=portSecurityExtPortIndex, portCpbTrunkEncapsulationType=portCpbTrunkEncapsulationType, portTopNControlEntry=portTopNControlEntry, vmpsTable=vmpsTable, traceRouteDataRtt=traceRouteDataRtt, portChannelPorts=portChannelPorts, portSpantreeFastStart=portSpantreeFastStart, vlanTrunkMappingType=vlanTrunkMappingType, tokenRingDripDistCrfMode=tokenRingDripDistCrfMode, radiusServerEntry=radiusServerEntry, vlanTrunkMappingStatus=vlanTrunkMappingStatus, portTopNTable=portTopNTable, traceRouteQueryDNSEnable=traceRouteQueryDNSEnable, chassisComponentType=chassisComponentType, sysBootVariable=sysBootVariable, cpw1220sysID=cpw1220sysID, sysConfigRegister=sysConfigRegister, chassisPs2TestResult=chassisPs2TestResult, tokenRingPortCfgLossInterval=tokenRingPortCfgLossInterval, sysConfigChangeTrap=sysConfigChangeTrap, voicePortIfOperDnsDomain=voicePortIfOperDnsDomain, moduleFwHiVersion=moduleFwHiVersion, traceRouteQueryWaitingTime=traceRouteQueryWaitingTime, vmpsAction=vmpsAction, fileCopyResultRcpErrorMessage=fileCopyResultRcpErrorMessage, tokenRingGrp=tokenRingGrp, optionalSystemMiscGroup3=optionalSystemMiscGroup3, chassisPs3Status=chassisPs3Status, moduleGroup1=moduleGroup1, sysTrafficMeterTable=sysTrafficMeterTable, portErrDisableTimeOutEnable=portErrDisableTimeOutEnable, mcastRouterPortIndex=mcastRouterPortIndex, filterPortSuppressionOption=filterPortSuppressionOption, portCpbPortfast=portCpbPortfast, ciscoStackgMIBCompliance4=ciscoStackgMIBCompliance4, vmpsAddr=vmpsAddr, filterMacModule=filterMacModule, moduleSubType=moduleSubType, fileCopyGroup=fileCopyGroup, moduleStandbyStatus=moduleStandbyStatus, portTopNRateBase=portTopNRateBase, tokenRingSoftErrorMonitorGroup=tokenRingSoftErrorMonitorGroup, traceRouteQueryIndex=traceRouteQueryIndex, PYSNMP_MODULE_ID=ciscoStackMIB, sysInsertMode=sysInsertMode, sysExtendedRmonNetflowEnable=sysExtendedRmonNetflowEnable, vmpsType=vmpsType, tokenRingPortSoftErrTable=tokenRingPortSoftErrTable, filterVendorPort=filterVendorPort, radiusRetransmits=radiusRetransmits, brouterIpxSnapToEther=brouterIpxSnapToEther, optionalPortGroup=optionalPortGroup, tokenRingPortEarlyTokenRel=tokenRingPortEarlyTokenRel, tokenRingDripAreReductionMode=tokenRingDripAreReductionMode, portType=portType, chassisMajorAlarm=chassisMajorAlarm, optionalModuleGroup=optionalModuleGroup, sshPublicKeySize=sshPublicKeySize, portTopNBufferOverFlow=portTopNBufferOverFlow, vlanTrunkMappingTable=vlanTrunkMappingTable, ntpTimezoneName=ntpTimezoneName, vlanPortIslOperStatus=vlanPortIslOperStatus, sysMgmtType=sysMgmtType, radiusTimeout=radiusTimeout, traceRouteDataHopCount=traceRouteDataHopCount, fileCopyRemoteServer=fileCopyRemoteServer, ipPermitDeniedListEntry=ipPermitDeniedListEntry, voicePortOperDnsServerTable=voicePortOperDnsServerTable, vlanPortIslVlansAllowed=vlanPortIslVlansAllowed, moduleGroup2=moduleGroup2, brouterPort=brouterPort, chassisAlarmOff=chassisAlarmOff, filterProtocolType=filterProtocolType, filterPortBroadcastDiscards=filterPortBroadcastDiscards, mdgGatewayType=mdgGatewayType, dnsDomainName=dnsDomainName, portCpbModuleIndex=portCpbModuleIndex, dnsServerTable=dnsServerTable, multicastGrp=multicastGrp, portChannelNeighbourDeviceId=portChannelNeighbourDeviceId, traceRouteQueryOwner=traceRouteQueryOwner, brouterEthernetReceiveMax=brouterEthernetReceiveMax, securityGrp=securityGrp, voicePortIfTftpServerAddress=voicePortIfTftpServerAddress, filterGroup=filterGroup, filterMacPort=filterMacPort, wsc3000sysID=wsc3000sysID, portChannelPortIndex=portChannelPortIndex, ntpSummertimeStatus=ntpSummertimeStatus, portCrossGroupIndex=portCrossGroupIndex, sysTelnetPrimaryEnableAuthentication=sysTelnetPrimaryEnableAuthentication)
