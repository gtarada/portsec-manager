...
TimeTicks, IpAddress, MibIdentifier, NotificationType, Counter32, mib_2, Counter64, iso, Bits, Integer32, Gauge32, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "MibIdentifier", "NotificationType", "Counter32", "mib-2", "Counter64", "iso", "Bits", "Integer32", "Gauge32", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
TAddress, RowPointer, TDomain, AutonomousType, TimeStamp, TextualConvention, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TAddress", "RowPointer", "TDomain", "AutonomousType", "TimeStamp", "TextualConvention", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("ENTITY-MIB", entPhysicalContainsTable=entPhysicalContainsTable, entLPMappingTable=entLPMappingTable, entLogicalTable=entLogicalTable, entPhysicalTable=entPhysicalTable, entPhysicalIsFRU=entPhysicalIsFRU, entityConformance=entityConformance, entity2Compliance=entity2Compliance, entLogicalIndex=entLogicalIndex, entPhysicalSerialNum=entPhysicalSerialNum, entPhysicalParentRelPos=entPhysicalParentRelPos, entPhysicalClass=entPhysicalClass, entLogicalContextEngineID=entLogicalContextEngineID, entityCompliance=entityCompliance, entityGeneral=entityGeneral, PhysicalClass=PhysicalClass, PYSNMP_MODULE_ID=entityMIB, entAliasMappingEntry=entAliasMappingEntry, entityMIBTraps=entityMIBTraps, PhysicalIndex=PhysicalIndex, SnmpEngineIdOrNone=SnmpEngineIdOrNone, entityLogical2Group=entityLogical2Group, entPhysicalFirmwareRev=entPhysicalFirmwareRev, entPhysicalSoftwareRev=entPhysicalSoftwareRev, entityGroups=entityGroups, entityLogical=entityLogical, entPhysicalAssetID=entPhysicalAssetID, entityPhysicalGroup=entityPhysicalGroup, entPhysicalHardwareRev=entPhysicalHardwareRev, entPhysicalName=entPhysicalName, entConfigChange=entConfigChange, entPhysicalVendorType=entPhysicalVendorType, entAliasLogicalIndexOrZero=entAliasLogicalIndexOrZero, entityNotificationsGroup=entityNotificationsGroup, entityMIB=entityMIB, entityMIBObjects=entityMIBObjects, entPhysicalIndex=entPhysicalIndex, entLogicalDescr=entLogicalDescr, entLPPhysicalIndex=entLPPhysicalIndex, entAliasMappingTable=entAliasMappingTable, entLastChangeTime=entLastChangeTime, entityMapping=entityMapping, entityPhysical=entityPhysical, entPhysicalMfgName=entPhysicalMfgName, entPhysicalAlias=entPhysicalAlias, entLogicalTAddress=entLogicalTAddress, entLogicalContextName=entLogicalContextName, entityCompliances=entityCompliances, entityGeneralGroup=entityGeneralGroup, entLogicalEntry=entLogicalEntry, entPhysicalChildIndex=entPhysicalChildIndex, entPhysicalEntry=entPhysicalEntry, entLogicalType=entLogicalType, entityLogicalGroup=entityLogicalGroup, entityMIBTrapPrefix=entityMIBTrapPrefix, entPhysicalDescr=entPhysicalDescr, entLPMappingEntry=entLPMappingEntry, entAliasMappingIdentifier=entAliasMappingIdentifier, entLogicalTDomain=entLogicalTDomain, entPhysicalContainsEntry=entPhysicalContainsEntry, entPhysicalModelName=entPhysicalModelName, entityPhysical2Group=entityPhysical2Group, entPhysicalContainedIn=entPhysicalContainedIn, entLogicalCommunity=entLogicalCommunity, entityMappingGroup=entityMappingGroup)
