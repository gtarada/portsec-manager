...
TimeTicks, IpAddress, MibIdentifier, NotificationType, Counter64, Counter32, Integer32, iso, Bits, Gauge32, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "MibIdentifier", "NotificationType", "Counter64", "Counter32", "Integer32", "iso", "Bits", "Gauge32", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("CISCO-TC", ListIndexOrZero=ListIndexOrZero, CiscoURLString=CiscoURLString, CiscoAbsZeroBasedCounter32=CiscoAbsZeroBasedCounter32, CiscoRowOperStatus=CiscoRowOperStatus, Layer2Cos=Layer2Cos, BulkConfigResult=BulkConfigResult, CvE164Address=CvE164Address, SAPType=SAPType, CiscoAlarmSeverity=CiscoAlarmSeverity, CiscoMilliSeconds=CiscoMilliSeconds, EntLogicalIndexOrZero=EntLogicalIndexOrZero, CiscoSnapShotAbsCounter32=CiscoSnapShotAbsCounter32, CiscoPortListRange=CiscoPortListRange, CountryCode=CountryCode, ciscoTextualConventions=ciscoTextualConventions, CiscoNetworkProtocol=CiscoNetworkProtocol, Unsigned64=Unsigned64, CiscoNetworkAddress=CiscoNetworkAddress, ConfigIterator=ConfigIterator, TimeIntervalSec=TimeIntervalSec, CiscoLocationSpecifier=CiscoLocationSpecifier, CiscoInetAddressMask=CiscoInetAddressMask, TimeIntervalMin=TimeIntervalMin, CiscoPort=CiscoPort, InterfaceIndexOrZero=InterfaceIndexOrZero, CountryCodeITU=CountryCodeITU, CiscoLocationClass=CiscoLocationClass, CiscoIpProtocol=CiscoIpProtocol, ListIndex=ListIndex, PerfHighIntervalCount=PerfHighIntervalCount, CiscoPortList=CiscoPortList, IfOperStatusReason=IfOperStatusReason, EntPhysicalIndexOrZero=EntPhysicalIndexOrZero, PYSNMP_MODULE_ID=ciscoTextualConventions, MicroSeconds=MicroSeconds, CiscoHTTPResponseStatusCode=CiscoHTTPResponseStatusCode)
