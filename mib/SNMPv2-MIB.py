...
TimeTicks, snmpModules, IpAddress, MibIdentifier, NotificationType, Counter32, mib_2, Counter64, iso, Bits, Integer32, Gauge32, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "snmpModules", "IpAddress", "MibIdentifier", "NotificationType", "Counter32", "mib-2", "Counter64", "iso", "Bits", "Integer32", "Gauge32", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("SNMPv2-MIB", snmpInGetRequests=snmpInGetRequests, snmpInGenErrs=snmpInGenErrs, snmpOutTooBigs=snmpOutTooBigs, snmpSetGroup=snmpSetGroup, snmpProxyDrops=snmpProxyDrops, sysOREntry=sysOREntry, snmpMIBConformance=snmpMIBConformance, snmpInTotalReqVars=snmpInTotalReqVars, snmpInGetNexts=snmpInGetNexts, snmpEnableAuthenTraps=snmpEnableAuthenTraps, authenticationFailure=authenticationFailure, snmpInSetRequests=snmpInSetRequests, sysORID=sysORID, snmpTrap=snmpTrap, snmpInGetResponses=snmpInGetResponses, snmpInTraps=snmpInTraps, snmpOutSetRequests=snmpOutSetRequests, sysName=sysName, snmpBasicNotificationsGroup=snmpBasicNotificationsGroup, snmpInBadCommunityNames=snmpInBadCommunityNames, snmpWarmStartNotificationGroup=snmpWarmStartNotificationGroup, snmpOutTraps=snmpOutTraps, snmpInBadValues=snmpInBadValues, snmpMIB=snmpMIB, PYSNMP_MODULE_ID=snmpMIB, snmpSilentDrops=snmpSilentDrops, sysLocation=sysLocation, snmpBasicCompliance=snmpBasicCompliance, coldStart=coldStart, snmpInNoSuchNames=snmpInNoSuchNames, sysORDescr=sysORDescr, snmpInReadOnlys=snmpInReadOnlys, snmpOutBadValues=snmpOutBadValues, snmpInASNParseErrs=snmpInASNParseErrs, snmpTraps=snmpTraps, snmpNotificationGroup=snmpNotificationGroup, sysContact=sysContact, system=system, snmpOutNoSuchNames=snmpOutNoSuchNames, snmp=snmp, snmpSetSerialNo=snmpSetSerialNo, sysORLastChange=sysORLastChange, snmpInTooBigs=snmpInTooBigs, sysORUpTime=sysORUpTime, sysObjectID=sysObjectID, snmpOutPkts=snmpOutPkts, snmpObsoleteGroup=snmpObsoleteGroup, snmpTrapEnterprise=snmpTrapEnterprise, snmpOutGetRequests=snmpOutGetRequests, snmpOutGetResponses=snmpOutGetResponses, snmpInBadCommunityUses=snmpInBadCommunityUses, sysORTable=sysORTable, snmpSet=snmpSet, snmpMIBGroups=snmpMIBGroups, snmpInPkts=snmpInPkts, snmpInTotalSetVars=snmpInTotalSetVars, snmpBasicComplianceRev2=snmpBasicComplianceRev2, snmpGroup=snmpGroup, sysDescr=sysDescr, snmpTrapOID=snmpTrapOID, systemGroup=systemGroup, snmpInBadVersions=snmpInBadVersions, sysServices=sysServices, snmpMIBCompliances=snmpMIBCompliances, snmpCommunityGroup=snmpCommunityGroup, snmpOutGenErrs=snmpOutGenErrs, snmpOutGetNexts=snmpOutGetNexts, sysUpTime=sysUpTime, sysORIndex=sysORIndex, warmStart=warmStart, snmpMIBObjects=snmpMIBObjects)
