...
IpAddress, TimeTicks, MibIdentifier, NotificationType, Counter32, Counter64, Integer32, iso, Bits, Gauge32, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "MibIdentifier", "NotificationType", "Counter32", "Counter64", "Integer32", "iso", "Bits", "Gauge32", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
TestAndIncr, TimeStamp, TextualConvention, RowStatus, TruthValue, DisplayString, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "TimeStamp", "TextualConvention", "RowStatus", "TruthValue", "DisplayString", "DateAndTime")
...
mibBuilder.exportSymbols("CISCO-VTP-MIB", vlanInfo=vlanInfo, vtpVlanRingNumber=vtpVlanRingNumber, vtpStats=vtpStats, vtpDatabaseLocalMode=vtpDatabaseLocalMode, vtpMtuTooBig=vtpMtuTooBig, vtpVlanInfoGroup=vtpVlanInfoGroup, vtpDiscoverResultPrimaryServer=vtpDiscoverResultPrimaryServer, vtpVlanRingNumberConflict=vtpVlanRingNumberConflict, vtpDiscoverStatus=vtpDiscoverStatus, vtpTrunkPortGroup=vtpTrunkPortGroup, vtpVlanEditTypeExt=vtpVlanEditTypeExt, vtpDatabaseTakeOverPassword=vtpDatabaseTakeOverPassword, vlanTrunkPortSetSerialNo=vlanTrunkPortSetSerialNo, vtpStatsTable=vtpStatsTable, vtpAuthPasswordType=vtpAuthPasswordType, vlanTrunkPortEncapsulationType=vlanTrunkPortEncapsulationType, vtpMIBCompliance3=vtpMIBCompliance3, vtpStatus=vtpStatus, vtpDatabaseIndex=vtpDatabaseIndex, vtpDiscoverTable=vtpDiscoverTable, vtpVlanEditModifiedVlan=vtpVlanEditModifiedVlan, vtpVlanNotifEnabledGroup=vtpVlanNotifEnabledGroup, vtpNotificationObjectsGroup=vtpNotificationObjectsGroup, vtpVlanState=vtpVlanState, vtpVlanDeleted=vtpVlanDeleted, vtp4kVlanGroupRev1=vtp4kVlanGroupRev1, VlanType=VlanType, vtpMIBConformance=vtpMIBConformance, vtpConfigNotificationsGroup4=vtpConfigNotificationsGroup4, vtpVlanEditMtu=vtpVlanEditMtu, vtpMIBCompliance12=vtpMIBCompliance12, vtpVlanEditTypeExt2=vtpVlanEditTypeExt2, vtpConfigNotificationsGroup2=vtpConfigNotificationsGroup2, vtpConfigNotificationsGroup5=vtpConfigNotificationsGroup5, managementDomainName=managementDomainName, vtpVlanEditRowStatus=vtpVlanEditRowStatus, vtpVersionInUseChanged=vtpVersionInUseChanged, managementDomainLocalMode=managementDomainLocalMode, vtpVlanTranslationalVlan2=vtpVlanTranslationalVlan2, vlanTrunkPortEntry=vlanTrunkPortEntry, vlanTrunkPortVlansPruningEligible=vlanTrunkPortVlansPruningEligible, vlanTrunkPortOutJoins=vlanTrunkPortOutJoins, vtpMIBCompliance10=vtpMIBCompliance10, VlanIndex=VlanIndex, vtpConfigNotificationsGroup3=vtpConfigNotificationsGroup3, vlanTrunkPortTable=vlanTrunkPortTable, vtpVlanEditBufferOwner=vtpVlanEditBufferOwner, vtpVlanIndex=vtpVlanIndex, vtpVersionOneDeviceDetected=vtpVersionOneDeviceDetected, vtpDatabaseRevNumber=vtpDatabaseRevNumber, vlanTrunkPortNativeVlan=vlanTrunkPortNativeVlan, vtpVlanCreatedNotifEnabled=vtpVlanCreatedNotifEnabled, vtpDatabaseGroup=vtpDatabaseGroup, vtpVersion=vtpVersion, managementDomainEntry=managementDomainEntry, vlanTrunkPortVtpEnabled=vlanTrunkPortVtpEnabled, vtpVlanTable=vtpVlanTable, vlanTrunkPortManagementDomain=vlanTrunkPortManagementDomain, vtpVlanEditParentVlan=vtpVlanEditParentVlan, vtpDot1qTunnelGroup=vtpDot1qTunnelGroup, managementDomainTftpServer=managementDomainTftpServer, vlanTrunkPortVlansRcvJoined4k=vlanTrunkPortVlansRcvJoined4k, vtpVlanEditConfigRevNumber=vtpVlanEditConfigRevNumber, vtpVlanEditSteHopCount=vtpVlanEditSteHopCount, vtpMIBCompliance7=vtpMIBCompliance7, vlanTrunkPortInJoins=vlanTrunkPortInJoins, vlanTrunkPortVlansRcvJoined=vlanTrunkPortVlansRcvJoined, vtpDatabaseTable=vtpDatabaseTable, vtpAuthentication=vtpAuthentication, vtpMIBCompliance4=vtpMIBCompliance4, vtpDiscover=vtpDiscover, vtpVlanPortLocalSegment=vtpVlanPortLocalSegment, vtpMaxVlanStorage=vtpMaxVlanStorage, vlanTrunkPortVlansEnabled3k=vlanTrunkPortVlansEnabled3k, vtpDiscoverAction=vtpDiscoverAction, vtpVlanEditTranslationalVlan1=vtpVlanEditTranslationalVlan1, vtpInternalVlanEntry=vtpInternalVlanEntry, vlanTrunkPortVlansEnabled=vlanTrunkPortVlansEnabled, vlanTrunkPortDynamicState=vlanTrunkPortDynamicState, vtpVlanEditIsCRFBackup=vtpVlanEditIsCRFBackup, vtpAuthSecretKey=vtpAuthSecretKey, vtpEditControlTable=vtpEditControlTable, vlanTrunkPortRowStatus=vlanTrunkPortRowStatus, vtpDatabaseEntry=vtpDatabaseEntry, vtpConfigDigestError=vtpConfigDigestError, vtpOutSubsetAdverts=vtpOutSubsetAdverts, vtpConfigDigestErrors=vtpConfigDigestErrors, vtpVlanBridgeNumber=vtpVlanBridgeNumber, vtpVlanEditOperation=vtpVlanEditOperation, vtpVlanEditName=vtpVlanEditName, vtpOutAdvertRequests=vtpOutAdvertRequests, vtpVlanType=vtpVlanType, vtpDiscoverResultDatabaseName=vtpDiscoverResultDatabaseName, vtpDatabaseName=vtpDatabaseName, vtpConfigRevNumberError=vtpConfigRevNumberError, vtpDiscoverResultRevNumber=vtpDiscoverResultRevNumber, managementDomainLastChange=managementDomainLastChange, PYSNMP_MODULE_ID=ciscoVtpMIB, managementDomainRowStatus=managementDomainRowStatus, vlanTrunkPortDynamicStatusChange=vlanTrunkPortDynamicStatusChange, vtpOutSummaryAdverts=vtpOutSummaryAdverts, vtpDot1qTunnelGroup2=vtpDot1qTunnelGroup2, vlanTrunkPortVlansXmitJoined3k=vlanTrunkPortVlansXmitJoined3k, ManagementDomainIndex=ManagementDomainIndex, vtpVlanEditBridgeNumber=vtpVlanEditBridgeNumber, ciscoVtpMIB=ciscoVtpMIB, managementDomainConfigRevNumber=managementDomainConfigRevNumber, vtpVlanAreHopCount=vtpVlanAreHopCount, vtpNotificationsEnabled=vtpNotificationsEnabled, vtpInternalVlanGrp=vtpInternalVlanGrp, vtpVlanEditBridgeType=vtpVlanEditBridgeType, managementDomainTftpPathname=managementDomainTftpPathname, vtpStatsEntry=vtpStatsEntry, vtpMIBObjects=vtpMIBObjects, managementDomainPruningState=managementDomainPruningState, vtpVlanEditIndex=vtpVlanEditIndex, vtpVlanEntry=vtpVlanEntry, vtpVlanIfIndex=vtpVlanIfIndex, vtpDiscoverEntry=vtpDiscoverEntry, vlanTrunkPortsDot1qTag=vlanTrunkPortsDot1qTag, vtpDatabasePrimaryServer=vtpDatabasePrimaryServer, vtpMIBCompliance2=vtpMIBCompliance2, vtpVlanEditEntry=vtpVlanEditEntry, vtpMIBGroups=vtpMIBGroups, vtpLocalModeChanged=vtpLocalModeChanged, vtpConfigRevNumberErrors=vtpConfigRevNumberErrors, VlanTypeExt=VlanTypeExt, vtpVlanMtu=vtpVlanMtu, vtpTrunkPruningGroup2=vtpTrunkPruningGroup2, vtpInAdvertRequests=vtpInAdvertRequests, vlanTrunkPortDynamicStatus=vlanTrunkPortDynamicStatus, vtpInternalVlanOwner=vtpInternalVlanOwner, vtpInternalVlanAllocPolicy=vtpInternalVlanAllocPolicy, vtpVlanEditTranslationalVlan2=vtpVlanEditTranslationalVlan2, vlanTrunkPortVlansRcvJoined3k=vlanTrunkPortVlansRcvJoined3k, vlanTrunkPortOldAdverts=vlanTrunkPortOldAdverts, vtpBasicGroup=vtpBasicGroup, vtpTrunkPortGroup2=vtpTrunkPortGroup2, vtp4kVlanGroup=vtp4kVlanGroup, vtpAuthEntry=vtpAuthEntry, vtpMIBCompliance11=vtpMIBCompliance11, vtpVlansPruningEligible4k=vtpVlansPruningEligible4k, vtpDiscoverResultIndex=vtpDiscoverResultIndex, vlanTrunkPortVlansEnabled2k=vlanTrunkPortVlansEnabled2k, vlanTrunkPortVlansXmitJoined2k=vlanTrunkPortVlansXmitJoined2k, vlanTrunkPortVlansXmitJoined4k=vlanTrunkPortVlansXmitJoined4k, vtpMIBCompliance=vtpMIBCompliance, vtpDiscoverGroup=vtpDiscoverGroup, vtpServerDisabled=vtpServerDisabled, vtpVlanBridgeType=vtpVlanBridgeType, vtpDatabasePrimaryServerId=vtpDatabasePrimaryServerId, vlanTrunkPorts=vlanTrunkPorts, vtpStatsGroup=vtpStatsGroup, vtpAuthPassword=vtpAuthPassword, vtpInternalVlanTable=vtpInternalVlanTable, vlanTrunkPortEncapsulationOperType=vlanTrunkPortEncapsulationOperType, vtpVersion2BasicGroup=vtpVersion2BasicGroup, vtpVlanDot10Said=vtpVlanDot10Said, vtpNotificationsPrefix=vtpNotificationsPrefix, vtpNotificationsObjects=vtpNotificationsObjects, vtpMIBCompliance6=vtpMIBCompliance6, vtpDatabaseTakeOverPrimary=vtpDatabaseTakeOverPrimary, vtpTrunkPortGroup3=vtpTrunkPortGroup3, vtpVlanParentVlan=vtpVlanParentVlan, vtpVlanApplyStatus=vtpVlanApplyStatus, vlanManagementDomains=vlanManagementDomains, vtpVlanStpType=vtpVlanStpType, vtpLastDiscoverTime=vtpLastDiscoverTime, vtpInSubsetAdverts=vtpInSubsetAdverts, vtpInSummaryAdverts=vtpInSummaryAdverts, vtpDatabase=vtpDatabase, vtpConfigNotificationsGroup=vtpConfigNotificationsGroup, vtpVlanIfIndexGroup=vtpVlanIfIndexGroup, vtpVlanEditDot10Said=vtpVlanEditDot10Said, vlanTrunkPortVlansRcvJoined2k=vlanTrunkPortVlansRcvJoined2k, vtpVlanEditStpType=vtpVlanEditStpType, vlanTrunkPortVlansEnabled4k=vlanTrunkPortVlansEnabled4k, vtpMIBCompliance8=vtpMIBCompliance8, vtpMIBCompliances=vtpMIBCompliances, vtpVlanTranslationalVlan1=vtpVlanTranslationalVlan1, vtpMIBCompliance5=vtpMIBCompliance5, vtpDiscoverResultDeviceId=vtpDiscoverResultDeviceId, vtpVlanEditTable=vtpVlanEditTable, vtpVlanEditRingNumber=vtpVlanEditRingNumber, vlanTrunkPortIfIndex=vlanTrunkPortIfIndex, vtpAuthGroup=vtpAuthGroup, managementDomainLastUpdater=managementDomainLastUpdater, vlanTrunkPortDot1qTunnel=vlanTrunkPortDot1qTunnel, vtpVlanEditAreHopCount=vtpVlanEditAreHopCount, vtpVlanName=vtpVlanName, vtpDiscoverResultSystemName=vtpDiscoverResultSystemName, vtpVlanInfoEditGroup2=vtpVlanInfoEditGroup2, managementDomainTable=managementDomainTable, vtpVlanIsCRFBackup=vtpVlanIsCRFBackup, vtpVlansPruningEligible3k=vtpVlansPruningEligible3k, vtpAuthenticationTable=vtpAuthenticationTable, vtpConfigNotificationsGroupRev1=vtpConfigNotificationsGroupRev1, internalVlanInfo=internalVlanInfo, managementDomainVersionInUse=managementDomainVersionInUse, vtpVlanTypeExt=vtpVlanTypeExt, vlanEdit=vlanEdit, vtpVlanEditType=vtpVlanEditType, vtpVlanInfoEditGroup=vtpVlanInfoEditGroup, vtpDiscoverResultTable=vtpDiscoverResultTable, vtpTrunkPruningGroup=vtpTrunkPruningGroup, vtpMIBCompliance9=vtpMIBCompliance9, vtpVlanDeletedNotifEnabled=vtpVlanDeletedNotifEnabled, vtpEditControlEntry=vtpEditControlEntry, vtpVlanSteHopCount=vtpVlanSteHopCount, managementDomainIndex=managementDomainIndex, vtpDiscoverResultEntry=vtpDiscoverResultEntry, vtpNotifications=vtpNotifications, vtpVlanCreated=vtpVlanCreated, vlanTrunkPortVlansXmitJoined=vlanTrunkPortVlansXmitJoined, vtpVlansPruningEligible2k=vtpVlansPruningEligible2k, vtpDiscoverResultConflicting=vtpDiscoverResultConflicting, vtpVlanEditState=vtpVlanEditState)
